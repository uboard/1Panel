...
TXT_DOCKER_INSTALL_OFFLINE="... Instalando Docker offline"
TXT_IPTABLES_INSTALL_OFFLINE="... Instalando iptables offline para"
...
TXT_THANK_YOU_WAITING="===============instalação está completa =============="
...
TXT_PANEL_SERVICE_USER_LIST="Obter lista de usuários do 1Panel"
...
TXT_PANEL_SERVICE_RESTORE_NODE_NOTICE="Atenção: esta operação reverte apenas o nó principal. Se houver nós filhos já atualizados, reverta primeiro os nós filhos antes de continuar. Continuar? [y/n]: "
