...
TXT_USE_BUILTIN_DOCKER_CONFIRM="Built-in Docker package detected. Use it for offline installation? [y/n] (default: y, choose n to install the latest Docker online): "
...
TXT_DOCKER_INSTALL_OFFLINE="... Installing Docker offline"
TXT_IPTABLES_INSTALL_OFFLINE="... Installing iptables offline for"
...
TXT_THANK_YOU_WAITING="===============Installation is complete==============="
...
TXT_PANEL_SERVICE_USER_LIST="Get 1Panel user list"
...
TXT_PANEL_SERVICE_RESTORE_NODE_NOTICE="Note: This operation only rolls back the main node. If any child nodes have been upgraded, roll back the child nodes first before continuing. Continue? [y/n]: "
