...
TXT_DOCKER_INSTALL_OFFLINE="... Установка Docker оффлайн"
TXT_IPTABLES_INSTALL_OFFLINE="... Оффлайн-установка iptables для"
...
TXT_THANK_YOU_WAITING="==================установка завершена================="
...
TXT_PANEL_SERVICE_USER_LIST="Получить список пользователей 1Panel"
