...
const message = {
    ...
    xpack: {
        ...
        vm: {
            ...
            forceDeleteConfirm:
                'Pemadaman paksa mungkin menyembunyikan VM yang masih wujud atau masih berjalan pada hos jika pembersihan libvirt gagal. Teruskan?',
            deleteNameHelper: '" untuk memadam mesin maya ini',
            isoSource: 'Sumber ISO',
            isoTargetDir: 'Laluan Simpan ISO',
            isoTargetDirHelper:
                'ISO yang dipilih daripada pelayan dan dimuat naik secara setempat akan disimpan dalam direktori ini.',
            isoTargetDirAvailable: 'Laluan simpan ISO tersedia.',
            isoTargetDirUnavailable: 'Laluan simpan ISO mesti berada dalam storan pool VM yang tersedia.',
            checkPath: 'Semak',
            isoSize: 'Saiz ISO',
