...
const message = {
    ...
    xpack: {
        ...
        logExport: {
            title: 'Eksport Log',
            records: 'Rekod Eksport',
            retentionDays: 'Tempoh Simpanan Rekod Eksport',
            timeRange: 'Julat Masa',
            timeRequired: 'Pilih julat masa eksport',
            websiteRequired: 'Pilih laman web',
            blackStatus: 'Status Senarai Hitam',
            black: 'Disenarai hitam',
            notBlack: 'Tidak disenarai hitam',
            fuzzy: 'Padanan Kabur',
            regex: 'Ungkapan Biasa',
            invalidRegex: 'Masukkan ungkapan RE2 yang sah, maksimum 256 aksara',
            created: 'Tugas eksport telah dibuat',
            fileName: 'Nama Fail',
            fileSize: 'Saiz Fail',
            expiresAt: 'Tamat Tempoh',
            cancelConfirm: 'Batalkan tugas eksport ini?',
            deleteConfirm: 'Padam rekod eksport dan fail ini?',
        },
        waf: {
            name: 'WAF',
            ...
            geoHelper:
                'Gabungkan dasar wilayah dan wilayah pentadbiran dalam satu suis. Peraturan wilayah dinilai sebelum peraturan wilayah pentadbiran',
            ...
            deny: 'Dilarang',
            allow: 'Benarkan',
            allowOnly: 'Benarkan yang dipilih sahaja',
            field: 'Objek',
            pattern: 'Keadaan',
            ...
            executionStrategy: 'Strategi pelaksanaan',
            detectionStrength: 'Kekuatan pengesanan',
            protectionMode: 'Mod perlindungan',
            observationMode: 'Mod pemerhatian',
            standardMode: 'Mod standard',
            observationModeHelper: 'Mengesan dan merekod permintaan tanpa menyekatnya',
        ...
        vm: {
            ...
            healthCheckResult: {
                ...
                fail: 'Gagal',
                normal: 'Normal',
                fixCommand: 'Perintah pembaikan',
                technicalDetail: 'Butiran teknikal',
                check: {
                    vmName: 'Nama mesin maya',
                    libvirtConnection: 'Sambungan Libvirt',
                    vmDefinition: 'Takrif mesin maya',
                    domainXML: 'XML mesin maya',
                    architecture: 'Seni bina',
                    virtualizationType: 'Jenis pemayaan',
                    machineType: 'Jenis mesin',
                    efiCapability: 'Keupayaan EFI',
                    qemuEmulator: 'Emulator QEMU',
                    bootOrder: 'Turutan but',
                    arm64Firmware: 'Perisian tegar ARM64',
                    arm64Features: 'Ciri ARM64',
                    arm64Video: 'Paparan ARM64',
                    arm64FirmwareFile: 'Fail perisian tegar ARM64',
                    arm64CDROM: 'CD-ROM ARM64',
                    blockDevice: 'Peranti blok',
                    isoArchitecture: 'Seni bina ISO',
                    network: 'Rangkaian',
                    qemuLog: 'Log QEMU',
                    arm64RuntimeFirmware: 'Perisian tegar masa jalan ARM64',
                },
                reason: {
                    invalidName: 'Nama mesin maya tidak sah.',
                    connectionFailed: 'Tidak dapat menyambung ke {uri}.',
                    vmNotFound: 'Mesin maya {name} tidak ditemui.',
                    xmlReadFailed: 'Gagal membaca XML mesin maya.',
                    liveXMLFallback:
                        'Konfigurasi kekal tidak dapat dibaca; konfigurasi yang sedang berjalan digunakan.',
                    xmlParseFailed: 'Gagal menghuraikan XML mesin maya.',
                    stateReadFailed:
                        'Keadaan mesin maya tidak dapat ditentukan. Pemeriksaan perisian tegar masa jalan dilangkau.',
                    guestArchMissing: 'Seni bina tetamu tiada dalam XML.',
                    archMismatch:
                        'Seni bina hos ialah {hostArch}, manakala seni bina tetamu ialah {guestArch}. Pelaksanaan merentas seni bina tidak disokong.',
                    nonKVMType: 'Jenis pemayaan ialah {type}, bukan jenis KVM lalai.',
                    archOrMachineMissing: 'Seni bina atau jenis mesin tiada dalam XML.',
                    machineUnsupported: 'Hos tidak menyokong {arch}/{machine}.',
                    emulatorNotSpecified: 'Tiada emulator dinyatakan dalam XML; Libvirt akan memilihnya.',
                    fileNotFound: 'Fail tidak ditemui: {path}',
                    fileNotExecutable: 'Fail tidak boleh dilaksanakan: {path}',
                    bootDeviceMissing: 'Tiada peranti but ditakrifkan dalam XML.',
                    diskNotFirst: 'Cakera bukan peranti but pertama. Turutan semasa: {order}',
                    cdromNotInBootOrder: 'CD-ROM disambungkan tetapi tidak disertakan dalam turutan but.',
                    firmwareNotConfigured:
                        'EFI atau Loader tidak dikonfigurasi, jadi tetamu mungkin gagal memulakan paparan atau but.',
                    acpiCustom: 'ACPI dikonfigurasi. Sahkan bahawa tetamu memerlukan penyesuaian ini.',
                    acpiRequiresUEFI: 'ACPI dikonfigurasi tanpa UEFI, menyebabkan ralat ACPI requires UEFI.',
                    apicUnsupported: 'x86 APIC dikonfigurasi tetapi tidak sah untuk ARM64.',
                    gicNotDeclared: 'GIC tiada dalam XML kekal; Libvirt mungkin menambahnya semasa berjalan.',
                    videoNotConfigured: 'Tiada peranti paparan dikonfigurasi dalam XML.',
                    videoNotVirtio: 'Jenis peranti paparan ialah {type}; Virtio disyorkan.',
                    firmwareFileMissing: 'Fail perisian tegar tidak wujud atau bukan fail biasa: {path}',
                    firmwareNotAvailable:
                        'Libvirt tidak melaporkan keupayaan EFI dan perisian tegar UEFI ARM64 tidak ditemui.',
                    cdromBusNotSCSI: 'CD-ROM menggunakan bas {bus}; ARM64 memerlukan SCSI.',
                    cdromNotOnVirtioSCSI: 'CD-ROM tidak disambungkan kepada pengawal Virtio SCSI.',
                    diskSourceMissing: 'Tiada fail sumber dikonfigurasi untuk {device} {target}.',
                    sourceNotFound: 'Fail sumber untuk {device} {target} tidak wujud: {path}',
                    sourceIsDirectory: 'Laluan sumber untuk {device} {target} ialah direktori: {path}',
                    systemDiskNotFound: 'Tiada cakera sistem dikesan.',
                    isoArchMismatch:
                        'Tetamu {guestArch} mempunyai imej yang kelihatan untuk {imageArch} disambungkan: {path}',
                    networkReadFailed: 'Tidak dapat membaca rangkaian {name}.',
                    networkStateReadFailed: 'Tidak dapat membaca keadaan rangkaian {name}.',
                    networkInactive: 'Rangkaian {name} wujud tetapi tidak aktif.',
                    logUnavailable: 'Tiada log permulaan tersedia untuk dianalisis.',
                    logErrorsFound: 'Ralat lazim ditemui dalam rekod permulaan terkini.',
                    vmNotRunning: 'Mesin maya tidak berjalan, jadi pemeriksaan argumen masa jalan QEMU dilangkau.',
                    runtimeFirmwareMissing: 'Tiada entri pflash, AAVMF atau QEMU_EFI ditemui dalam log QEMU.',
                },
            },
            ...
            cpuLimitHelper: 'CPU tersedia semasa: {0} teras',
            cpuLimitExceeded: 'CPU melebihi had. Maksimum tersedia semasa: {0} teras.',
            memoryLimitHelper: 'Memori yang boleh diperuntukkan semasa: {0} (hos mesti merizab {1} memori)',
            memoryLimitExceeded: 'Memori melebihi had. Maksimum semasa yang boleh diperuntukkan: {0}.',
            storageLimitHelper: 'Ruang kosong semasa dalam kolam storan sasaran: {0}',
            storageLimitExceeded: 'Kapasiti cakera melebihi had. Maksimum tersedia semasa: {0}.',
            iso: 'ISO',
            createFromTemplate: 'Cipta daripada templat',
            template: 'Template',
            templateName: 'Template Name',
            convertToTemplate: 'Convert to Template',
            sourceVM: 'Source VM',
            templateSize: 'Template Size',
            deleteTemplateConfirm: 'Padam templat {0}. Operasi ini tidak boleh dibuat asal. Teruskan?',
            orphanClean: 'Pembersihan data yatim',
            orphanScan: 'Imbas semula',
            orphanCleanHelper:
                'Hanya fail calon yang tidak dirujuk oleh mesin maya, syot kilat atau templat berdaftar dipaparkan. Sahkan fail tidak lagi digunakan sebelum membersihkannya; operasi ini tidak boleh dibuat asal.',
            orphanSelected: '{0} fail dipilih, jumlah {1}',
            orphanSize: 'Saiz',
            orphanCleanConfirm: 'Bersihkan {0} fail terpilih ({1})? Operasi ini tidak boleh dibuat asal.',
            orphanCleanSuccess: '{0} fail telah dibersihkan dan {1} dibebaskan.',
            orphanType: {
                orphan_domain_disk: 'Cakera yatim',
            ...
            bootDiskFirst: 'Cakera dahulu (HD → CD-ROM)',
            bootIsoFirst: 'ISO dahulu (CD-ROM → HD)',
            bootOrderConfirm:
                'Tukar susunan but kepada {0}? Pada permulaan seterusnya, VM akan mencuba peranti boleh but yang sedang dipasang mengikut susunan ini.',
            ...
            forceDelete: 'Padam paksa',
            forceDeleteHelper:
                'Padam paksa akan mengabaikan ralat pemadaman VM, memadam metadata panel dan melepaskan penggunaan sumber.',
            deleteNameHelper: '" untuk memadam mesin maya ini',
            isoSource: 'Sumber ISO',
            downloadFromServer: 'Muat Turun Jauh',
            isoTargetDir: 'Laluan Sasaran ISO',
            isoTargetDirHelper:
            ...
            deleteSourceFileHelper:
                'Jika ditanda, fail sumber yang dirujuk oleh rekod ISO ini juga akan dipadam dan tidak boleh dipulihkan.',
