...
const message = {
    ...
    aiTools: {
        agents: {
            ...
            tokenOrAuth: 'Token/Autenticação',
    ...
    xpack: {
        ...
        logExport: {
            title: 'Exportar logs',
            records: 'Registros de exportação',
            retentionDays: 'Retenção dos registros de exportação',
            timeRange: 'Período',
            timeRequired: 'Selecione o período da exportação',
            websiteRequired: 'Selecione um site',
            blackStatus: 'Status da lista de bloqueio',
            black: 'Bloqueado',
            notBlack: 'Não bloqueado',
            fuzzy: 'Correspondência aproximada',
            regex: 'Expressão regular',
            invalidRegex: 'Insira uma expressão RE2 válida com no máximo 256 caracteres',
            created: 'Tarefa de exportação criada',
            fileName: 'Nome do arquivo',
            fileSize: 'Tamanho do arquivo',
            expiresAt: 'Expira em',
            cancelConfirm: 'Cancelar esta tarefa de exportação?',
            deleteConfirm: 'Excluir este registro e arquivo de exportação?',
        },
        waf: {
            name: 'WAF',
            ...
            geoHelper:
                'Combine políticas de região e província em um único controle. As regras de região são avaliadas antes das regras de província',
            ...
            executionStrategy: 'Estratégia de execução',
            detectionStrength: 'Nível de detecção',
            protectionMode: 'Modo de proteção',
            observationMode: 'Modo de observação',
            standardMode: 'Modo padrão',
            observationModeHelper: 'Detecta e registra solicitações sem bloqueá-las',
        ...
        vm: {
            ...
            healthCheckResult: {
                ...
                fail: 'Falha',
                normal: 'Normal',
                fixCommand: 'Comando de correção',
                technicalDetail: 'Detalhes técnicos',
                check: {
                    vmName: 'Nome da máquina virtual',
                    libvirtConnection: 'Conexão com o Libvirt',
                    vmDefinition: 'Definição da máquina virtual',
                    domainXML: 'XML da máquina virtual',
                    architecture: 'Arquitetura',
                    virtualizationType: 'Tipo de virtualização',
                    machineType: 'Tipo de máquina',
                    efiCapability: 'Compatibilidade com EFI',
                    qemuEmulator: 'Emulador QEMU',
                    bootOrder: 'Ordem de inicialização',
                    arm64Firmware: 'Firmware ARM64',
                    arm64Features: 'Recursos ARM64',
                    arm64Video: 'Vídeo ARM64',
                    arm64FirmwareFile: 'Arquivo de firmware ARM64',
                    arm64CDROM: 'CD-ROM ARM64',
                    blockDevice: 'Dispositivo de bloco',
                    isoArchitecture: 'Arquitetura da ISO',
                    network: 'Rede',
                    qemuLog: 'Log do QEMU',
                    arm64RuntimeFirmware: 'Firmware ARM64 em execução',
                },
                reason: {
                    invalidName: 'O nome da máquina virtual é inválido.',
                    connectionFailed: 'Não foi possível conectar a {uri}.',
                    vmNotFound: 'A máquina virtual {name} não foi encontrada.',
                    xmlReadFailed: 'Falha ao ler o XML da máquina virtual.',
                    liveXMLFallback:
                        'Não foi possível ler a configuração persistente; a configuração em execução está sendo usada.',
                    xmlParseFailed: 'Falha ao analisar o XML da máquina virtual.',
                    stateReadFailed:
                        'Não foi possível determinar o estado da máquina virtual. A verificação do firmware em execução foi ignorada.',
                    guestArchMissing: 'A arquitetura do sistema convidado está ausente no XML.',
                    archMismatch:
                        'A arquitetura do host é {hostArch}, enquanto a do convidado é {guestArch}. A execução entre arquiteturas diferentes não é suportada.',
                    nonKVMType: 'O tipo de virtualização é {type}, não o tipo KVM padrão.',
                    archOrMachineMissing: 'A arquitetura ou o tipo de máquina está ausente no XML.',
                    machineUnsupported: 'O host não suporta {arch}/{machine}.',
                    emulatorNotSpecified: 'Nenhum emulador foi especificado no XML; o Libvirt selecionará um.',
                    fileNotFound: 'Arquivo não encontrado: {path}',
                    fileNotExecutable: 'O arquivo não é executável: {path}',
                    bootDeviceMissing: 'Nenhum dispositivo de inicialização está definido no XML.',
                    diskNotFirst: 'O disco não é o primeiro dispositivo de inicialização. Ordem atual: {order}',
                    cdromNotInBootOrder: 'Um CD-ROM está conectado, mas não está incluído na ordem de inicialização.',
                    firmwareNotConfigured:
                        'EFI ou Loader não estão configurados, portanto o convidado pode não inicializar o vídeo ou arrancar.',
                    acpiCustom: 'ACPI está configurado. Confirme se o convidado precisa dessa personalização.',
                    acpiRequiresUEFI: 'ACPI está configurado sem UEFI, causando o erro ACPI requires UEFI.',
                    apicUnsupported: 'x86 APIC está configurado, mas não é válido para ARM64.',
                    gicNotDeclared:
                        'GIC não aparece no XML persistente; o Libvirt pode adicioná-lo durante a execução.',
                    videoNotConfigured: 'Nenhum dispositivo de vídeo está configurado no XML.',
                    videoNotVirtio: 'O tipo do dispositivo de vídeo é {type}; Virtio é recomendado.',
                    firmwareFileMissing: 'O arquivo de firmware não existe ou não é um arquivo comum: {path}',
                    firmwareNotAvailable:
                        'O Libvirt não informa compatibilidade com EFI e nenhum firmware UEFI ARM64 foi encontrado.',
                    cdromBusNotSCSI: 'O CD-ROM usa o barramento {bus}; ARM64 requer SCSI.',
                    cdromNotOnVirtioSCSI: 'O CD-ROM não está conectado a um controlador Virtio SCSI.',
                    diskSourceMissing: 'Nenhum arquivo de origem está configurado para {device} {target}.',
                    sourceNotFound: 'O arquivo de origem de {device} {target} não existe: {path}',
                    sourceIsDirectory: 'O caminho de origem de {device} {target} é um diretório: {path}',
                    systemDiskNotFound: 'Nenhum disco do sistema foi detectado.',
                    isoArchMismatch:
                        'O convidado {guestArch} tem uma imagem aparentemente destinada a {imageArch} conectada: {path}',
                    networkReadFailed: 'Não foi possível ler a rede {name}.',
                    networkStateReadFailed: 'Não foi possível ler o estado da rede {name}.',
                    networkInactive: 'A rede {name} existe, mas está inativa.',
                    logUnavailable: 'Nenhum log de inicialização está disponível para análise.',
                    logErrorsFound: 'Erros comuns foram encontrados no registro de inicialização mais recente.',
                    vmNotRunning:
                        'A máquina virtual não está em execução, portanto a verificação dos argumentos do QEMU foi ignorada.',
                    runtimeFirmwareMissing: 'Nenhuma entrada pflash, AAVMF ou QEMU_EFI foi encontrada no log do QEMU.',
                },
            },
            ...
            cpuLimitHelper: 'CPU disponível no momento: {0} núcleos',
            cpuLimitExceeded: 'CPU excede o limite. Máximo disponível no momento: {0} núcleos.',
            memoryLimitHelper: 'Memória alocável no momento: {0} (o host deve reservar {1} de memória)',
            memoryLimitExceeded: 'A memória excede o limite. Máximo alocável no momento: {0}.',
            storageLimitHelper: 'Espaço livre atual no pool de armazenamento de destino: {0}',
            storageLimitExceeded: 'A capacidade do disco excede o limite. Máximo disponível no momento: {0}.',
            iso: 'ISO',
            ...
            deleteTemplateConfirm: 'Excluir modelo {0}. Esta operação não pode ser desfeita. Continuar?',
            orphanClean: 'Limpeza de dados órfãos',
            orphanScan: 'Verificar novamente',
            orphanCleanHelper:
                'São exibidos apenas arquivos candidatos sem referência por máquinas virtuais, snapshots ou modelos registrados. Confirme que o arquivo não está mais em uso antes de limpá-lo; a operação não pode ser desfeita.',
            orphanSelected: '{0} arquivos selecionados, {1} no total',
            orphanSize: 'Tamanho',
            orphanCleanConfirm: 'Limpar os {0} arquivos selecionados ({1})? Esta operação não pode ser desfeita.',
            orphanCleanSuccess: '{0} arquivos foram limpos e {1} foram liberados.',
            orphanType: {
                orphan_domain_disk: 'Disco órfão',
            ...
            bootDiskFirst: 'Disco primeiro (HD → CD-ROM)',
            bootIsoFirst: 'ISO primeiro (CD-ROM → HD)',
            bootOrderConfirm:
                'Alterar a ordem de boot para {0}? Na próxima inicialização, a VM tentará nesta ordem os dispositivos inicializáveis que estiverem montados.',
            ...
            downloadFromServer: 'Download remoto',
