...
const message = {
    ...
    xpack: {
        ...
        vm: {
            ...
            forceDeleteConfirm:
                'A exclusão forçada pode ocultar uma VM que ainda existe ou ainda está em execução no host se a limpeza do libvirt falhar. Continuar?',
            ...
            isoTargetDirUnavailable:
                'O caminho de salvamento ISO deve estar em um pool de armazenamento de VM disponível.',
            checkPath: 'Verificar',
