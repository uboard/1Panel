...
const message = {
    commons: {
        ...
        login: {
            ...
            agreeTitle: '동의',
            agreeContent:
                '귀하의 합법적인 권리와 이익을 보다 잘 보호하기 위해, 다음 &laquo;',
    ...
    aiTools: {
        agents: {
            ...
            operationType: '작업 유형',
            batchAction: '일괄 {0}',
            installSkillAction: 'Skill 배포',
            batchAgentTask: '에이전트 일괄 {0}',
            dispatchAgentTask: '에이전트 {0} 작업 배포',
            dispatchTask: '{0} 작업 배포',
            taskSubmitted: '{0} 작업이 전송되었습니다',
            allNodes: '모든 노드',
            targetVersion: '대상 버전',
            ...
            verifyModel: '검증 모델',
            verifyModelHelper:
                '이 계정으로 사용할 수 있는 모델을 선택하세요. 저장할 때 최소 요청을 보내 연결을 검증합니다.',
            verifyModelRequired: '검증 모델을 선택하세요',
            discoverModels: '모델 가져오기',
            automaticModelDiscovery: '자동 가져오기',
            manualModelConfiguration: '수동 설정',
            discoverModelsHelper: '공급자의 /v1/models API에서 모델을 가져와 모두 모델 풀에 추가합니다.',
            discoverModelsFailedFallback: '모델을 가져오지 못했습니다. 모델을 직접 설정하세요.',
            accountModelsDuplicate: '카탈로그에 중복된 모델이 있습니다',
            modelPool: '모델 풀',
            fallbackModels: '폴백 모델',
            addFallbackModel: '폴백 모델 추가',
            fallbackModelsEmpty: '구성된 폴백 모델이 없습니다',
            ...
            skillsMarketSourceLocalHub: '로컬 Skill 스토어',
            skillsScore: '점수',
            ...
            roleMarkdownDescriptions: {
                'AGENTS.md': [
                    '에이전트의 운영 지침과 메모리를 어떻게 사용할지에 대한 설명입니다.',
                    '모든 세션 시작 시 로드됩니다.',
                    '규칙, 우선순위, 동작 방식의 세부 내용을 적기에 좋습니다.',
                ],
                'SOUL.md': ['페르소나, 말투, 경계.', '매 세션마다 로드됩니다.'],
                'USER.md': ['사용자가 누구인지, 어떻게 호칭할지.', '매 세션마다 로드됩니다.'],
                'IDENTITY.md': ['에이전트의 이름, 분위기, 이모지.', '부트스트랩 절차 중 생성되거나 업데이트됩니다.'],
                'TOOLS.md': [
                    '로컬 도구와 사용 규약에 대한 메모입니다.',
                    '도구 사용 가능 여부를 제어하지 않으며, 안내용 설명입니다.',
                ],
                'HEARTBEAT.md': ['heartbeat 실행용 선택 체크리스트입니다.', '토큰 낭비를 막기 위해 짧게 유지하세요.'],
                'BOOT.md': [
                    '내부 훅이 켜져 있을 때 gateway 재시작 시 실행되는 선택 시작 체크리스트입니다.',
                    '짧게 유지하고, 외부 발신은 message 도구를 사용하세요.',
                ],
                'BOOTSTRAP.md': [
                    '최초 실행 시 한 번만 수행되는 절차입니다.',
                    '완전히 새로운 작업공간에서만 생성됩니다.',
                    '절차가 끝나면 삭제하세요.',
                ],
            },
            ...
            dmPolicy: 'DM 정책',
            threadSession: '스레드 세션',
            replyMode: '응답 모드',
            requireMention: '멘션 요구',
            requireMentionTrue: "{'@'} 필요",
            requireMentionFalse: "{'@'} 불필요",
            requireMentionOpen: '그룹 설정 따름',
            groupPolicy: '그룹 정책',
            ...
            addBot: '봇 추가',
            accountId: '계정 ID',
            accountIdPlaceholder: '봇을 구분하는 고유 ID이며 저장 후 설정과 라우팅 식별에 사용됩니다.',
            setDefaultBot: '기본값으로 설정',
            botDuplicateField: '{field}이(가) 이미 존재합니다',
            botRequired: '봇을 하나 이상 추가하세요',
            botId: '봇 ID',
            allowFrom: 'DM 허용 목록',
            allowFromPlaceholder: '한 줄에 하나의 발신자 ID',
            allowlistPolicyHelper: '{0}. {1}이(가) 허용 목록일 때만 사용됩니다.',
            systemPrompt: '시스템 프롬프트',
            groupAllowFrom: '그룹 허용 목록',
            groupAllowFromPlaceholder: '한 줄에 하나의 그룹 ID',
            separateSessionByConversation: '대화별 세션 분리',
            ...
            streaming: '스트리밍',
            streamingOff: '끄기',
            streamingPartial: '부분 출력',
            streamingBlock: '블로킹 출력',
            streamingProgress: '진행 출력',
        ...
        model: {
            ...
            modelSource: '모델 소스',
            repoID: '저장소 ID',
            endpointLabel: '{0} 엔드포인트',
            acceleratedEndpointLabel: '{0} 가속 엔드포인트',
            tokenOptionalLabel: '{0} Token (선택 사항)',
            searchSource: '{0} 검색',
            hfEndpointHelper:
        ...
        aiProxy: {
            ...
            lastError: '최근 오류',
            modelMap: '모델 매핑',
            apiKeyKeepEmpty: 'API Key (비워 두면 변경하지 않음)',
            apiKeyOnceHint: 'API Key는 생성 시 한 번만 표시됩니다. 지금 복사하여 저장하세요.',
            apiKeyOnceSave: 'API Key는 한 번만 표시됩니다. 지금 저장하세요:',
            qpsLimit: 'QPS 제한',
            tokenLimit: 'Token 제한',
            tokenUsed: '사용한 Token',
            tokenRemaining: '남은 Token',
            ...
            lbPolicyWeightedRoundRobin: '가중 라운드 로빈',
            lbPolicyWeightedRoundRobinDesc:
                '모델 계정의 가중치에 따라 요청을 분배합니다. 가중치가 높을수록 더 많은 트래픽을 받습니다.',
            lbPolicyFailover: '장애 조치',
            lbPolicyFailoverDesc:
                '우선순위가 가장 높은 모델 계정을 먼저 사용하고, 실패 또는 쿨다운 후 다음 사용 가능한 계정으로 전환합니다.',
            maxConcurrency: '최대 동시성',
            queueSize: '대기열 크기',
            queueTimeoutSeconds: '대기열 대기 시간 초과(초)',
            requestTimeoutSeconds: '비스트리밍 요청 시간 초과(초)',
            ...
            deleteTargetConfirm: '{0} {1}을(를) 삭제하시겠습니까?',
            deleteBackendTitle: '모델 계정 삭제',
            userFallback: '삭제된 사용자 (ID: {0})',
            requestModel: '요청 모델',
            ...
            ranking: '순위',
            rank: '순위',
            promptToken: '입력 Token',
            completionToken: '출력 Token',
            totalToken: '총 Token',
        ...
        skillsHub: {
            ...
            repositoryGithubOnly: 'GitHub 저장소 주소만 지원됩니다',
            repositoryRef: '브랜치 또는 Tag',
            repositoryRefPlaceholder: '기본값은 main이며, 실패하면 master를 시도합니다',
            repositoryDownloadPreview: '대상 다운로드 URL:',
            packageURL: '패키지 URL',
            packageURLPlaceholder: '.zip 패키지 주소를 입력하세요',
            importSuccess: 'Skill을 성공적으로 가져왔으며 검토 대기 상태가 되었습니다.',
            source: '출처',
            applicableAgent: '적용 에이전트',
            overview: '개요',
            versionHistory: '버전 기록',
            publishedAt: '게시 시간',
            versionMarker: '표시',
            currentVersion: '현재 보기',
            latestVersion: '최신 버전',
            latestPublished: '최신 게시',
            riskLevel: '위험 수준',
            riskReferenceHint:
                '위험 수준은 Skill 패키지 내용을 기반으로 자동 감지되며 검토 참고용입니다.\n낮음: 명확한 위험 없음\n중간: 스크립트/의존성/외부 URL/환경 변수 포함\n높음: 원격 실행/민감 정보/위험 명령 포함',
            riskCheckResult: '보안 검사 결과',
            noRiskFound: '명확한 위험을 찾지 못했습니다.',
            riskFilePath: '파일 경로',
            riskKeyword: '일치한 키워드 또는 규칙',
            riskDescription: '위험 설명',
            publishHighRiskConfirm:
                '이 Skill에는 스크립트 실행, 외부 다운로드 또는 민감한 정보 접근이 포함될 수 있는 고위험 항목이 있습니다. 그래도 게시하시겠습니까?',
            approve: '승인',
            reject: '거부',
            publish: '게시',
            disable: '게시 해제',
            ...
            copy: '복사',
            extract: '압축 해제',
            postInstallCommand: '설치 후 명령',
            localSource: '로컬 업로드',
            uploadDragTitle: 'Skill 패키지를 여기에 끌어다 놓거나 클릭하여 업로드',
            uploadFormatLabel: '지원 형식:',
            uploadFormatValue: '.zip, .7z, .tar, .tar.gz',
            uploadSizeLabel: '파일 크기:',
            uploadSizeValue: '파일 하나당 5 MB 이하',
            uploadRequirementLabel: '패키지 요구 사항:',
            uploadRequirementPrefix: 'Skill 패키지에는 다음이 포함되어야 합니다',
            onlySupportedArchive: '.zip, .7z, .tar, .tar.gz 형식의 Skill 패키지만 업로드할 수 있습니다',
            uploadSizeExceeded: '단일 Skill 패키지는 5 MB를 초과할 수 없습니다',
            ...
            deleteConfirm:
                '이 Skill을 삭제하시겠습니까? 삭제 후 복구할 수 없습니다. 에이전트에 이미 설치된 Skill에는 영향이 없습니다.',
            ...
            riskType: {
                script_file: '스크립트 파일',
                dependency_manifest: '의존성 선언',
                external_url: '외부 URL',
                environment_variable: '환경 변수',
                dockerfile: 'Dockerfile',
                command_execution: '명령 실행',
                remote_script_execution: '원격 스크립트 실행',
                eval_execution: '동적 실행',
                base64_execution: 'Base64 디코딩 실행',
                privileged_command: '권한 상승 명령',
                dangerous_delete: '위험한 삭제',
                world_writable_permission: '고위험 권한',
                credential: '의심스러운 인증 정보',
                sensitive_path: '민감한 경로',
                suspicious_download_execute: '의심스러운 다운로드 실행',
                binary_content: '바이너리 콘텐츠',
                scan_truncated: '검사 내용 잘림',
            },
            riskDescriptionText: {
                script_file: '로컬 명령을 실행할 수 있는 스크립트 파일이 포함되어 있습니다.',
                dependency_manifest: '설치 시 외부 의존성을 가져올 수 있는 의존성 선언 파일이 포함되어 있습니다.',
                external_url: '외부 URL이 포함되어 있습니다. 외부 연결 주소를 신뢰할 수 있는지 확인하세요.',
                environment_variable: '환경 변수를 선언합니다. 용도와 기본값을 확인하세요.',
                dockerfile: '이미지 빌드 또는 실행 로직을 정의할 수 있는 Dockerfile이 포함되어 있습니다.',
                command_execution: '명령 실행 관련 호출이 포함되어 있습니다. 실행 로직을 확인하세요.',
                remote_script_execution: '원격 스크립트를 다운로드한 뒤 직접 실행하는 로직이 포함되어 있습니다.',
                eval_execution: 'eval을 통한 동적 실행이 포함되어 있습니다.',
                base64_execution: 'Base64 디코딩 후 내용을 실행하는 로직이 포함되어 있습니다.',
                privileged_command: 'sudo 권한 상승 명령이 포함되어 있습니다.',
                dangerous_delete: '위험한 삭제 명령이 포함되어 있습니다.',
                world_writable_permission: 'chmod 777 권한 변경이 포함되어 있습니다.',
                credential: 'API Key, Token, Secret 또는 Password로 의심되는 정보가 포함되어 있습니다.',
                sensitive_path: '민감한 디렉터리 또는 파일에 접근하는 동작이 포함되어 있습니다.',
                suspicious_download_execute: '의심스러운 외부 다운로드 또는 다운로드 후 실행 로직이 포함되어 있습니다.',
                binary_content:
                    '파일에 NUL 바이트가 포함되어 실행 가능 콘텐츠 또는 바이너리 콘텐츠를 숨길 수 있습니다.',
                scan_truncated: '파일이 검사 한도를 초과했습니다. 검사되지 않은 내용은 수동 확인이 필요합니다.',
            },
        },
        benchmark: {
            title: '벤치마크',
            ...
            tokenizerPlaceholder:
                '로컬 토크나이저 디렉터리를 선택하거나 입력하세요. 예: /opt/1panel/tokenizers/DeepSeek-V3',
            runConfig: '실행 구성',
            rawResult: '원시 결과',
            resultMetrics: '결과 지표',
            contextTokens: '컨텍스트 길이',
            contextTokensHelper: '이 벤치마크의 입력 Token 제한과 출력 Token 제한의 합계입니다.',
            outputThroughput: '출력 처리량',
            outputThroughputHelper: '초당 생성된 출력 Token 수입니다. 높을수록 생성 속도가 빠릅니다.',
            totalThroughput: '총 처리량',
            totalThroughputHelper: '초당 처리된 입력 및 출력 Token 수로 전체 처리 능력을 측정합니다.',
            firstTokenLatency: '첫 Token 지연 시간',
            firstTokenLatencyHelper: '요청 전송부터 첫 Token 수신까지의 시간입니다. 낮을수록 응답이 빠릅니다.',
            tokenValueHelper: '양의 정수 또는 k 값을 입력하세요. 예: 512, 1k, 32k',
            numPrompts: '프롬프트 수',
            concurrency: '동시성',
            mean: '평균값',
            median: '중앙값',
            requestRate: '요청 속도',
            requestRateUnlimited: '무제한(최대 처리량)',
            requestRateCustom: '사용자 지정 QPS',
            requestRateCustomPlaceholder: '초당 요청 수, 예: 2.5',
    ...
    monitor: {
        ...
        runtimeHeapAlloc: '힙 메모리',
        runtimeHeapObjects: '힙 객체',
        runtimeGoroutines: 'Goroutine 수',
        ...
        profileMutex: '뮤텍스',
        profileBlock: '블록',
        runtimeRSSDesc: 'Go 힙, 스레드 스택 및 네이티브 메모리를 포함해 프로세스가 사용하는 실제 메모리입니다.',
        runtimeHeapAllocDesc:
            'Go 힙에 할당되어 아직 해제되지 않은 메모리입니다. 지속적인 증가는 객체가 유지되고 있음을 나타낼 수 있습니다.',
        runtimeHeapObjectsDesc:
            'Go 힙의 현재 활성 객체 수입니다. 지속적인 증가는 객체가 유지되고 있음을 나타낼 수 있습니다.',
        ...
        profileHeapDesc: '사용 중인 Go 힙 객체와 할당 스택을 기록하여 지속적인 메모리 증가를 조사합니다.',
    ...
    terminal: {
        ...
        nodeAdminLocalOnly: '노드 관리자는 로컬 터미널만 사용할 수 있습니다.',
    ...
    toolbox: {
        ...
        clam: {
            clam: '바이러스 검사',
            cron: '예약 스캔',
            cronHelper: '상용 버전에서 예약 스캔 기능을 지원합니다.',
            ...
            alertHelper: '상용 버전에서 예약 스캔 및 SMS 알림을 지원합니다.',
    ...
    file: {
        ...
        shareList: '공유 목록',
        fileTools: '파일 도구',
        aiSearchHitLines: '일치하는 줄',
        aiSearch: 'AI 검색',
        aiSearchTitle: 'AI 검색',
        aiSearchHint:
            '파일 내용을 줄 단위로 검색합니다. 검색창 오른쪽 버튼과 아래의 "고급 조건"에서 검색 방식을 바꿀 수 있습니다. AI 계정을 활성화하고 저장하면 Markdown 요약도 생성할 수 있습니다.',
        aiSearchAccountTitle: 'AI 계정',
        aiSearchAccountIntro: '요약 생성을 위한 대형 모델 계정을 선택하세요. 변경 후 저장을 눌러주세요.',
        aiSearchAccountEnable: '파일 AI 검색 활성화',
        aiSearchSaveAccount: '계정 설정 저장',
        aiSearchSectionQuery: '검색',
        aiSearchSectionConditions: '검색 조건',
        aiSearchResultsSection: '분석 결과',
        aiSearchContentLabel: '검색 내용',
        aiSearchDirLabel: '디렉터리',
        aiSearchExtLabel: '파일 확장자',
        aiSearchModifiedPreset: '수정 시간',
        aiSearchSizePresetLabel: '파일 크기',
        aiSearchTimeAny: '기간 없음',
        aiSearchTime3h: '최근 3시간',
        aiSearchTime1d: '최근 1일',
        aiSearchTime7d: '최근 7일',
        aiSearchTime30d: '최근 30일',
        aiSearchTimeCustom: '사용자 지정',
        aiSearchSizeAny: '크기 제한 없음',
        aiSearchSize0_10mb: '0 ~ 10 MB',
        aiSearchSize10_100mb: '10 MB ~ 100 MB',
        aiSearchSize100_1gb: '100 MB ~ 1 GB',
        aiSearchSizeGte1gb: '1 GB 이상',
        aiSearchSizeCustom: '사용자 지정(바이트)',
        aiSearchPlaceholder: '검색 내용을 입력하세요',
        aiSearchContainSub: '하위 폴더',
        aiSearchMaxItems: '검색 대상 경로/파일 수 상한(디렉터리 열람, 1–2000)',
        aiSearchRun: '분석 시작',
        aiSearchTruncated: '디렉터리 항목이 너무 많아 일부만 포함되었습니다. 결과가 완전하지 않을 수 있습니다.',
        aiSearchPreFiltered: '키워드로 상대 경로를 미리 필터링하여 모델에 보낼 항목 수를 줄였습니다.',
        aiSearchMeta: '분석 항목: {0} | 소요 시간 {1} | Token {2}',
        aiSearchQueryRequired: '검색 내용이나 키워드를 입력하세요',
        aiSearchContentHits: '내용 일치',
        aiSearchContentScanMeta: '내용 스캔: {0}개의 텍스트 파일을 읽었습니다(현재 검색 조건, 크기/개수 제한 적용).',
        aiSearchNoLineHits: '스캔한 텍스트 파일에서 일치하는 줄이 없습니다.',
        aiSearchHitsTruncated: '일부 파일은 스캔되지 않았거나, 상한으로 인해 일치 목록이 잘렸습니다.',
        aiSearchHitFiles: '일치한 파일',
        aiSearchOpenFile: '편집기에서 열기',
        aiSearchOpenAtLine: '이 줄로 열기',
        aiSearchGrepOnlyHint:
            '현재 파일 AI가 비활성화되어 있습니다. 결정적인 내용 검색만 수행되며 모델은 호출되지 않습니다. 위에서 AI 계정을 활성화하고 저장하면 요약을 사용할 수 있습니다. 검색 줄과 아래 옵션은 계속 적용됩니다.',
        aiSearchMatchCase: '대소문자 구분',
        aiSearchWholeWord: '단어 전체 일치(영문 단어 경계 \\b)',
        aiSearchUseRegex: '정규식(Go RE2 문법)',
        aiSearchExtensions: '파일 확장자(쉼표 구분, 예: go,ts,md)',
        aiSearchMinSize: '최소 파일 크기(바이트, 0은 제한 없음)',
        aiSearchMaxSize: '최대 파일 크기(바이트, 0은 제한 없음)',
        aiSearchSectionAdvanced: '고급 조건',
        aiSearchLimitMaxItems: '검색 총 파일 수',
        aiSearchLimitMaxScan: '내용 스캔 파일 수',
        aiSearchLimitMaxBytes: '단일 파일 읽기 상한',
        aiSearchLimitHitsPerFile: '단일 파일 일치 줄 수',
        aiSearchLimitTotalHits: '총 일치 줄 수',
        aiSearchLimitUnitEntries: '개',
        aiSearchLimitUnitFiles: '파일',
        aiSearchLimitUnitBytes: 'B',
        aiSearchLimitUnitLines: '줄',
        aiSearchMaxScanFiles: '내용 스캔 최대 파일 수',
        aiSearchMaxFileBytes:
            '내용 스캔 시 각 파일에서 읽는 최대 바이트 수입니다. 위의 "파일 크기"와는 다르며, 이는 파일을 열어 비교할 때 실제 읽는 양을 제한합니다.',
        aiSearchMaxHitsPerFile: '단일 파일 최대 일치 줄 수',
        aiSearchMaxTotalHits: '총 일치 줄 수 상한',
        aiSearchGrepMetaContent:
            '내용 스캔: 검색 총 항목 {0}, 읽은 텍스트 파일 {1}개(현재 조건, 크기/개수 제한 적용). 소요 시간 {2}',
        aiSearchAdvancedResetDefaults: '기본 상한으로 복원',
        zip: '압축됨',
        group: '그룹',
        path: '경로',
        public: '기타',
        ...
        historyTitle: '버전 기록',
        historyHint:
            '파일 변경 전 버전을 기록하여 파일 내용의 변경 이력을 확인하고 내용 수정 버전으로 되돌릴 수 있습니다.',
        historySettingTitle: '버전 정책',
        historyEnable: '버전 기록 활성화',
        historyMaxPerPath: '파일당 보관 개수',
        historyDiskQuota: '전체 디스크 할당량 (MB)',
        historyCurrentScope: '현재 파일',
        historyAllScope: '전체 파일',
        historyDeleteConfirm: '선택한 변경 기록을 삭제하시겠습니까?',
        historyNeedFile: '먼저 파일을 열어주세요',
        historyRestore: '이 버전으로 복원',
        historyOperationOnlyHint: '선택한 항목은 파일 작업이며 버전 복원을 지원하지 않습니다.',
        historyCurrentFile: '현재 파일',
        historyLatestVersion: '왼쪽에는 기록 버전의 내용, 오른쪽에는 선택한 파일의 최신 버전 내용을 표시합니다',
        historyCompareTarget: '비교 대상',
        historyCompareTargetPath: '비교 경로',
        historyRestoreConfirm: '이 버전을 현재 파일로 복원하시겠습니까?',
        historyRestoreDirtyConfirm:
            '현재 파일에 저장되지 않은 변경 사항이 있습니다. 복원하면 덮어씌워집니다. 계속하시겠습니까?',
        historyRestoreSuccess: '버전 복원이 완료되었습니다',
        historyDirtyHint: '현재 편집기에는 저장되지 않은 변경 사항이 있습니다. 버전을 복원하면 덮어씌워집니다.',
        historyDiffHintCurrent: '왼쪽은 기록 버전의 내용, 오른쪽은 현재 파일 내용을 표시합니다',
        historyDiffHintAll: '왼쪽은 기록 버전의 내용, 오른쪽은 선택한 파일의 최신 버전을 표시합니다',
        copyDir: '복사',
        shareFile: '파일 공유',
        shareExpire: '유효 기간',
        shareExpire1h: '1시간',
    ...
    setting: {
        ...
        proxyHelper1: '설치 패키지 다운로드 및 앱 스토어 동기화 (상용 버전 전용)',
        proxyHelper2: '시스템 업데이트 및 업데이트 정보 확인 (상용 버전 전용)',
        proxyHelper4: 'Docker 이미지 pull 같은 네트워크 요청은 프록시 서버를 통해 처리됩니다 (상용 버전 전용)',
        proxyHelper3: '시스템 라이선스 인증 및 동기화',
        proxyHelper5: '시스템 스크립트 라이브러리 통합 다운로드 및 동기화 (상용 버전 기능)',
        proxyHelper6: '인증서 신청 (상용 버전 기능)',
        proxyType: '프록시 유형',
        proxyUrl: '프록시 주소',
        proxyPort: '프록시 포트',
        ...
        passwordEmptyTip: '현재 비밀번호를 변경하지 않으려면 비워 두세요',
        ...
        complexity: '복잡성 검증',
        complexityHelper: '활성화하면 비밀번호는 8-30 자이며 영문, 숫자, 특수 문자 중 최소 두 가지를 포함해야 합니다.',
        bindDomain: '도메인 바인딩',
    ...
    license: {
        ...
        lostHelper:
            '라이센스가 최대 재시도 횟수를 초과했습니다. 상용 버전 기능이 제대로 작동하는지 확인하려면 동기화 버튼을 수동으로 클릭하세요.',
        disableHelper:
            '라이센스 동기화 검증에 실패했습니다. 상용 버전 기능이 제대로 작동하는지 확인하려면 동기화 버튼을 수동으로 클릭하세요.',
        quickUpdate: '빠른 업데이트',
        power: '권한 부여',
        ...
        serialNo: '시리얼 번호',
        remark: '비고',
        waf: '상용 버전으로 업그레이드하면 차단 맵, 로그, 차단 기록, 지역 차단, 사용자 정의 규칙, 사용자 정의 차단 페이지 등을 사용할 수 있습니다.',
        tamper: '상용 버전으로 업그레이드하면 웹사이트를 무단 수정이나 변조로부터 보호할 수 있습니다.',
        setting: '상용 버전으로 업그레이드하면 패널 로고, 환영 메시지 등 정보를 사용자 정의할 수 있습니다.',
        monitor:
        ...
        nodeDashboard:
            '상용 버전으로 업그레이드하면 다중 노드 애플리케이션, 웹사이트, 데이터베이스, 예약 작업을 중앙에서 관리할 수 있습니다.',
        ...
        exceptionalHelper:
            '라이선스 동기화 검증이 비정상입니다. 수동으로 동기화해 상용 버전 기능이 정상적으로 동작하는지 확인하세요. 상세: ',
    ...
    nginx: {
        ...
        build: '빌드',
        buildWarn:
            '로컬 모듈 빌드는 CPU와 메모리를 사용합니다. 정적 모듈은 OpenResty를 다시 빌드하고 재시작합니다. 계속하시겠습니까?',
        buildPurposeHint:
    ...
    xpack: {
        ...
        opsReport: {
            ...
            page: {
                enterprise: '엔터프라이즈',
                reportNode: '보고서 노드',
                selectReportNode: '보고서 노드 선택',
                currentNode: '현재 노드',
                scoreMeta: '감점 {0}점 · 위험 {1}건',
                hostAddress: '호스트 주소',
                panelVersion: '패널 버전',
                cpuCores: '물리 코어',
                coreUnit: '{0}코어',
                ...
                scoreTrend: '점수 추이',
                scoreLevelSafe: '안전',
                scoreLevelAttention: '주의 필요',
                scoreLevelMediumRisk: '중위험',
                scoreLevelHighRisk: '고위험',
                scoreCategoryHost: '호스트 리소스',
                scoreCategoryLogin: '로그인 보안',
                scoreCategoryWebsite: '웹사이트 및 인증서',
                scoreCategoryCronjob: '예약 작업',
                scoreCategoryResource: '런타임 리소스',
                scoreDiskHigh: '디스크 {0} 사용률 {1}%',
                scoreDiskMedium: '디스크 {0} 사용률 {1}%',
                scoreResourceHigh: '{0} 현재 사용률 {1}%',
                scoreResourceMedium: '{0} 현재 사용률 {1}%',
                scoreLoadMedium: '현재 부하 {0}',
                scoreMonitorDisabled: '호스트 모니터링 미활성화',
                scorePanelLoginFailedHigh: '패널 로그인 실패 {0}회',
                scorePanelLoginFailedMedium: '패널 로그인 실패 {0}회',
                scoreSSHLoginFailedHigh: 'SSH 로그인 실패 {0}회',
                scoreSSHLoginFailedMedium: 'SSH 로그인 실패 {0}회',
                scoreMFADisabled: 'MFA 미활성화',
                scoreAllowIPsOpen: '허용 IP 및 바인딩 도메인이 미구성되었거나 접근 제한이 설정되지 않음',
                scorePanelHTTPSDisabled: '패널 HTTPS 미활성화',
                scoreSSHRootLogin: 'SSH Root 로그인 허용됨',
                scoreSSHPasswordAuth: 'SSH 비밀번호 인증 활성화, 키 인증 미활성화',
                scoreSSLHigh: '{0} 인증서 만료까지 {1}일 남음',
                scoreSSLMedium: '{0} 인증서 만료까지 {1}일 남음',
                scoreWebsiteExpire: '{0} 웹사이트 만료까지 {1}일 남음',
                ...
                scoreAppFailed: '{0} 애플리케이션 비정상',
                scoreAppStopped: '{0} 애플리케이션 중지됨',
                scoreContainerHigh: '{0} 컨테이너 상태 비정상',
                scoreContainerExited: '{0} 컨테이너 중지됨',
                scoreContainerResource: '{0} 컨테이너 리소스 사용량 과다',
                scoreContainerPublicPort: '{0} 컨테이너에 공개 포트가 있습니다',
                attentionItems: '주의 필요 항목',
                attentionAssets: '주의 필요 자산',
                riskItems: '위험 항목',
                object: '대상',
                description: '설명',
                itemUnit: '건',
                ...
                loginFailed: '로그인 실패',
                sslExpire: '인증서 만료',
                abnormalContainer: '비정상 컨테이너',
                statAttentionDesc: '현재 총 감점 {0}점',
                statLoginDesc: '패널 {0}건 · SSH {1}건',
                statSslDesc: '총 {0}매 인증서 검사',
                statContainerDesc: '총 {0}개 컨테이너 검사',
                assetHostDesc: '디스크 최대 사용률 {0}%',
                assetWebsiteDesc: '{0}매 인증서 만료 임박, {1}개 웹사이트 상태 비정상',
                assetResourceDesc: '{0}개 앱 비정상, {1}개 컨테이너 비정상',
                assetCronjobDesc: '최근 7일간 {0}건 실패 기록, {1}개 작업 미활성화',
                app: '애플리케이션',
                website: '웹사이트',
                websiteSsl: '웹사이트 / 인증서',
                cronjob: '예약 작업',
                ...
                sshLogin: 'SSH 로그인',
                failedRecord: '실패 기록',
                expiredDays: '{0}일 전 만료',
                remainingDays: '{0} · {1}일 남음',
                enabled: '활성화',
                disabled: '비활성화',
                exportRecordFailed: '내보내기 기록 저장 실패',
                hostInfo: '호스트 정보',
                hostname: '호스트명',
                osVersion: '시스템 버전',
                kernelVersion: '커널 버전',
                ...
                memory: '메모리',
                load: '부하',
                maxDiskUsage: '디스크 최대 사용률',
                panelLoginSecurity: '패널 로그인 보안 설정',
                sshSecurity: 'Linux 서버 SSH 보안 설정',
                panelFailedRecords: '패널 로그인 실패 기록',
                sshFailedRecords: 'SSH 로그인 실패 기록',
                location: '소재지',
                configItem: '설정 항목',
                currentValue: '현재 값',
                securityEntrance: '보안 입구',
                configured: '구성됨',
                notConfigured: '미구성',
                normal: '정상',
                needAttention: '주의 필요',
                ...
                unrestricted: '미제한',
                bindDomain: '바인딩 도메인',
                accessRestriction: '접근 제한',
                panelHTTPS: '패널 HTTPS',
                passwordComplexity: '비밀번호 복잡도',
                sshService: 'SSH 서비스',
                running: '실행 중',
                notRunning: '미실행',
                listenPort: '리스닝 포트',
                ...
                keyAuth: '키 인증',
                panelLoginFailed: '패널 로그인 실패',
                sshLoginFailed: 'SSH 로그인 실패',
                panelSecurityItems: '패널 보안 항목',
                sshSecurityItems: 'SSH 보안 항목',
                loginSecurityHealthStatus: '로그인 보안 상태',
                adjustSSHSecurity: 'SSH 보안 조정',
                viewLoginLogs: '로그인 로그 보기',
                riskLevel: '위험 등급',
                goConfig: '설정하기',
                viewMore: '더 보기',
                involvedIPs: '{0}개 IP 관련',
                sessionTimeout: '세션 타임아웃',
                countUnit: '회',
                ...
                securityEntranceRiskDesc: '보안 입구 미개방, 기본 로그인 입구를 숨기는 것을 권장합니다',
                allowIPsRestrictedDesc: '패널 접근 허용 IP가 제한되어 있습니다',
                allowIPsRiskDesc: '접근 IP가 제한되지 않았습니다. 공인 환경에서는 허용 IP 구성을 권장합니다',
                bindDomainRestrictedDesc: '접근 도메인이 바인딩되어 있습니다',
                bindDomainRiskDesc: '접근 도메인이 바인딩되지 않았습니다. 고정 도메인 접근 제한을 권장합니다',
                accessRestrictionValue: '허용 IP: {0} / 바인딩 도메인: {1}',
                accessRestrictionNormalDesc: '허용 IP 또는 바인딩 도메인이 구성되어 패널 접근 경로가 제한됩니다',
                accessRestrictionRiskDesc:
                    '허용 IP와 바인딩 도메인이 모두 미구성되었거나 접근 제한이 없습니다. 최소 하나의 설정을 권장합니다',
                panelHTTPSNormalDesc: '패널 HTTPS가 활성화되어 있습니다',
                panelHTTPSRiskDesc: '패널 HTTPS가 비활성화되어 있습니다. 로그인 구간의 평문 노출 위험이 있습니다',
                passwordComplexityNormalDesc: '비밀번호 복잡도 검증이 활성화되어 있습니다',
                passwordComplexityRiskDesc:
                    '비밀번호 복잡도 검증이 비활성화되어 있습니다. 약한 비밀번호 위험이 높습니다',
                mfa: 'MFA 인증',
                mfaNormalDesc: 'MFA 인증이 활성화되어 로그인 보안이 강화됩니다',
                mfaRiskDesc: 'MFA 인증이 비활성화되어 있습니다. 다중 인증 활성화를 권장합니다',
                sessionTimeoutNormalDesc: '세션 타임아웃이 안전한 범위 내에 있습니다',
                sessionTimeoutRiskDesc: '세션 타임아웃이 깁니다. 유휴 세션 유효기간을 제한하는 것을 권장합니다',
                sshServiceNormalDesc: 'SSH 서비스가 정상 실행 중입니다',
                sshServiceRiskDesc: 'SSH 서비스가 실행되지 않거나 상태가 비정상입니다',
                sshPortNormalDesc: 'SSH 포트가 기본 포트에서 변경되었습니다',
                sshPortRiskDesc: '기본 22 포트를 사용 중입니다. 필요에 따라 변경을 권장합니다',
                rootLoginNormalDesc: 'Root 사용자가 직접 로그인할 수 없습니다',
                rootLoginRiskDesc: 'Root 사용자가 직접 로그인할 수 있습니다. 비활성화를 권장합니다',
                passwordAuthNormalDesc: 'SSH 비밀번호 로그인이 비활성화되어 있습니다',
                passwordAuthRiskDesc: '비밀번호 로그인이 허용되어 있습니다. 무차별 대입 공격 위험이 높습니다',
                keyAuthNormalDesc: 'SSH 키 인증이 활성화되어 있습니다',
                keyAuthRiskDesc: '키 인증이 비활성화되어 있습니다. 키 기반 로그인을 권장합니다',
                websiteOverview: '웹사이트 개요',
                primaryDomain: '주 도메인',
                expireTime: '만료 시간',
                domain: '도메인',
                issuer: '발급 기관',
                autoRenew: '자동 갱신',
                websiteCount: '웹사이트 수',
                httpsWebsite: 'HTTPS 웹사이트',
                certCount: '인증서 수',
                websiteExpire: '웹사이트 만료',
                database: '데이터베이스',
                remoteDatabase: '원격 데이터베이스',
                address: '주소',
                containerResourceUsage: '컨테이너 리소스 사용량',
                spaceUsage: '사용 공간',
                reclaimable: '회수 가능',
                containerReclaimable: '컨테이너 회수 가능',
                image: '이미지',
                volume: '데이터 볼륨',
                buildCache: '빌드 캐시',
                alert: '알림',
                alertConfigured: '알림 구성됨',
                alertOperations: '알림 통보',
                alertTaskCount: '알림 작업',
                enabledAlertTask: '활성 작업',
                disabledAlertTask: '중지 작업',
                alertChannels: '통보 채널',
                alertLogCount: '알림 로그',
                alertSuccessRate: '알림 성공률',
                alertFailedLogs: '실패 알림 로그',
                alertPendingLogs: '동기화 대기 로그',
                alertPending: '동기화 대기',
                alertTaskStats: '알림 작업 통계',
                alertTaskType: '알림 유형',
                alertLogStatusStats: '알림 실행 상태',
                alertHealthNormal: '정상',
                alertHealthAttention: '주의 필요',
                alertHealthRisk: '고위험',
                alertHealthSummary: '알림 건강 상태',
                alertHealthNormalReason: '알림 작업, 통보 채널, 실행 로그가 모두 정상 상태입니다',
                alertNoChannelReason: '활성화된 통보 채널이 없습니다',
                alertFailedLogReason: '{0}건의 실패 로그가 존재합니다',
                alertPendingReason: '{0}건의 알림 로그가 동기화 대기 중입니다',
                alertDisabledTaskReason: '{0}개의 알림 작업이 중지되었습니다',
                alertNoTaskReason: '구성된 알림 작업이 없습니다',
                goAlertConfig: '알림 설정',
                goAlertLogs: '알림 로그',
                configureAlertChannel: '통보 채널 설정',
                createAlertTask: '알림 작업 생성',
                viewAlertTasks: '알림 작업 보기',
                viewFailedAlertLogs: '실패 로그 보기',
                viewAlertLogs: '알림 로그 보기',
                alertChannelSummary: '{0} / {1}개 채널 활성화',
                alertTaskEnabledDesc: '{0}개 작업 활성화',
                alertTaskSummary: '활성 {0}개, 중지 {1}개',
                alertLogSummary: '성공 {0}건, 실패 {1}건',
                alertPendingDesc: '{0}건의 로그 동기화 대기 중',
                alertLogSuccessDesc: '통보 완료',
                alertLogFailedDesc: '채널 설정 또는 전송 경로를 확인하세요',
                alertLogPendingDesc: '오프라인 또는 동기화 경로 대기 중',
                failedAlertLogs: '실패 알림 로그',
                disabledAlertTasks: '중지된 알림 작업',
                alertTableDisplayDesc: '현재 {0}건 표시, 총 {1}건',
                alertMsg: '알림 내용',
                alertMethod: '알림 방식',
                alertRule: '알림 규칙',
                noAlertTask: '알림 작업이 없습니다',
                noFailedAlertLog: '실패 알림 로그가 없습니다',
                noDisabledAlertTask: '중지된 알림 작업이 없습니다',
                alertCronjobType: '예약 작업: {0}',
                alertAllTargets: '전체 대상',
                alertAllDisks: '전체 디스크',
                alertAllCertificates: '전체 인증서',
                alertAllWebsites: '전체 웹사이트',
                alertDiskRuleShort: '{0} {1}{2} 초과, 매일 {3}회',
                alertAverageRuleShort: '{0}분 평균 {1}% 초과, 매일 {2}회',
                alertTimeRuleShort: '{0}일 이내 트리거, {1}회 전송',
                alertSendCountRuleShort: '매일 {0}회 전송',
                alertConfigInvalid: '설정 비정상',
                scoreCategoryAlert: '알림 통보',
                scoreAlertNoTask: '구성된 알림 작업이 없습니다',
                scoreAlertNoEnabledTask: '모든 알림 작업이 비활성화되었습니다',
                scoreAlertDisabledTask: '{0}개의 알림 작업이 중지되었습니다',
                scoreAlertNoChannel: '활성화된 알림 통보 채널이 없습니다',
                scoreAlertFailedHigh: '{0}건의 알림 실패 로그가 존재합니다',
                scoreAlertFailedMedium: '{0}건의 알림 실패 로그가 존재합니다',
                scoreAlertPending: '{0}건의 알림 로그가 동기화 대기 중입니다',
                statAlertDesc: '활성 작업 {0}개 · 채널 {1}개',
                assetAlertDesc: '실패 로그 {0}건, 동기화 대기 {1}건',
                failedExecutionRecords: '실패 실행 기록',
                taskID: '작업 ID',
                executeTime: '실행 시간',
                backupTasks: '백업 작업',
                systemMetrics: '실행 지표',
                ...
                recent24HourPeakPercent: '최근 24시간 피크 {0}',
                loadAverage: '1 / 5 / 15분 부하: {0} / {1} / {2}',
                sourceMount: '마운트 포인트 {0}',
                storageUsage: '저장 공간 사용량',
                localDisk: '로컬 디스크',
                highUsagePeriods: '고부하 시간대',
                timeRange: '시간 범위',
                threshold: '임계값',
                duration: '지속 시간',
                peak: '피크',
                ...
                notCounted: '미산정',
                dataSource: '데이터 소스',
                noHighUsagePeriod: '고부하 시간대가 없습니다',
                monitorDisabledOrNoData: '호스트 모니터링이 미활성화되었거나 모니터 데이터가 없습니다',
                systemHealthStatus: '최근 24시간 호스트 실행 위험 상태',
                mainReasons: '주요 원인',
                viewHostMonitor: '호스트 모니터 보기',
                systemHealthAttentionDesc:
                    '최근 24시간 동안 {0}개의 위험 항목이 감지되었습니다. 리소스 피크와 디스크 사용률을 우선 확인하세요.',
                systemHealthNormalDesc: '최근 24시간 호스트 실행 지표가 정상 상태입니다',
                monitorEnabled: '모니터링 활성화됨',
                cpuCoreUsage: '{0} / {1}코어',
                load1Minute: '1분 부하',
                diskSpaceUsage: '디스크 공간 사용량',
                usedCapacity: '사용량 / 총 용량',
                fileSystem: '파일 시스템',
                resourceTrendSummary: '리소스 추이 요약',
                last24Hours: '최근 24시간',
                granularityHour: '단위: 1시간',
                current: '현재',
                average: '평균',
                totalItems: '총 {0}건',
                to: '~',
                hoursShort: '{0}시간',
                minutesShort: '{0}분',
                websiteStatus: '웹사이트 상태',
                websiteHealthStatus: '웹사이트 보호 건강 상태',
                websiteHealthNormalReason: '웹사이트, 인증서, WAF, 웹사이트 모니터링이 모두 정상입니다',
                websiteHealthAttentionDesc:
                    '{0}개의 위험 항목이 감지되었습니다. 웹사이트 보안과 가용성을 위해 신속히 처리하세요.',
                websiteHealthNormalDesc: '현재 웹사이트 보호 지표가 정상 상태입니다',
                handleSslRisk: '인증서 위험 처리',
                viewWaf: 'WAF 보기',
                priority: '우선순위',
                riskDescription: '위험 설명',
                deductScore: '감점 점수',
                remaining: '잔여',
                wafSourceIpTop: 'WAF 차단 출처 IP TOP5',
                wafAffectedSiteTop: '영향받은 사이트 TOP5',
                sslRisk: '인증서 위험',
                sslExpiring: '인증서 만료 임박',
                includedInReport: '보고서 포함',
                needRenewal: '갱신 권장',
                fromExpireInfo: '만료 정보 기반',
                runningWebsite: '실행 중 웹사이트',
                fromWebsiteStatus: '웹사이트 목록 상태 기반',
                stoppedWebsite: '중지된 웹사이트',
                confirmStoppedWebsite: '예상된 상태인지 확인하세요',
                expiringWebsite: '만료 임박 웹사이트',
                expiringSoon: '만료 임박',
                none: '없음',
                noSslRisk: '처리할 인증서가 없습니다',
                ...
                count5xxSource: '5xx 요청 기준 집계',
                wafIntercept: 'WAF 차단',
                highRiskHit: '고위험 매칭',
                websiteMonitorDisabledOrNoData: '웹사이트 모니터링이 미활성화되었거나 모니터 데이터가 없습니다',
                wafDisabledOrNoData: 'WAF가 미활성화되었거나 차단 데이터가 없습니다',
                noWafData: 'WAF 차단 데이터가 없습니다',
                sourceIP: '출처 IP',
                hitCount: '매칭 횟수',
                level: '등급',
                attackType: '공격 유형',
                ...
                canUpdate: '업그레이드 가능',
                listSeparator: '、',
                containerCount: '컨테이너 수',
                stopped: '중지',
                abnormal: '비정상',
                abnormalContainers: '비정상 컨테이너',
                resourceUsage: '리소스 사용량',
                exposedContainerPorts: '노출 포트',
                portMapping: '포트 매핑',
                risk: '위험',
                noAbnormalContainer: '비정상 컨테이너가 없습니다',
                noExposedContainer: '노출 포트가 감지되지 않았습니다',
                publicExpose: '공인 노출',
                privateExpose: '내부 매핑',
                ...
                resourceThresholdContainers: 'CPU / 메모리 임계치 초과 컨테이너',
                noThresholdExceededContainer: '임계치를 초과한 컨테이너가 없습니다',
                triggerMetric: '트리거 항목',
                ...
                successRate: '성공률',
                failedJobs: '실패 작업',
                recentRecoveryPoint: '최근 복구 지점',
                remoteCoverage: '원격 포함',
                recent7Days: '최근 7일',
                taskTypeStats: '작업 유형 통계',
                total: '합계',
                taskTypeDesc: '활성 {0}개, 미활성 {1}개',
                failedOrAttentionTasks: '실패 또는 주의 필요 작업',
                execution: '실행 현황',
                latestExecution: '최근 실행',
                remoteBackup: '원격 백업',
                localOnly: '로컬만',
                covered: '포함됨',
                noAttentionCronjob: '실패 또는 주의 필요한 예약 작업이 없습니다',
                ...
                generationRule: '생성 규칙',
                scheduleDaily: '매일',
                scheduleDailyDesc: '매일 09:00에 최근 24시간 보고서 생성',
                scheduleWeekly: '매주',
                scheduleWeeklyDesc: '매주 월요일 09:00에 최근 7일 보고서 생성',
                scheduleMonthly: '매월',
                scheduleMonthlyDesc: '매월 1일 09:00에 전월 보고서 생성',
                scheduleCurrentDaily: '매일 09:00에 최근 24시간 보고서 생성 · 다음 {0}',
                scheduleCurrentWeekly: '매주 월요일 09:00에 최근 7일 보고서 생성 · 다음 {0}',
                scheduleCurrentMonthly: '매월 1일 09:00에 전월 보고서 생성 · 다음 {0}',
                notificationMethod: '통보 방식',
                channel: '채널',
                receiver: '수신 대상',
                systemThreshold: '시스템 임계값',
                metric: '지표',
                currentRule: '현재 규칙',
                hostMonitor: '호스트 모니터링',
                monitorInterval: '모니터링 간격',
                exportSettings: '내보내기 설정',
                lastExportReport: '최근 생성 결과',
                noLastExportReport: '내보내기 보고서 기록이 없습니다',
                lastExportStatus: '마지막 내보내기 상태',
                exportFile: '내보내기 파일',
                generateTime: '생성 시간',
                fileSize: '파일 크기',
                viewExportHistory: '내보내기 기록 보기',
                defaultFormat: '기본 형식',
                savePath: '저장 경로',
                savePathRequired: '보고서 저장 경로를 설정하세요',
                autoExport: '자동 내보내기 활성화',
                autoExportDesc: '활성화 시 매일 09:00에 자동으로 운영 보고서를 생성합니다',
                autoExportEnabled: '자동 내보내기 활성화됨',
                autoExportDisabled: '자동 내보내기 비활성화됨',
                readOnlyPermissionTip:
                    '현재 계정은 운영 보고서 설정을 볼 수만 있습니다. 수정이 필요하면 관리자에게 문의하세요.',
                refreshing: '새로고침 중',
                exporting: '내보내기 중',
                exportFailed: '보고서 내보내기 실패',
                generating: '생성 중',
                saved: '저장됨',
                saveFailed: '설정 저장 실패',
                generateNow: '즉시 생성',
                generateSuccess: '보고서 파일 생성됨: {0}',
                generateFailed: '보고서 생성 실패',
                enabledStatus: '활성화',
                disabledStatus: '비활성화',
                thresholdRule: '임계값 {0}, 연속 {1}회 트리거',
                hours: '{0}시간',
                minutes: '{0}분',
                seconds: '{0}초',
                totalExports: '총 내보내기 수',
                successExports: '성공 내보내기',
                failedExports: '실패 내보내기',
                reportName: '보고서 이름',
        ...
        logExport: {
            title: '로그 내보내기',
            records: '내보내기 기록',
            retentionDays: '내보내기 기록 보관 일수',
            timeRange: '시간 범위',
            timeRequired: '내보낼 시간 범위를 선택하세요',
            websiteRequired: '웹사이트를 선택하세요',
            blackStatus: '차단 목록 상태',
            black: '차단됨',
            notBlack: '차단되지 않음',
            fuzzy: '부분 일치',
            regex: '정규식',
            invalidRegex: '256자 이하의 올바른 RE2 정규식을 입력하세요',
            created: '내보내기 작업이 생성되었습니다',
            fileName: '파일 이름',
            fileSize: '파일 크기',
            expiresAt: '만료 시간',
            cancelConfirm: '이 내보내기 작업을 취소하시겠습니까?',
            deleteConfirm: '이 내보내기 기록과 파일을 삭제하시겠습니까?',
        },
        waf: {
            WAF: 'WAF',
            ...
            geoRule: '지역별 접근 제한',
            geoHelper:
                '하나의 스위치로 지역 및 성 정책을 결합합니다. 지역 규칙을 먼저 적용한 다음 성 규칙을 적용합니다.',
            regionPolicy: '지역 정책',
            provincePolicy: '성 정책',
            provinceRuleLabel: '성',
            ...
            hostSearchHelper: 'Host를 입력하여 유사 검색을 지원합니다.',
            toCreate: '생성',
            closeWaf: 'WAF 종료',
            ...
            originProtect: 'CDN 원본 서버 보호',
            attacklog: '차단 기록',
            unknownWebsite: '허가되지 않은 도메인 접근',
            geoRuleEmpty: '지역 또는 성을 하나 이상 선택하세요.',
            unknown: '웹사이트 없음',
            geo: '지역 제한',
            ...
            spiderIpHelper: '활성화하면 선택한 크롤러만 허용하고, 비활성화하면 모든 크롤러 접근을 차단합니다.',
            spiderIp: '스파이더 IP 풀',
            spider: '스파이더',
            spiderAllowlist: '허용할 크롤러',
            spiderAllowlistEmpty: '선택한 크롤러가 없습니다. 저장하면 모든 크롤러 접근이 차단됩니다.',
            geoIp: 'IP 주소 라이브러리',
            ...
            executionStrategy: '실행 정책',
            detectionStrength: '탐지 강도',
            protectionMode: '보호 모드',
            observationMode: '관찰 모드',
            standardMode: '표준 모드',
            observationModeHelper: '요청을 차단하지 않고 탐지 및 로그만 기록합니다',
        ...
        monitor: {
            ...
            originProtection: '원본 서버 보호',
            originProtectionHelper:
                '선택한 IP 그룹의 CDN 노드만 원본 서버에 연결할 수 있습니다. 방문자 실제 IP 식별은 별도 스위치를 사용합니다.',
            originProtectionIPGroups: 'CDN 원본 IP 그룹',
            originProtectionIPGroupsPlaceholder: '신뢰할 CDN 원본 IP 그룹을 선택하세요',
            originProtectionWarning:
                '잘못 설정하면 웹사이트에 접속할 수 없습니다. 모든 CDN 원본 주소가 포함되었는지 확인하세요.',
            originProtectionEnableConfirm:
                '선택한 IP 그룹 외의 연결은 원본 서버 직접 접근으로 간주되어 차단됩니다. 계속하시겠습니까?',
        ...
        node: {
            ...
            syncWithMaster:
                '상용 버전으로 업그레이드 후 모든 데이터가 기본적으로 동기화됩니다. 노드 관리에서 동기화 정책을 수동으로 조정할 수 있습니다.',
        ...
        customApp: {
            ...
            licenseHelper: '상용 버전은 사용자 정의 애플리케이션 저장소 기능을 지원합니다',
        ...
        alert: {
            ...
            licenseHelper: '상용 버전에서는 알림을 지원합니다.',
            ...
            remainingDays: '남은 일수',
            sendCount: '발송 횟수',
            recipientPlaceholder: '이메일 주소를 입력하세요',
            addRecipient: '수신자 추가',
            webhookItem: 'Webhook 링크',
            addWebhook: 'Webhook 추가',
            selectAlertType: '알림 유형 선택',
            configDetail: '세부 설정',
            webhookCount: 'Webhook 수',
            sms: 'SMS',
            wechat: '위챗',
            dingTalk: '딩톡',
            feiShu: '페이슈',
        ...
        vm: {
            ...
            healthCheckResult: {
                ...
                check: {
                    vmName: '가상 머신 이름',
                    libvirtConnection: 'Libvirt 연결',
                    vmDefinition: '가상 머신 정의',
                    domainXML: '가상 머신 XML',
                    architecture: '아키텍처',
                    virtualizationType: '가상화 유형',
                    machineType: '머신 유형',
                    efiCapability: 'EFI 기능',
                    qemuEmulator: 'QEMU 에뮬레이터',
                    bootOrder: '부팅 순서',
                    arm64Firmware: 'ARM64 펌웨어',
                    arm64Features: 'ARM64 기능',
                    arm64Video: 'ARM64 디스플레이',
                    arm64FirmwareFile: 'ARM64 펌웨어 파일',
                    arm64CDROM: 'ARM64 CD-ROM',
                    blockDevice: '블록 장치',
                    isoArchitecture: 'ISO 아키텍처',
                    network: '네트워크',
                    qemuLog: 'QEMU 로그',
                    arm64RuntimeFirmware: 'ARM64 런타임 펌웨어',
                },
                reason: {
                    invalidName: '가상 머신 이름이 올바르지 않습니다.',
                    connectionFailed: '{uri}에 연결할 수 없습니다.',
                    vmNotFound: '가상 머신 {name}을(를) 찾을 수 없습니다.',
                    xmlReadFailed: '가상 머신 XML을 읽지 못했습니다.',
                    liveXMLFallback: '영구 설정을 읽을 수 없어 현재 실행 설정을 사용합니다.',
                    xmlParseFailed: '가상 머신 XML을 분석하지 못했습니다.',
                    stateReadFailed: '가상 머신 상태를 확인할 수 없어 런타임 펌웨어 검사를 건너뛰었습니다.',
                    guestArchMissing: 'XML에 게스트 아키텍처가 없습니다.',
                    archMismatch:
                        '호스트 아키텍처는 {hostArch}, 게스트 아키텍처는 {guestArch}입니다. 교차 아키텍처 실행은 지원되지 않습니다.',
                    nonKVMType: '가상화 유형이 {type}이며 기본 KVM 유형이 아닙니다.',
                    archOrMachineMissing: 'XML에 아키텍처 또는 머신 유형이 없습니다.',
                    machineUnsupported: '호스트가 {arch}/{machine}을(를) 지원하지 않습니다.',
                    emulatorNotSpecified: 'XML에 에뮬레이터가 지정되지 않아 Libvirt가 선택합니다.',
                    fileNotFound: '파일을 찾을 수 없습니다: {path}',
                    fileNotExecutable: '파일을 실행할 수 없습니다: {path}',
                    bootDeviceMissing: 'XML에 부팅 장치가 정의되어 있지 않습니다.',
                    diskNotFirst: '디스크가 첫 번째 부팅 장치가 아닙니다. 현재 순서: {order}',
                    cdromNotInBootOrder: 'CD-ROM이 연결되어 있지만 부팅 순서에 포함되어 있지 않습니다.',
                    firmwareNotConfigured:
                        'EFI 또는 Loader가 설정되지 않아 게스트의 디스플레이 초기화나 부팅이 실패할 수 있습니다.',
                    acpiCustom: 'ACPI가 설정되어 있습니다. 게스트에 필요한 사용자 지정 설정인지 확인하세요.',
                    acpiRequiresUEFI: 'UEFI 없이 ACPI가 설정되어 ACPI requires UEFI 오류가 발생합니다.',
                    apicUnsupported: 'x86 APIC가 설정되어 있지만 ARM64에서는 사용할 수 없습니다.',
                    gicNotDeclared: '영구 XML에 GIC가 없습니다. Libvirt가 런타임에 추가할 수 있습니다.',
                    videoNotConfigured: 'XML에 디스플레이 장치가 설정되어 있지 않습니다.',
                    videoNotVirtio: '디스플레이 장치 유형은 {type}입니다. Virtio 사용을 권장합니다.',
                    firmwareFileMissing: '펌웨어 파일이 없거나 일반 파일이 아닙니다: {path}',
                    firmwareNotAvailable: 'Libvirt에서 EFI 기능을 보고하지 않았으며 ARM64 UEFI 펌웨어도 없습니다.',
                    cdromBusNotSCSI: 'CD-ROM이 {bus} 버스를 사용합니다. ARM64에는 SCSI가 필요합니다.',
                    cdromNotOnVirtioSCSI: 'CD-ROM이 Virtio SCSI 컨트롤러에 연결되어 있지 않습니다.',
                    diskSourceMissing: '{device} {target}에 소스 파일이 설정되어 있지 않습니다.',
                    sourceNotFound: '{device} {target}의 소스 파일이 없습니다: {path}',
                    sourceIsDirectory: '{device} {target}의 소스 경로가 디렉터리입니다: {path}',
                    systemDiskNotFound: '시스템 디스크를 찾지 못했습니다.',
                    isoArchMismatch: '{guestArch} 게스트에 {imageArch}용으로 보이는 이미지가 연결되어 있습니다: {path}',
                    networkReadFailed: '네트워크 {name}을(를) 읽을 수 없습니다.',
                    networkStateReadFailed: '네트워크 {name}의 상태를 읽을 수 없습니다.',
                    networkInactive: '네트워크 {name}이(가) 존재하지만 활성화되지 않았습니다.',
                    logUnavailable: '분석할 수 있는 시작 로그가 없습니다.',
                    logErrorsFound: '최근 시작 기록에서 일반적인 오류가 발견되었습니다.',
                    vmNotRunning: '가상 머신이 실행 중이 아니므로 QEMU 런타임 인수 검사를 건너뛰었습니다.',
                    runtimeFirmwareMissing: 'QEMU 로그에서 pflash, AAVMF 또는 QEMU_EFI 항목을 찾지 못했습니다.',
                },
            },
            dependencies: '종속성',
            ...
            dependencyNotReady: '가상 머신 종속성 검사를 통과하지 못했습니다. 종속성을 처리한 후 사용하세요.',
            helperUnavailable:
                '가상 머신 기능 초기화에 실패했습니다. Core 로그를 확인하거나 다시 업그레이드한 후 사용하세요.',
            cpu: 'CPU',
            memory: '메모리',
            disk: '디스크',
            overview: 'Overview',
            ...
            cpuLimitHelper: '현재 사용 가능한 CPU: {0} 코어',
            cpuLimitExceeded: 'CPU가 제한을 초과했습니다. 현재 최대 사용 가능: {0} 코어.',
            memoryLimitHelper: '현재 할당 가능한 메모리: {0} (호스트는 {1} 메모리를 예약해야 함)',
            memoryLimitExceeded: '메모리가 제한을 초과했습니다. 현재 최대 할당 가능: {0}.',
            storageLimitHelper: '대상 스토리지 풀의 현재 사용 가능 공간: {0}',
            storageLimitExceeded: '디스크 용량이 제한을 초과했습니다. 현재 최대 사용 가능: {0}.',
            iso: 'ISO',
            ...
            deleteTemplateConfirm: '템플릿 {0}을(를) 삭제합니다. 이 작업은 되돌릴 수 없습니다. 계속하시겠습니까?',
            orphanClean: '고아 데이터 정리',
            orphanScan: '다시 검색',
            orphanCleanHelper:
                '가상 머신, 스냅샷 또는 등록된 템플릿에서 참조되지 않는 후보 파일만 표시됩니다. 정리하기 전에 더 이상 사용되지 않는지 확인하세요. 이 작업은 되돌릴 수 없습니다.',
            orphanSelected: '{0}개 파일 선택됨, 총 {1}',
            orphanSize: '크기',
            orphanCleanConfirm: '선택한 {0}개 파일({1})을 정리하시겠습니까? 이 작업은 되돌릴 수 없습니다.',
            orphanCleanSuccess: '{0}개 파일을 정리하여 {1}을(를) 확보했습니다.',
            orphanType: {
                orphan_domain_disk: '고아 디스크',
            ...
            dhcpEnd: 'DHCP 종료 주소',
            bootOrder: '부팅 순서',
            bootDiskFirst: '디스크 우선 (HD → CD-ROM)',
            bootIsoFirst: 'ISO 우선 (CD-ROM → HD)',
            bootOrderConfirm:
                '부팅 순서를 {0}(으)로 변경하시겠습니까? 다음 시작 시 가상 머신은 현재 연결된 부팅 가능한 장치를 이 순서대로 시도합니다.',
            ...
            suspend: '일시 중지',
            resume: '재개',
            operateConfirm: '{0} 가상 머신 [{1}]을(를) 실행하시겠습니까?',
            forceDelete: '강제 삭제',
            forceDeleteHelper:
                '강제 삭제는 VM 삭제 오류를 무시하고 패널 메타데이터를 삭제하며 리소스 사용을 해제합니다.',
            deleteNameHelper: '" 입력 시 이 가상 머신 삭제',
            isoSource: 'ISO 출처',
            downloadFromServer: '원격 다운로드',
            ...
            deleteSourceFileHelper: '선택하면 이 ISO 레코드가 참조하는 원본 파일도 삭제되며 복구할 수 없습니다.',
            dir: '로컬 디렉터리',
        },
        cluster: {
            cluster: '애플리케이션 고가용성',
