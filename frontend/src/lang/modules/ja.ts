...
const message = {
    ...
    aiTools: {
        agents: {
            ...
            verifyModel: '検証モデル',
            verifyModelHelper:
                'このアカウントで利用できるモデルを選択してください。保存時に最小リクエストを送信して接続を検証します。',
            verifyModelRequired: '検証モデルを選択してください',
            discoverModels: 'モデルを取得',
            automaticModelDiscovery: '自動取得',
            manualModelConfiguration: '手動設定',
            discoverModelsHelper: 'プロバイダーの /v1/models API からモデルを取得し、すべてモデルプールに追加します',
            discoverModelsFailedFallback: 'モデルを取得できませんでした。手動でモデルを設定してください。',
        ...
        aiProxy: {
            ...
            logRetentionDays: 'AI ゲートウェイログ保持日数',
            clearLogs: 'ログをクリア',
            clearLogsConfirm:
                'AI ゲートウェイの使用統計、コンテンツコンプライアンス監査、スマートルーティング判断、リクエスト本文ログ、サービスログをクリアします。続行しますか？',
            ...
            requestBodyLogDesc:
                'AI Gateway のリクエスト本文とレスポンス本文を Elasticsearch に保存し、検索、監査、トラブルシュートに使用します。',
    ...
    monitor: {
        ...
        runtimeGoroutines: 'Goroutine 数',
        goroutineSnapshot: 'Goroutine スナップショット',
        goroutineSummary: '{0} 個の Goroutine を {1} 個の呼び出しスタックに集約',
        goroutineTruncated: 'スナップショットが大きすぎるため、一部の呼び出しスタックのみ表示しています。',
        ...
        startCapture: '取得開始',
        capturing: '取得中',
        captureSuccess: '診断ファイルを生成し、ダウンロードを開始しました',
        profileCPU: 'CPU',
        profileHeap: 'ヒープ',
        profileGoroutine: 'Goroutine',
        profileMutex: 'ミューテックス',
        profileBlock: 'ブロック',
        runtimeRSSDesc: 'Go ヒープ、スレッドスタック、ネイティブメモリを含む、プロセスが使用中の物理メモリです。',
        runtimeHeapAllocDesc:
            'Go ヒープに割り当てられ、まだ解放されていないメモリです。継続的な増加はオブジェクトの滞留を示す場合があります。',
        runtimeHeapObjectsDesc:
            'Go ヒープ上の生存オブジェクト数です。継続的な増加はオブジェクトの滞留を示す場合があります。',
        runtimeGoroutineDesc: '現在の軽量な並行タスク数です。継続的な増加は Goroutine リークの確認が必要です。',
        profileCPUDesc: '選択した期間の CPU 呼び出しスタックを取得し、CPU を消費する関数を特定します。',
        profileHeapDesc: '使用中の Go ヒープオブジェクトと割り当てスタックを記録し、メモリ増加を調査します。',
    ...
    xpack: {
        ...
        logExport: {
            title: 'ログをエクスポート',
            records: 'エクスポート履歴',
            retentionDays: 'エクスポート履歴の保持日数',
            timeRange: '期間',
            timeRequired: 'エクスポート期間を選択してください',
            websiteRequired: 'Web サイトを選択してください',
            blackStatus: 'ブラックリスト状態',
            black: '登録済み',
            notBlack: '未登録',
            fuzzy: 'あいまい一致',
            regex: '正規表現',
            invalidRegex: '256 文字以内の有効な RE2 正規表現を入力してください',
            created: 'エクスポートタスクを作成しました',
            fileName: 'ファイル名',
            fileSize: 'ファイルサイズ',
            expiresAt: '有効期限',
            cancelConfirm: 'このエクスポートタスクをキャンセルしますか？',
            deleteConfirm: 'このエクスポート履歴とファイルを削除しますか？',
        },
        waf: {
            name: 'WAF',
            ...
            geoRule: '地域アクセス制限',
            geoHelper:
                '1つのスイッチで地域と省のポリシーを組み合わせます。地域ルールを先に評価し、その後に省ルールを適用します',
            regionPolicy: '地域ポリシー',
            ...
            executionStrategy: '実行ポリシー',
            detectionStrength: '検出強度',
            protectionMode: '防御モード',
            observationMode: '監視モード',
            standardMode: '標準モード',
            observationModeHelper: 'リクエストをブロックせず、検出とログ記録のみを行います',
        ...
        vm: {
            ...
            healthCheckResult: {
                ...
                check: {
                    vmName: '仮想マシン名',
                    libvirtConnection: 'Libvirt 接続',
                    vmDefinition: '仮想マシン定義',
                    domainXML: '仮想マシン XML',
                    architecture: 'アーキテクチャ',
                    virtualizationType: '仮想化タイプ',
                    machineType: 'マシンタイプ',
                    efiCapability: 'EFI 機能',
                    qemuEmulator: 'QEMU エミュレーター',
                    bootOrder: '起動順序',
                    arm64Firmware: 'ARM64 ファームウェア',
                    arm64Features: 'ARM64 機能',
                    arm64Video: 'ARM64 ディスプレイ',
                    arm64FirmwareFile: 'ARM64 ファームウェアファイル',
                    arm64CDROM: 'ARM64 CD-ROM',
                    blockDevice: 'ブロックデバイス',
                    isoArchitecture: 'ISO アーキテクチャ',
                    network: 'ネットワーク',
                    qemuLog: 'QEMU ログ',
                    arm64RuntimeFirmware: 'ARM64 実行時ファームウェア',
                },
                reason: {
                    invalidName: '仮想マシン名が無効です。',
                    connectionFailed: '{uri} に接続できません。',
                    vmNotFound: '仮想マシン {name} が見つかりません。',
                    xmlReadFailed: '仮想マシン XML の読み取りに失敗しました。',
                    liveXMLFallback: '永続設定を読み取れないため、現在の実行設定を使用しています。',
                    xmlParseFailed: '仮想マシン XML の解析に失敗しました。',
                    stateReadFailed: '仮想マシンの状態を確認できないため、実行時ファームウェアの確認を省略しました。',
                    guestArchMissing: 'XML にゲストアーキテクチャがありません。',
                    archMismatch:
                        'ホストのアーキテクチャは {hostArch}、ゲストは {guestArch} です。異なるアーキテクチャ間での実行はサポートされていません。',
                    nonKVMType: '仮想化タイプは {type} で、既定の KVM ではありません。',
                    archOrMachineMissing: 'XML にアーキテクチャまたはマシンタイプがありません。',
                    machineUnsupported: 'ホストは {arch}/{machine} をサポートしていません。',
                    emulatorNotSpecified: 'XML にエミュレーターが指定されていないため、Libvirt が選択します。',
                    fileNotFound: 'ファイルが見つかりません：{path}',
                    fileNotExecutable: 'ファイルを実行できません：{path}',
                    bootDeviceMissing: 'XML に起動デバイスが定義されていません。',
                    diskNotFirst: 'ディスクが最初の起動デバイスではありません。現在の順序：{order}',
                    cdromNotInBootOrder: 'CD-ROM は接続されていますが、起動順序に含まれていません。',
                    firmwareNotConfigured:
                        'EFI または Loader が設定されていないため、ゲストが表示の初期化や起動に失敗する可能性があります。',
                    acpiCustom: 'ACPI が設定されています。このカスタム設定がゲストに必要か確認してください。',
                    acpiRequiresUEFI: 'UEFI なしで ACPI が設定されているため、ACPI requires UEFI エラーが発生します。',
                    apicUnsupported: 'x86 APIC が設定されていますが、ARM64 では使用できません。',
                    gicNotDeclared: '永続 XML に GIC がありません。Libvirt が実行時に追加する場合があります。',
                    videoNotConfigured: 'XML にディスプレイデバイスが設定されていません。',
                    videoNotVirtio: 'ディスプレイデバイスは {type} です。Virtio を推奨します。',
                    firmwareFileMissing: 'ファームウェアファイルが存在しないか、通常ファイルではありません：{path}',
                    firmwareNotAvailable: 'Libvirt に EFI 機能がなく、ARM64 UEFI ファームウェアも見つかりません。',
                    cdromBusNotSCSI: 'CD-ROM は {bus} バスを使用しています。ARM64 では SCSI が必要です。',
                    cdromNotOnVirtioSCSI: 'CD-ROM が Virtio SCSI コントローラーに接続されていません。',
                    diskSourceMissing: '{device} {target} にソースファイルが設定されていません。',
                    sourceNotFound: '{device} {target} のソースファイルが存在しません：{path}',
                    sourceIsDirectory: '{device} {target} のソースパスはディレクトリです：{path}',
                    systemDiskNotFound: 'システムディスクが検出されませんでした。',
                    isoArchMismatch: '{guestArch} ゲストに {imageArch} 用と思われるイメージが接続されています：{path}',
                    networkReadFailed: 'ネットワーク {name} を読み取れません。',
                    networkStateReadFailed: 'ネットワーク {name} の状態を読み取れません。',
                    networkInactive: 'ネットワーク {name} は存在しますが、起動していません。',
                    logUnavailable: '解析できる起動ログがありません。',
                    logErrorsFound: '最新の起動記録に一般的なエラーが見つかりました。',
                    vmNotRunning: '仮想マシンが実行中ではないため、QEMU 実行時引数の確認を省略しました。',
                    runtimeFirmwareMissing: 'QEMU ログに pflash、AAVMF、QEMU_EFI が見つかりません。',
                },
            },
            dependencies: '依存関係',
            ...
            cpuLimitHelper: '現在利用可能な CPU：{0} コア',
            cpuLimitExceeded: 'CPU が上限を超えています。現在利用可能な最大値：{0} コア。',
            memoryLimitHelper: '現在割り当て可能なメモリ：{0}（ホストは {1} のメモリを予約する必要があります）',
            memoryLimitExceeded: 'メモリが上限を超えています。現在割り当て可能な最大値：{0}。',
            storageLimitHelper: '対象ストレージプールの現在の空き容量：{0}',
            storageLimitExceeded: 'ディスク容量が上限を超えています。現在利用可能な最大値：{0}。',
            iso: 'ISO',
            ...
            deleteTemplateConfirm: 'テンプレート {0} を削除します。この操作は元に戻せません。続行しますか？',
            orphanClean: '孤立データのクリーンアップ',
            orphanScan: '再スキャン',
            orphanCleanHelper:
                '仮想マシン、スナップショット、または登録済みテンプレートから参照されていない候補ファイルのみを表示します。削除前に使用されていないことを確認してください。この操作は元に戻せません。',
            orphanSelected: '{0} 個のファイルを選択、合計 {1}',
            orphanSize: 'サイズ',
            orphanCleanConfirm: '選択した {0} 個のファイル（{1}）をクリーンアップしますか？この操作は元に戻せません。',
            orphanCleanSuccess: '{0} 個のファイルをクリーンアップし、{1} を解放しました。',
            orphanType: {
                orphan_domain_disk: '孤立ディスク',
            ...
            dhcpEnd: 'DHCP 終了アドレス',
            bootOrder: '起動順序',
            bootDiskFirst: 'ディスク優先（HD → CD-ROM）',
            bootIsoFirst: 'ISO 優先（CD-ROM → HD）',
            bootOrderConfirm:
                '起動順序を {0} に変更しますか？次回の起動時、仮想マシンは現在接続されている起動可能なデバイスをこの順序で試します。',
            ...
            forceDelete: '強制削除',
            forceDeleteHelper:
                '強制削除は仮想マシン削除エラーを無視し、パネルのメタデータを削除してリソース使用を解放します。',
            deleteNameHelper: '" と入力してこの仮想マシンを削除',
            isoSource: 'ISO ソース',
            downloadFromServer: 'リモートダウンロード',
            isoTargetDir: 'ISO ターゲットパス',
            isoTargetDirHelper:
            ...
            deleteSourceFileHelper: '選択すると、この ISO レコードが参照する元ファイルも削除され、復元できません。',
            dir: 'ローカルディレクトリ',
        },
        cluster: {
