...
const message = {
    ...
    aiTools: {
        ...
        aiProxy: {
            ...
            requestBodyLogEsEndpoint: 'Elasticsearch エンドポイント',
            requestBodyLogEsAuthMethod: 'Elasticsearch 認証方式',
            requestBodyLogEsUsername: 'Elasticsearch ユーザー名',
            requestBodyLogEsPassword: 'Elasticsearch パスワード',
            ...
            deleteUserConfirm: 'ユーザー {0} を削除しますか？',
            userFallback: 'ユーザー {0}',
            ...
            deleteModelGroupConfirm: 'モデルグループ {0} を削除しますか？',
            ...
            apiKeyReset: 'リセット',
            apiKeyCount: '数量',
            deleteGroupConfirm: 'グループ「{name}」を削除しますか？この操作は元に戻せません。',
        },
        skillsHub: {
            title: 'Skills Hub',
