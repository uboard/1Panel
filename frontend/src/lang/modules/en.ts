...
const message = {
    commons: {
        ...
        login: {
            ...
            agreeContent:
                'In order to better protect your legitimate rights and interests, please read and agree to the following agreement &laquo;',
    ...
    aiTools: {
        agents: {
            ...
            batchAction: 'Batch {0}',
            installSkillAction: 'Distribute Skill',
            batchAgentTask: 'Batch {0} agent',
            dispatchAgentTask: 'Dispatch agent {0} tasks',
            dispatchTask: 'Dispatch {0} tasks',
            taskSubmitted: '{0} task has been submitted',
            allNodes: 'All Nodes',
            ...
            skillsMarketSourceLocalHub: 'Local Skill Store',
            skillsScore: 'Score',
            ...
            requireMentionTrue: "Require {'@'}",
            requireMentionFalse: "No {'@'} required",
            requireMentionOpen: 'By group config',
            ...
            allowlistPolicyHelper: '{0}. Used only when {1} is Allowlist.',
            systemPrompt: 'System Prompt',
            groupAllowFrom: 'Group Allowlist',
            groupAllowFromPlaceholder: 'One group ID per line',
            separateSessionByConversation: 'Separate Session By Conversation',
            groupSessionScope: 'Group Session Scope',
            groupSessionScopeGroup: 'Shared By Group',
            groupSessionScopeGroupSender: 'Per Sender',
            sharedMemoryAcrossConversations: 'Share Memory Across Conversations',
            asyncMode: 'Async Mode',
            ackText: 'Ack Text',
            ackTextDefault: 'Task received, processing...',
            streaming: 'Streaming',
            streamingOff: 'Off',
            streamingPartial: 'Partial',
            streamingBlock: 'Blocking',
            ...
            successAndRestart: '{0}. The container is restarting automatically.',
        ...
        model: {
            ...
            endpointLabel: '{0} endpoint',
            acceleratedEndpointLabel: '{0} acceleration endpoint',
            tokenOptionalLabel: '{0} Token (optional)',
            searchSource: 'Search {0}',
            hfEndpointHelper:
        ...
        aiProxy: {
            ...
            logRetentionDays: 'AI Gateway Log Retention (days)',
            clearLogs: 'Clear Logs',
            clearLogsConfirm:
                'This will clear AI Gateway usage statistics, content compliance audits, smart routing decisions, request body logs, and service logs. Continue?',
            ...
            requestBodyLog: 'Request Body Log',
            requestBodyLogDesc:
                'Writes AI Gateway request and response bodies to Elasticsearch for search, audit, and troubleshooting.',
            requestBodyLogIndexPrefix: 'Index Prefix',
            requestBodyLogRetentionDays: 'Request Body Log Retention (days)',
            requestBodyLogMaxBodyKb: 'Max Request Body Size (KB)',
            ...
            deleteTargetConfirm: 'Delete {0} {1}?',
            deleteBackendTitle: 'Delete Model Account',
            userFallback: 'Deleted user (ID: {0})',
            ...
            actionDropHistory: 'Drop history',
            severity: 'Severity',
            severityHigh: 'High',
        ...
        skillsHub: {
            ...
            repositoryGithubOnly: 'Only GitHub repository addresses are supported',
            repositoryRef: 'Branch or Tag',
            repositoryRefPlaceholder: 'Defaults to main, then tries master if it fails',
            repositoryDownloadPreview: 'Target download URL:',
            packageURL: 'Package URL',
            packageURLPlaceholder: 'Enter .zip package address',
            ...
            riskCheckResult: 'Security Check Result',
            noRiskFound: 'No obvious risk found.',
            riskFilePath: 'File Path',
            riskKeyword: 'Matched Keyword or Rule',
            riskDescription: 'Risk Description',
            publishHighRiskConfirm:
                'This Skill has high-risk items and may contain script execution, external downloads, or sensitive information access. Publish anyway?',
            approve: 'Approve',
            reject: 'Reject',
            publish: 'Publish',
            disable: 'Unpublish',
            ...
            copy: 'Copy',
            extract: 'Extract',
            postInstallCommand: 'Post-install Command',
            localSource: 'Local Upload',
            uploadDragTitle: 'Drop a Skill package here, or click to upload',
            uploadFormatLabel: 'Formats:',
            uploadFormatValue: '.zip, .7z, .tar, .tar.gz',
            uploadSizeLabel: 'File size:',
            uploadSizeValue: 'No more than 5 MB per file',
            uploadRequirementLabel: 'Package requirement:',
            uploadRequirementPrefix: 'The Skill package must contain',
            ...
            riskType: {
                ...
                remote_script_execution: 'Remote Script Execution',
                eval_execution: 'Dynamic Execution',
                base64_execution: 'Base64 Decode Execution',
                privileged_command: 'Privileged Command',
                dangerous_delete: 'Dangerous Delete',
                world_writable_permission: 'High-risk Permission',
                credential: 'Suspected Credential',
                sensitive_path: 'Sensitive Path',
                suspicious_download_execute: 'Suspicious Download Execution',
                binary_content: 'Binary Content',
                scan_truncated: 'Scan Truncated',
            },
            riskDescriptionText: {
                script_file: 'Contains script files that may execute local commands.',
                dependency_manifest:
                    'Contains dependency manifests that may fetch external dependencies during install.',
                external_url: 'Contains external URLs. Verify that the outbound addresses are trusted.',
                environment_variable: 'Declares environment variables. Verify their purpose and default values.',
                dockerfile: 'Contains a Dockerfile that may define image build or runtime logic.',
                command_execution:
                    'Contains command execution related calls. Verify that the execution logic is trusted.',
                remote_script_execution: 'Contains logic that downloads and directly runs a remote script.',
                eval_execution: 'Contains dynamic execution through eval.',
                base64_execution: 'Contains logic that executes content after Base64 decoding.',
                privileged_command: 'Contains sudo privilege escalation commands.',
                dangerous_delete: 'Contains dangerous delete commands.',
                world_writable_permission: 'Contains chmod 777 permission changes.',
                credential: 'Contains suspected API Key, Token, Secret, or Password.',
                sensitive_path: 'Contains access to sensitive directories or files.',
                suspicious_download_execute: 'Contains suspicious outbound download or download-and-execute logic.',
                binary_content: 'The file contains NUL bytes and may hide executable or binary content.',
                scan_truncated: 'The file exceeds the scan limit. Unscanned content still requires manual review.',
            },
        },
        benchmark: {
            title: 'Benchmark',
            ...
            tokenizerPlaceholder:
                'Select or enter a local tokenizer directory, e.g. /opt/1panel/tokenizers/DeepSeek-V3',
            runConfig: 'Run Config',
            rawResult: 'Raw Result',
            resultMetrics: 'Result Metrics',
            contextTokens: 'Context Length',
            contextTokensHelper: 'Input token limit plus output token limit for this benchmark.',
            outputThroughput: 'Output Throughput',
            outputThroughputHelper: 'Generated output tokens per second. Higher means faster generation.',
            totalThroughput: 'Total Throughput',
            totalThroughputHelper: 'Input and output tokens processed per second. Used to measure overall capacity.',
            firstTokenLatency: 'First Token Latency',
            firstTokenLatencyHelper:
                'Time from sending the request to receiving the first token. Lower means faster response.',
            tokenValueHelper: 'Enter a positive integer or k value, e.g. 512, 1k, 32k',
            numPrompts: 'Prompts',
            concurrency: 'Concurrency',
            requestRate: 'Request Rate',
            requestRateUnlimited: 'Unlimited (max throughput)',
            requestRateCustom: 'Custom QPS',
            requestRateCustomPlaceholder: 'Requests per second, e.g. 2.5',
        ...
        mcp: {
            ...
            gatewayArgsHelper:
                'Arguments are appended to the supergateway command. Transport, port, path, and protocol arguments managed by 1Panel cannot be changed',
    ...
    terminal: {
        ...
        nodeAdminLocalOnly: 'Node administrators only support local terminals.',
    ...
    file: {
        ...
        aiSearchHint:
            'Search inside file contents line-by-line. Use the buttons on the search row and Advanced options below. When file AI is enabled and saved, a model can also return a Markdown summary.',
        aiSearchAccountTitle: 'AI account',
        aiSearchAccountIntro: 'Pick an agent account for the optional summary and click save after changes.',
        aiSearchAccountEnable: 'Enable file AI search',
        aiSearchSaveAccount: 'Save account',
        aiSearchSectionQuery: 'Search',
        aiSearchSectionConditions: 'Search criteria',
        aiSearchResultsSection: 'Results',
        aiSearchContentLabel: 'Search',
        aiSearchDirLabel: 'Directory',
        aiSearchExtLabel: 'Extensions',
        aiSearchModifiedPreset: 'Modified',
        aiSearchSizePresetLabel: 'File size',
        aiSearchTimeAny: 'Any time',
        aiSearchTime3h: 'Last 3 hours',
        aiSearchTime1d: 'Last 1 day',
        aiSearchTime7d: 'Last 7 days',
        aiSearchTime30d: 'Last 30 days',
        aiSearchTimeCustom: 'Custom range',
        aiSearchSizeAny: 'Any size',
        aiSearchSize0_10mb: '0 ~ 10 MB',
        aiSearchSize10_100mb: '10 MB ~ 100 MB',
        aiSearchSize100_1gb: '100 MB ~ 1 GB',
        aiSearchSizeGte1gb: '≥ 1 GB',
        aiSearchSizeCustom: 'Custom (bytes)',
        aiSearchPlaceholder: 'Keywords or a short question, e.g. files related to logs',
        aiSearchContainSub: 'Recursive',
        aiSearchMaxItems: 'Cap on paths/files included in search (directory listing, 1–2000)',
        aiSearchRun: 'Analyze',
        aiSearchTruncated: 'Too many entries; only part of the listing was sent. Results may be incomplete.',
        aiSearchPreFiltered: 'Paths were pre-filtered by keyword to reduce the set sent to the model.',
        aiSearchMeta: 'Items analyzed: {0} | Duration {1} | Tokens {2}',
        aiSearchQueryRequired: 'Enter keywords or a short description',
        aiSearchContentHits: 'Content matches',
        aiSearchContentScanMeta: 'Content scan: {0} file(s) read (per your search options; limits apply).',
        aiSearchNoLineHits:
            'No lines matched your search in scanned text files. The summary above may still reflect path names and metadata.',
        aiSearchHitsTruncated: 'Some files were not scanned or the hit list was truncated by limits.',
        aiSearchHitFiles: 'Files with matches',
        aiSearchHitLines: 'Matching lines',
        aiSearchOpenFile: 'Open in editor',
        aiSearchOpenAtLine: 'Open at this line',
        aiSearchGrepOnlyHint:
            'File AI is off: only deterministic content search runs—no model. Enable an AI account above for summaries. The search row and options below still apply.',
        aiSearchMatchCase: 'Case sensitive',
        aiSearchWholeWord: 'Whole word (ASCII word boundaries)',
        aiSearchUseRegex: 'Regular expression (RE2 syntax)',
        aiSearchExtensions: 'File extensions (comma-separated, e.g. go,ts,md)',
        aiSearchMinSize: 'Min file size (bytes, 0 = no limit)',
        aiSearchMaxSize: 'Max file size (bytes, 0 = no limit)',
        aiSearchSectionAdvanced: 'Advanced options',
        aiSearchLimitMaxItems: 'Total files to search (cap)',
        aiSearchLimitMaxScan: 'Files to scan',
        aiSearchLimitMaxBytes: 'Per-file read cap (content scan)',
        aiSearchLimitHitsPerFile: 'Hits per file',
        aiSearchLimitTotalHits: 'Total hits cap',
        aiSearchLimitUnitEntries: 'entries',
        aiSearchLimitUnitFiles: 'files',
        aiSearchLimitUnitBytes: 'B',
        aiSearchLimitUnitLines: 'lines',
        aiSearchMaxScanFiles: 'Max files to scan for content',
        aiSearchMaxFileBytes:
            'Max bytes read from each file during content scanning. Unlike the size filter above (on-disk size decides listing), this caps how much is read for matching.',
        aiSearchMaxHitsPerFile: 'Max hits per file',
        aiSearchMaxTotalHits: 'Max total hits',
        aiSearchGrepMetaContent:
            'Content scan: {0} total entries listed, {1} text file(s) read (current filters; size/count limits apply). Duration {2}',
        aiSearchAdvancedResetDefaults: 'Reset to defaults',
        mode: 'Permissions',
    ...
    xpack: {
        ...
        opsReport: {
            ...
            page: {
                ...
                overviewSummary:
                    'Current security level: {0}. {1} points deducted, {2} risk items found, {3} objects checked.',
                riskDistribution: 'Risk Distribution',
                totalDeducted: 'Total deducted',
                noRiskDeducted: 'No deductions',
                scoreTrend: 'Score Trend',
                scoreLevelSafe: 'Safe',
                scoreLevelAttention: 'Needs Attention',
                scoreLevelMediumRisk: 'Medium Risk',
                scoreLevelHighRisk: 'High Risk',
                scoreCategoryHost: 'Host Resources',
                scoreCategoryLogin: 'Login Security',
                ...
                scoreResourceMedium: '{0} current usage is {1}%',
                scoreLoadMedium: 'Current load is {0}',
                scoreMonitorDisabled: 'Host monitoring is disabled',
                ...
                scoreMFADisabled: 'MFA is disabled',
                scoreAllowIPsOpen: 'Allowed IPs and bound domain are not configured or access is unrestricted',
                scorePanelHTTPSDisabled: 'Panel HTTPS is disabled',
                scoreSSHRootLogin: 'SSH root login is allowed',
                scoreSSHPasswordAuth: 'SSH password auth is enabled without key auth',
                scoreSSLExpired: '{0} certificate has expired',
                scoreSSLHigh: '{0} certificate expires in {1} days',
                scoreSSLMedium: '{0} certificate expires in {1} days',
                scoreWebsiteExpired: '{0} website has expired',
                scoreWebsiteExpire: '{0} website expires in {1} days',
                scoreWebsiteHTTP: '{0} does not use HTTPS',
                scoreWebsiteStopped: '{0} status is abnormal',
                scoreWebsiteMonitorUnavailable: 'Website monitoring detected an unavailable site',
                scoreWebsiteMonitorAvailability: 'Website monitoring availability {0}% is below the threshold',
                scoreWebsiteMonitorStatusAbnormal: 'Website monitoring is enabled but in an abnormal state',
                scoreWafDisabled: 'WAF is disabled and websites are not protected',
                scoreWafHighRiskHit: 'WAF matched {0} risk rules in the reporting period',
                scoreCronjobFailed: '{0} cron job failure records in the last 7 days',
                scoreAppFailed: '{0} app is abnormal',
                scoreAppStopped: '{0} app has stopped',
                ...
                scoreContainerPublicPort: '{0} container has public exposed ports',
                ...
                sslExpire: 'Certificate Expiry',
                abnormalContainer: 'Abnormal Containers',
                statAttentionDesc: '{0} points deducted',
                ...
                assetResourceDesc: '{0} abnormal apps, {1} abnormal containers',
                ...
                expired: 'Expired',
                expiredDays: 'Expired {0} days ago',
                remainingDays: '{0} · {1} days left',
                enabled: 'Enabled',
                disabled: 'Disabled',
                exportRecordFailed: 'Failed to save export record',
                hostInfo: 'Host Info',
                hostname: 'Hostname',
                ...
                memory: 'Memory',
                load: 'Load',
                maxDiskUsage: 'Max Disk Usage',
                panelLoginSecurity: 'Panel Login Security',
                sshSecurity: 'Linux Server SSH Security',
                panelFailedRecords: 'Panel Failed Login Records',
                sshFailedRecords: 'SSH Failed Login Records',
                location: 'Location',
                ...
                keyAuth: 'Key Auth',
                panelLoginFailed: 'Panel Failed Logins',
                ...
                allowIPsRestrictedDesc: 'Allowed IPs are restricted for Panel access',
                ...
                accessRestrictionValue: 'Allowed IPs: {0} / Bound Domain: {1}',
                accessRestrictionNormalDesc:
                    'Allowed IPs or bound domain is configured to restrict Panel access sources',
                accessRestrictionRiskDesc:
                    'Allowed IPs and bound domain are not configured or access is unrestricted. Configure at least one',
                ...
                mfa: 'MFA',
                mfaNormalDesc: 'MFA is enabled, improving login security',
                mfaRiskDesc: 'MFA is disabled. Enable multi-factor authentication',
                ...
                httpsWebsite: 'HTTPS Websites',
                certCount: 'Certificates',
                websiteExpire: 'Website Expiry',
                database: 'Databases',
                remoteDatabase: 'Remote Databases',
                address: 'Address',
                containerResourceUsage: 'Container Resource Usage',
                spaceUsage: 'Space Usage',
                reclaimable: 'Reclaimable',
                containerReclaimable: 'Container Reclaimable',
                image: 'Images',
                volume: 'Volumes',
                buildCache: 'Build Cache',
                alert: 'Alert',
                ...
                highUsagePeriods: 'High Usage Periods',
                ...
                needRenewal: 'Renewal recommended',
                fromExpireInfo: 'From expiry information',
                runningWebsite: 'Running Websites',
                fromWebsiteStatus: 'From website list status',
                stoppedWebsite: 'Stopped Websites',
                confirmStoppedWebsite: 'Confirm whether this is expected',
                expiringWebsite: 'Expiring Websites',
                expiringSoon: 'Expiring Soon',
                none: 'None',
                noSslRisk: 'No certificates need handling',
                websiteProtection: 'WAF and Website Monitoring',
                websiteMonitor: 'Website Monitoring',
                waf: 'WAF',
                siteAvailability: 'Site Availability',
                monitoredSites: 'Monitored Sites',
                requestCount: 'Requests',
                abnormalSites: 'Abnormal Sites',
                count5xxSource: 'Counted by 5xx requests',
                wafIntercept: 'WAF Blocks',
                websiteMonitorDisabledOrNoData: 'Website monitoring is disabled or no monitor data is available',
                wafDisabledOrNoData: 'WAF is disabled or no block data is available',
                serviceEnabledButAbnormal: 'Enabled, but in an abnormal state',
                noWafData: 'No WAF block data',
                sourceIP: 'Source IP',
                hitCount: 'Hits',
                level: 'Level',
                attackType: 'Attack Type',
                requestRatio: 'Request Ratio',
                installed: 'Installed',
                ...
                failed: 'Failed',
                success: 'Success',
                canUpdate: 'Upgradable',
                listSeparator: ', ',
                containerCount: 'Containers',
                stopped: 'Stopped',
                abnormal: 'Abnormal',
                abnormalContainers: 'Abnormal Containers',
                resourceUsage: 'Resource Usage',
                exposedContainerPorts: 'Exposed Ports',
                portMapping: 'Port Mapping',
                risk: 'Risk',
                noAbnormalContainer: 'No abnormal containers',
                ...
                resourceThresholdContainers: 'CPU / Memory Threshold Containers',
                noThresholdExceededContainer: 'No containers exceeded the threshold',
                triggerMetric: 'Triggered Metric',
                ...
                recentRecoveryPoint: 'Latest Recovery Point',
                disabledCronjobTasks: 'Disabled Cron Jobs',
                remoteCoverage: 'Remote Coverage',
                recent7Days: 'Last 7 days',
                taskTypeStats: 'Task Type Statistics',
                total: 'Total',
                taskTypeDesc: '{0} enabled, {1} disabled',
                failedOrAttentionTasks: 'Failed or Attention Tasks',
                execution: 'Execution',
                ...
                cronjobHealthAttentionDesc:
                    '{0} attention items detected. Prioritize disabled tasks and failed records.',
                ...
                scheduleWeeklyDesc: 'Generate a report for the last 7 days at 09:00 every Monday',
                scheduleMonthly: 'Monthly',
                scheduleMonthlyDesc: 'Generate a report for the previous month at 09:00 on the 1st',
                scheduleCurrentDaily: 'Every day at 09:00, generate the last 24 hours report · Next {0}',
                scheduleCurrentWeekly: 'Every Monday at 09:00, generate the last 7 days report · Next {0}',
                scheduleCurrentMonthly: 'On the 1st at 09:00, generate the previous month report · Next {0}',
                notificationMethod: 'Notification Methods',
                channel: 'Channel',
                receiver: 'Receiver',
                systemThreshold: 'System Threshold',
                metric: 'Metric',
                ...
                generateSuccess: 'Report file generated: {0}',
                ...
                successExports: 'Successful Exports',
        ...
        waf: {
            ...
            hostSearchHelper: 'Enter the Host to support fuzzy search',
            toCreate: 'Create',
            closeWaf: 'Close WAF',
            ...
            originProtect: 'CDN origin protection',
        ...
        monitor: {
            ...
            realIPRecognition: 'Real IP detection',
            ...
            originProtection: 'Origin protection',
            originProtectionHelper:
                'Only CDN nodes in the selected IP groups may connect to the origin. Visitor real-IP detection uses a separate switch.',
            originProtectionIPGroups: 'CDN origin IP groups',
            originProtectionIPGroupsPlaceholder: 'Select trusted CDN origin IP groups',
            originProtectionWarning:
                'An incorrect configuration may make the website unavailable. Confirm that every CDN origin address is included.',
            originProtectionEnableConfirm:
                'Connections outside the selected IP groups will be treated as direct origin access and blocked. Continue?',
        ...
        vm: {
            ...
            healthCheckResult: {
                ...
                check: {
                    vmName: 'VM name',
                    libvirtConnection: 'Libvirt connection',
                    vmDefinition: 'VM definition',
                    domainXML: 'VM XML',
                    architecture: 'Architecture',
                    virtualizationType: 'Virtualization type',
                    machineType: 'Machine type',
                    efiCapability: 'EFI capability',
                    qemuEmulator: 'QEMU emulator',
                    bootOrder: 'Boot order',
                    arm64Firmware: 'ARM64 firmware',
                    arm64Features: 'ARM64 features',
                    arm64Video: 'ARM64 display',
                    arm64FirmwareFile: 'ARM64 firmware file',
                    arm64CDROM: 'ARM64 CD-ROM',
                    blockDevice: 'Block device',
                    isoArchitecture: 'ISO architecture',
                    network: 'Network',
                    qemuLog: 'QEMU log',
                    arm64RuntimeFirmware: 'ARM64 runtime firmware',
                },
                reason: {
                    invalidName: 'The VM name is invalid.',
                    connectionFailed: 'Unable to connect to {uri}.',
                    vmNotFound: 'VM {name} was not found.',
                    xmlReadFailed: 'Failed to read the VM XML.',
                    liveXMLFallback: 'The persistent configuration could not be read; the live configuration is used.',
                    xmlParseFailed: 'Failed to parse the VM XML.',
                    stateReadFailed: 'The VM state could not be determined. The runtime firmware check was skipped.',
                    guestArchMissing: 'The guest architecture is missing from the XML.',
                    archMismatch:
                        'The host architecture is {hostArch}, while the guest architecture is {guestArch}. Cross-architecture execution is unsupported.',
                    nonKVMType: 'The virtualization type is {type}, not the default KVM type.',
                    archOrMachineMissing: 'The architecture or machine type is missing from the XML.',
                    machineUnsupported: 'The host does not support {arch}/{machine}.',
                    emulatorNotSpecified: 'No emulator is specified in the XML; Libvirt will select one.',
                    fileNotFound: 'File not found: {path}',
                    fileNotExecutable: 'File is not executable: {path}',
                    bootDeviceMissing: 'No boot device is defined in the XML.',
                    diskNotFirst: 'The disk is not the first boot device. Current order: {order}',
                    cdromNotInBootOrder: 'A CD-ROM is attached but is not included in the boot order.',
                    firmwareNotConfigured:
                        'EFI or a loader is not configured, so the guest may fail to display or boot.',
                    acpiCustom: 'ACPI is configured. Confirm that the guest explicitly requires this customization.',
                    acpiRequiresUEFI: 'ACPI is configured without UEFI, which causes “ACPI requires UEFI”.',
                    apicUnsupported: 'x86 APIC is configured, but it is not valid for ARM64.',
                    gicNotDeclared: 'GIC is absent from the persistent XML; Libvirt may add it at runtime.',
                    videoNotConfigured: 'No display device is configured in the XML.',
                    videoNotVirtio: 'The display device type is {type}; Virtio is recommended.',
                    firmwareFileMissing: 'The firmware file does not exist or is not a regular file: {path}',
                    firmwareNotAvailable: 'Libvirt reports no EFI capability, and no ARM64 UEFI firmware was found.',
                    cdromBusNotSCSI: 'The CD-ROM uses the {bus} bus; ARM64 requires SCSI.',
                    cdromNotOnVirtioSCSI: 'The CD-ROM is not attached to a Virtio SCSI controller.',
                    diskSourceMissing: 'No source file is configured for {device} {target}.',
                    sourceNotFound: 'The source file for {device} {target} does not exist: {path}',
                    sourceIsDirectory: 'The source path for {device} {target} is a directory: {path}',
                    systemDiskNotFound: 'No system disk was detected.',
                    isoArchMismatch:
                        'The {guestArch} guest has an image that appears to be for {imageArch} attached: {path}',
                    networkReadFailed: 'Unable to read network {name}.',
                    networkStateReadFailed: 'Unable to read the state of network {name}.',
                    networkInactive: 'Network {name} exists but is inactive.',
                    logUnavailable: 'No startup log is available for analysis.',
                    logErrorsFound: 'Common errors were found in the latest startup record.',
                    vmNotRunning: 'The VM is not running, so the QEMU runtime argument check was skipped.',
                    runtimeFirmwareMissing: 'No pflash, AAVMF, or QEMU_EFI entry was found in the QEMU log.',
                },
            },
            overview: 'Overview',
            ...
            cpuLimitHelper: 'Currently available CPU: {0} cores',
            cpuLimitExceeded: 'CPU exceeds the limit. Current maximum available: {0} cores.',
            memoryLimitHelper: 'Currently allocatable memory: {0} (the host must reserve {1} memory)',
            memoryLimitExceeded: 'Memory exceeds the limit. Current maximum allocatable: {0}.',
            storageLimitHelper: 'Current free space in the target storage pool: {0}',
            storageLimitExceeded: 'Disk capacity exceeds the limit. Current maximum available: {0}.',
            iso: 'ISO',
            ...
            deleteTemplateConfirm: 'Delete template {0}. This operation cannot be rolled back. Continue?',
            orphanClean: 'Orphaned Data Cleanup',
            orphanScan: 'Rescan',
            orphanCleanHelper:
                'Only candidate files not referenced by virtual machines, snapshots, or registered templates are shown. Confirm that a file is no longer in use before cleaning; cleanup cannot be undone.',
            orphanSelected: '{0} files selected, {1} in total',
            orphanSize: 'Size',
            orphanCleanConfirm: 'Clean the selected {0} files ({1})? This operation cannot be undone.',
            orphanCleanSuccess: 'Cleaned {0} files and released {1}.',
            orphanType: {
                orphan_domain_disk: 'Orphaned Disk',
            ...
            dhcpEnd: 'DHCP End',
            bootOrder: 'Boot Order',
            bootDiskFirst: 'Disk first (HD → CD-ROM)',
            bootIsoFirst: 'ISO first (CD-ROM → HD)',
            bootOrderConfirm:
                'Change the boot order to {0}? The VM will try currently mounted, bootable devices in this order the next time it starts.',
            ...
            forceDelete: 'Force delete',
            forceDeleteHelper:
                'Force delete will ignore VM deletion errors, delete panel metadata, and release resource usage.',
            deleteNameHelper: '" to delete this virtual machine',
            isoSource: 'ISO Source',
            downloadFromServer: 'Remote Download',
            ...
            deleteSourceFileHelper:
                'When checked, the source file referenced by this ISO record will also be deleted and cannot be recovered.',
            dir: 'Local Directory',
        },
        cluster: {
