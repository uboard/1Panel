...
const message = {
    ...
    xpack: {
        ...
        vm: {
            ...
            forceDeleteConfirm:
                'Force deletion may hide a VM that still exists or is still running on the host if libvirt cleanup fails. Continue?',
            deleteNameHelper: '" to delete this virtual machine',
            isoSource: 'ISO Source',
            isoTargetDir: 'ISO Save Path',
            isoTargetDirHelper: 'Server-selected and locally uploaded ISO files are saved to this directory.',
            isoTargetDirAvailable: 'The ISO save path is available.',
            isoTargetDirUnavailable: 'The ISO save path must be inside an available VM storage pool.',
            checkPath: 'Check',
            isoSize: 'ISO Size',
            dir: 'Local Directory',
        },
