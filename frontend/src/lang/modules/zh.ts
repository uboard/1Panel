...
const message = {
    ...
    aiTools: {
        agents: {
            ...
            botDuplicateAccountId: '账户 ID 不能重复',
        ...
        aiProxy: {
            ...
            requestBodyLogEsAuthMethod: 'Elasticsearch 认证方式',
            requestBodyLogEsUsername: 'Elasticsearch 用户名',
            requestBodyLogEsPassword: 'Elasticsearch 密码',
            ...
            deleteUserConfirm: '确认删除 API Key {0}？',
            deleteGroupConfirm: '确认删除用户组 {0}？',
            userFallback: '用户 {0}',
            requestModel: '请求模型',
            upstreamModel: '上游模型',
            ...
            deleteModelGroupConfirm: '确认删除模型组 {0}？',
