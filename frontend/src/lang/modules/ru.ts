...
const message = {
    ...
    xpack: {
        ...
        vm: {
            ...
            forceDeleteConfirm:
                'Если очистка libvirt завершится неудачно, принудительное удаление может скрыть ВМ, которая всё ещё существует или работает на хосте. Продолжить?',
            deleteNameHelper: '" для удаления этой виртуальной машины',
            isoSource: 'Источник ISO',
            isoTargetDir: 'Путь сохранения ISO',
            isoTargetDirHelper: 'ISO, выбранные на сервере и загруженные локально, будут сохранены в этом каталоге.',
            isoTargetDirAvailable: 'Путь сохранения ISO доступен.',
            isoTargetDirUnavailable: 'Путь сохранения ISO должен находиться в доступном пуле хранения ВМ.',
            checkPath: 'Проверить',
            isoSize: 'Размер ISO',
