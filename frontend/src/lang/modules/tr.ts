...
const message = {
    ...
    xpack: {
        ...
        vm: {
            ...
            network: 'Ağ',
            networkHelper:
                'Varsayılan olarak default NAT ağı kullanılır. Mevcut bir libvirt ağ adını seçebilir veya girebilirsiniz.',
            ...
            forceDeleteConfirm:
                'libvirt temizliği başarısız olursa zorla silme, ana makinede hâlâ var olan veya çalışan bir VM’i gizleyebilir. Devam edilsin mi?',
            deleteNameHelper: '" yazarak bu sanal makineyi sil',
            isoSource: 'ISO Kaynağı',
            isoTargetDir: 'ISO Kaydetme Yolu',
            isoTargetDirHelper: 'Sunucudan seçilen ve yerel olarak yüklenen ISO dosyaları bu dizine kaydedilir.',
            isoTargetDirAvailable: 'ISO kaydetme yolu kullanılabilir.',
            isoTargetDirUnavailable: 'ISO kaydetme yolu kullanılabilir bir VM depolama havuzunun içinde olmalıdır.',
            checkPath: 'Kontrol Et',
            isoSize: 'ISO Boyutu',
            dir: 'Yerel Dizin',
        },
        cluster: {
