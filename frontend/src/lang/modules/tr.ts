...
const message = {
    commons: {
        ...
        button: {
            ...
            cancel: 'İptal',
            reset: 'Sıfırla',
            setDefault: 'Varsayılanları Geri Yükle',
    ...
    aiTools: {
        agents: {
            ...
            batchAction: 'Toplu {0}',
            installSkillAction: 'Skill dağıt',
            batchAgentTask: 'Aracıları toplu {0}',
            dispatchAgentTask: 'Aracı {0} görevlerini gönder',
            dispatchTask: '{0} görevlerini gönder',
            taskSubmitted: '{0} görevi gönderildi',
            ...
            modelInputTypes: 'Girdi türleri',
            reasoning: 'Akıl yürütme modeli',
            verified: 'Doğrulandı',
            ...
            skillsMarketSourceLocalHub: 'Yerel Skill Mağazası',
            skillsScore: 'Puan',
            ...
            roleMarkdownDescriptions: {
                'AGENTS.md': [
                    ...
                    'Kurallar, öncelikler ve nasıl davranılacağına dair ayrıntılar için uygun yerdir.',
                ],
                'SOUL.md': ['Kişilik, ton ve sınırlar.', 'Her oturumda yüklenir.'],
                'USER.md': ['Kullanıcının kim olduğu ve ona nasıl hitap edileceği.', 'Her oturumda yüklenir.'],
                'IDENTITY.md': [
                    'Ajanın adı, havası ve emojisi.',
                    'Bootstrap ritüeli sırasında oluşturulur veya güncellenir.',
                ],
                'TOOLS.md': [
                    'Yerel araçlar ve kullanım kuralları hakkında notlar.',
                    'Araç kullanılabilirliğini kontrol etmez; yalnızca rehberdir.',
                ],
                'HEARTBEAT.md': [
                    'Heartbeat çalıştırmaları için isteğe bağlı kısa kontrol listesi.',
                    'Token tüketimini azaltmak için kısa tutun.',
                ],
                'BOOT.md': [
                    'Dahili kancalar etkin olduğunda gateway yeniden başlatılırken çalışan isteğe bağlı başlangıç kontrol listesi.',
                    'Kısa tutun; dışa gönderimler için message aracını kullanın.',
                ],
                'BOOTSTRAP.md': [
                    'İlk çalıştırmada bir kez uygulanan ritüel.',
            ...
            dmPolicy: 'DM ilkesi',
            threadSession: 'İş parçacığı oturumu',
            replyMode: 'Yanıt modu',
            requireMention: 'Bahsetme gereksinimi',
            requireMentionTrue: "{'@'} gerekli",
            requireMentionFalse: "{'@'} gerekmez",
            requireMentionOpen: 'Grup yapılandırmasına göre',
            ...
            allowlistPolicyHelper: '{0}. Yalnızca {1} İzin listesi olduğunda kullanılır.',
            systemPrompt: 'Sistem istemi',
            groupAllowFrom: 'Grup izin listesi',
            groupAllowFromPlaceholder: 'Her satıra bir grup ID',
            separateSessionByConversation: 'Oturumu konuşmaya göre ayır',
            groupSessionScope: 'Grup oturum kapsamı',
            groupSessionScopeGroup: 'Grup genelinde paylaşılan',
            groupSessionScopeGroupSender: 'Gönderene göre',
            sharedMemoryAcrossConversations: 'Konuşmalar arasında belleği paylaş',
            asyncMode: 'Asenkron mod',
            ackText: 'Onay metni',
            ackTextDefault: 'Görev alındı, işleniyor...',
            streaming: 'Akış',
            streamingOff: 'Kapalı',
            streamingPartial: 'Kısmi',
            streamingBlock: 'Bloklayıcı',
            streamingProgress: 'İlerleme',
            ...
            successAndRestart: '{0}. Konteyner otomatik olarak yeniden başlatılıyor.',
        ...
        model: {
            ...
            repoID: 'Depo ID',
            endpointLabel: '{0} endpointi',
            acceleratedEndpointLabel: '{0} hızlandırma endpointi',
            tokenOptionalLabel: '{0} Token (isteğe bağlı)',
            searchSource: '{0} ara',
            hfEndpointHelper:
        ...
        proxy: {
            proxy: 'AI Ağ Geçidi Geliştirmesi',
        ...
        aiProxy: {
            ...
            lastError: 'Son hata',
            modelMap: 'Model eşlemesi',
            apiKeyKeepEmpty: 'API Key (değiştirmemek için boş bırakın)',
            apiKeyOnceHint: 'API Key oluşturulduktan sonra yalnızca bir kez gösterilir. Şimdi kopyalayıp kaydedin.',
            apiKeyOnceSave: 'API Key yalnızca bir kez gösterilir. Şimdi kaydedin:',
            qpsLimit: 'QPS sınırı',
            tokenLimit: 'Token sınırı',
            tokenUsed: 'Kullanılan Token',
            tokenRemaining: 'Kalan Token',
            ...
            lbPolicyWeightedRoundRobin: 'Ağırlıklı Round Robin',
            lbPolicyWeightedRoundRobinDesc:
                'İstekleri model hesabı ağırlığına göre dağıtır. Daha yüksek ağırlık daha fazla trafik alır.',
            lbPolicyFailover: 'Failover',
            lbPolicyFailoverDesc:
                'Önce en yüksek öncelikli model hesabını kullanır, hata veya cooldown sonrası bir sonraki kullanılabilir hesaba geçer.',
            maxConcurrency: 'Maksimum eşzamanlılık',
            queueSize: 'Kuyruk boyutu',
            queueTimeoutSeconds: 'Kuyruk bekleme zaman aşımı (sn)',
            requestTimeoutSeconds: 'Akışsız istek zaman aşımı (sn)',
            ...
            serviceOperateConfirm: 'AI Ağ Geçidi servisini {0} onaylıyor musunuz?',
            deleteTargetConfirm: '{0} {1} silinsin mi?',
            deleteBackendTitle: 'Model hesabını sil',
            userFallback: 'Silinen kullanıcı (ID: {0})',
            requestModel: 'İstek modeli',
            ...
            ranking: 'Sıralama',
            rank: 'Sıra',
            promptToken: 'Girdi Token',
            completionToken: 'Çıktı Token',
            totalToken: 'Toplam Token',
        ...
        skillsHub: {
            ...
            repositoryGithubOnly: 'Yalnızca GitHub depo adresleri desteklenir',
            repositoryRef: 'Dal veya Tag',
            repositoryRefPlaceholder: 'Varsayılan main; başarısız olursa master denenir',
            repositoryDownloadPreview: 'Hedef indirme URLsi:',
            packageURL: 'Paket URLsi',
            packageURLPlaceholder: '.zip paket adresini girin',
            ...
            riskCheckResult: 'Güvenlik kontrolü sonucu',
            noRiskFound: 'Belirgin bir risk bulunamadı.',
            riskFilePath: 'Dosya yolu',
            riskKeyword: 'Eşleşen anahtar kelime veya kural',
            riskDescription: 'Risk açıklaması',
            publishHighRiskConfirm:
                'Bu Skill yüksek riskli öğeler içeriyor olabilir: script çalıştırma, harici indirme veya hassas bilgi erişimi. Yine de yayınlansın mı?',
            approve: 'Onayla',
            reject: 'Reddet',
            publish: 'Yayınla',
            ...
            copy: 'Kopyala',
            extract: 'Çıkart',
            postInstallCommand: 'Kurulum sonrası komut',
            localSource: 'Yerel yükleme',
            uploadDragTitle: 'Skill paketini buraya sürükleyin veya yüklemek için tıklayın',
            uploadFormatLabel: 'Biçimler:',
            uploadFormatValue: '.zip, .7z, .tar, .tar.gz',
            uploadSizeLabel: 'Dosya boyutu:',
            uploadSizeValue: 'Dosya başına en fazla 5 MB',
            uploadRequirementLabel: 'Paket gereksinimi:',
            uploadRequirementPrefix: 'Skill paketi şunu içermelidir',
            ...
            disableConfirm: 'Bu Skilli yayından kaldırmak istiyor musunuz? Ajanlara kurulu Skilller etkilenmez.',
            deleteConfirm:
            ...
            riskType: {
                script_file: 'Script dosyası',
                dependency_manifest: 'Bağımlılık bildirimi',
                external_url: 'Harici URL',
                environment_variable: 'Ortam değişkeni',
                dockerfile: 'Dockerfile',
                command_execution: 'Komut çalıştırma',
                remote_script_execution: 'Uzak script çalıştırma',
                eval_execution: 'Dinamik çalıştırma',
                base64_execution: 'Base64 çözme sonrası çalıştırma',
                privileged_command: 'Ayrıcalıklı komut',
                dangerous_delete: 'Tehlikeli silme',
                world_writable_permission: 'Yüksek riskli izin',
                credential: 'Şüpheli kimlik bilgisi',
                sensitive_path: 'Hassas yol',
                suspicious_download_execute: 'Şüpheli indirme ve çalıştırma',
                binary_content: 'İkili içerik',
                scan_truncated: 'Tarama kesildi',
            },
            riskDescriptionText: {
                script_file: 'Yerel komutları çalıştırabilecek script dosyaları içerir.',
                dependency_manifest:
                    'Kurulum sırasında harici bağımlılıkları indirebilecek bağımlılık bildirimleri içerir.',
                external_url: 'Harici URLler içerir. Dış bağlantı adreslerinin güvenilir olduğunu doğrulayın.',
                environment_variable: 'Ortam değişkenleri tanımlar. Amaçlarını ve varsayılan değerlerini doğrulayın.',
                dockerfile: 'İmaj oluşturma veya çalışma zamanı mantığını tanımlayabilecek Dockerfile içerir.',
                command_execution: 'Komut çalıştırma ile ilişkili çağrılar içerir. Çalıştırma mantığını doğrulayın.',
                remote_script_execution: 'Uzak bir scripti indirip doğrudan çalıştıran mantık içerir.',
                eval_execution: 'eval ile dinamik çalıştırma içerir.',
                base64_execution: 'Base64 çözümlemesinden sonra içeriği çalıştıran mantık içerir.',
                privileged_command: 'sudo ayrıcalık yükseltme komutları içerir.',
                dangerous_delete: 'Tehlikeli silme komutları içerir.',
                world_writable_permission: 'chmod 777 izin değişiklikleri içerir.',
                credential: 'Şüpheli API Key, Token, Secret veya Password içerir.',
                sensitive_path: 'Hassas dizinlere veya dosyalara erişim içerir.',
                suspicious_download_execute: 'Şüpheli harici indirme veya indirip çalıştırma mantığı içerir.',
                binary_content: 'Dosya NUL baytları içerir ve çalıştırılabilir veya ikili içeriği gizleyebilir.',
                scan_truncated: 'Dosya tarama sınırını aşıyor. Taranmayan içerik manuel inceleme gerektirir.',
            },
        },
        benchmark: {
            title: 'Benchmark',
            launchCommand: 'Başlatma Komutu',
            ...
            endpoint: 'Endpoint',
            tokenizer: 'Tokenizer',
            tokenizerPlaceholder: 'Yerel tokenizer dizini seçin veya girin, örn. /opt/1panel/tokenizers/DeepSeek-V3',
            runConfig: 'Çalıştırma Yapılandırması',
            rawResult: 'Ham Sonuç',
            resultMetrics: 'Sonuç Metrikleri',
            contextTokens: 'Bağlam Uzunluğu',
            contextTokensHelper: 'Bu benchmark için giriş token sınırı ile çıkış token sınırının toplamı.',
            outputThroughput: 'Çıkış Throughput',
            outputThroughputHelper:
                'Saniye başına üretilen çıkış token sayısı. Daha yüksek değer daha hızlı üretimdir.',
            totalThroughput: 'Toplam Throughput',
            totalThroughputHelper:
                'Saniye başına işlenen giriş ve çıkış token sayısı. Genel kapasiteyi ölçmek için kullanılır.',
            firstTokenLatency: 'İlk Token Gecikmesi',
            firstTokenLatencyHelper:
                'İsteğin gönderilmesinden ilk token alınana kadar geçen süre. Daha düşük değer daha hızlı yanıttır.',
            tokenValueHelper: 'Pozitif tam sayı veya k değeri girin, örn. 512, 1k, 32k',
            numPrompts: 'Prompt',
            concurrency: 'Eşzamanlılık',
            mean: 'Ortalama',
            median: 'Medyan',
            requestRate: 'İstek Hızı',
            requestRateUnlimited: 'Sınırsız (maksimum throughput)',
            requestRateCustom: 'Özel QPS',
            requestRateCustomPlaceholder: 'Saniye başına istek, örn. 2.5',
            successfulRequests: 'Başarılı istekler',
            requestThroughput: 'İstek Throughput',
            timeout: 'Zaman aşımı (saniye)',
            image: 'vLLM İmajı',
            ignoreEos: "EOS'u yok say",
    ...
    monitor: {
        ...
        runtimeRSSDesc: 'Go heap, iş parçacığı yığınları ve yerel bellek dahil işlemin kullandığı fiziksel bellek.',
    ...
    terminal: {
        ...
        nodeAdminLocalOnly: 'Düğüm yöneticileri yalnızca yerel terminali kullanabilir.',
    ...
    toolbox: {
        ...
        clam: {
            ...
            cronHelper: 'Ticari sürüm zamanlanmış taramayı destekler',
    ...
    file: {
        ...
        fileTools: 'Dosya araçları',
        aiSearchHitLines: 'Eşleşen satırlar',
        aiSearch: 'Yapay zeka araması',
        aiSearchTitle: 'Yapay zeka araması',
        aiSearchHint:
            'Dosya içeriğini satır satır arar. Arama satırının sağındaki düğmeleri ve alttaki "Gelişmiş koşullar"ı kullanın. AI hesabı etkinleştirilip kaydedildiğinde Markdown özeti de oluşturulabilir.',
        aiSearchAccountTitle: 'AI hesabı',
        aiSearchAccountIntro: 'Özet için kullanılacak model hesabını seçin, ardından kaydedin.',
        aiSearchAccountEnable: 'Dosya AI aramasını etkinleştir',
        aiSearchSaveAccount: 'Hesap yapılandırmasını kaydet',
        aiSearchSectionQuery: 'Arama',
        aiSearchSectionConditions: 'Arama koşulları',
        aiSearchResultsSection: 'Analiz sonuçları',
        aiSearchContentLabel: 'Arama içeriği',
        aiSearchDirLabel: 'Dizin',
        aiSearchExtLabel: 'Dosya uzantısı',
        aiSearchModifiedPreset: 'Değiştirme zamanı',
        aiSearchSizePresetLabel: 'Dosya boyutu',
        aiSearchTimeAny: 'Her zaman',
        aiSearchTime3h: 'Son 3 saat',
        aiSearchTime1d: 'Son 1 gün',
        aiSearchTime7d: 'Son 7 gün',
        aiSearchTime30d: 'Son 30 gün',
        aiSearchTimeCustom: 'Özel',
        aiSearchSizeAny: 'Boyut sınırı yok',
        aiSearchSize0_10mb: '0 ~ 10 MB',
        aiSearchSize10_100mb: '10 MB ~ 100 MB',
        aiSearchSize100_1gb: '100 MB ~ 1 GB',
        aiSearchSizeGte1gb: '≥ 1 GB',
        aiSearchSizeCustom: 'Özel (bayt)',
        aiSearchPlaceholder: 'Arama içeriğini girin',
        aiSearchContainSub: 'Alt dizin',
        aiSearchMaxItems: 'Aramaya dahil edilen yol/dosya sayısı üst sınırı (dizin listesi, 1–2000)',
        aiSearchRun: 'Analizi başlat',
        aiSearchTruncated: 'Dizin öğesi çok fazla; yalnızca listenin bir kısmı dahil edildi.',
        aiSearchPreFiltered: 'Göreli yollar anahtar kelimeyle önceden filtrelendi.',
        aiSearchMeta: 'Analiz edilen öğeler: {0} | Süre {1} | Token {2}',
        aiSearchQueryRequired: 'Lütfen arama açıklaması veya anahtar kelime girin',
        aiSearchContentHits: 'İçerik eşleşmeleri',
        aiSearchContentScanMeta: 'İçerik taraması: {0} metin dosyası okundu.',
        aiSearchNoLineHits: 'Taranan metin dosyalarında eşleşen satır bulunamadı.',
        aiSearchHitsTruncated: 'Bazı dosyalar taranmadı veya eşleşme listesi sınırlar nedeniyle kısaltıldı.',
        aiSearchHitFiles: 'Eşleşen dosyalar',
        aiSearchOpenFile: 'Düzenleyicide aç',
        aiSearchOpenAtLine: 'Aç ve bu satıra git',
        aiSearchGrepOnlyHint:
            'Dosya AI devre dışı: yalnızca içerik araması çalışır. Özet için yukarıda AI hesabını etkinleştirip kaydedin.',
        aiSearchMatchCase: 'Büyük/küçük harf duyarlı',
        aiSearchWholeWord: 'Tam kelime (İngilizce kelime sınırları \\b)',
        aiSearchUseRegex: 'Düzenli ifade (Go RE2 sözdizimi)',
        aiSearchExtensions: 'Dosya uzantıları (virgülle ayrılmış, örn. go,ts,md)',
        aiSearchMinSize: 'Minimum dosya boyutu (bayt, 0 = sınır yok)',
        aiSearchMaxSize: 'Maksimum dosya boyutu (bayt, 0 = sınır yok)',
        aiSearchSectionAdvanced: 'Gelişmiş koşullar',
        aiSearchLimitMaxItems: 'Toplam aranacak dosya sayısı',
        aiSearchLimitMaxScan: 'İçerik taranacak dosya sayısı',
        aiSearchLimitMaxBytes: 'Dosya başına okuma üst sınırı',
        aiSearchLimitHitsPerFile: 'Dosya başına eşleşen satır sayısı',
        aiSearchLimitTotalHits: 'Toplam eşleşen satır sayısı',
        aiSearchLimitUnitEntries: 'öğe',
        aiSearchLimitUnitFiles: 'dosya',
        aiSearchLimitUnitBytes: 'B',
        aiSearchLimitUnitLines: 'satır',
        aiSearchMaxScanFiles: 'İçerik taraması için maksimum dosya sayısı',
        aiSearchMaxFileBytes:
            'İçerik taraması sırasında her dosyadan okunacak maksimum bayt sayısıdır. Yukarıdaki "Dosya boyutu" filtresinden farklıdır; bu, dosyayı eşleştirmek için gerçekten okunacak miktarı sınırlar.',
        aiSearchMaxHitsPerFile: 'Dosya başına maksimum eşleşme satırı',
        aiSearchMaxTotalHits: 'Toplam eşleşen satır üst sınırı',
        aiSearchGrepMetaContent:
            'İçerik taraması: toplam öğe {0}, okunan metin dosyası {1} (mevcut koşullar; boyut/sayı sınırları uygulanır). Süre {2}',
        aiSearchAdvancedResetDefaults: 'Varsayılan sınırlara dön',
        zip: 'Sıkıştırılmış',
        group: 'Grup',
        path: 'Yol',
        public: 'Diğerleri',
        ...
        historyHint:
            'Her dosya değişikliğinden önceki sürümü kaydeder, içerik değişiklik geçmişini incelemenizi ve içerik ' +
            'sürümlerini geri almanızı sağlar.',
        historySettingTitle: 'Sürüm politikası',
        historyEnable: 'Sürüm geçmişini etkinleştir',
        historyMaxPerPath: 'Dosya başına sakla',
        historyDiskQuota: 'Genel disk kotası (MB)',
        historyCurrentScope: 'Geçerli dosya',
        historyAllScope: 'Tüm dosyalar',
        historyDeleteConfirm: 'Seçilen geçmiş kayıtlarını silmek istediğinizden emin misiniz?',
        historyNeedFile: 'Lütfen önce bir dosya açın',
        historyRestore: 'Bu sürümü geri yükle',
        historyOperationOnlyHint: 'Seçili öğe bir dosya işlemidir ve sürüm geri yüklemeyi desteklemez.',
        historyCurrentFile: 'Geçerli dosya',
        historyLatestVersion:
            'Sol tarafta geçmiş sürümünün içeriği, sağ tarafta seçilen dosyanın en son sürümü gösterilir',
        historyCompareTarget: 'Karşılaştırma hedefi',
        historyCompareTargetPath: 'Karşılaştırma yolu',
        historyRestoreConfirm: 'Bu sürümü geçerli dosyaya geri yüklemek istiyor musunuz?',
        historyRestoreDirtyConfirm:
            'Geçerli dosyada kaydedilmemiş değişiklikler var. Geri yükleme bunların üzerine yazacaktır. Devam ' +
            'edilsin mi?',
        historyRestoreSuccess: 'Sürüm başarıyla geri yüklendi',
        historyDirtyHint:
            'Geçerli düzenleyicide kaydedilmemiş değişiklikler var. Bir sürümü geri yüklemek bunların üzerine ' +
            'yazacaktır.',
        historyDiffHintCurrent: 'Sol tarafta geçmiş sürümünün içeriği, sağ tarafta geçerli dosyanın içeriği gösterilir',
        historyDiffHintAll:
            'Sol tarafta geçmiş sürümünün içeriği, sağ tarafta seçilen dosyanın en son sürümü gösterilir',
        copyDir: 'Kopyala',
        ...
        shareClose: 'Close',
        shareCancel: 'Paylaşımı iptal et',
        shareCancelConfirm: 'Bu dosya paylaşımını iptal etmek istediğinize emin misiniz?',
        shareDetail: 'Details',
    ...
    setting: {
        ...
        docSourceTip: 'Dokümantasyon ve güncelleme günlüğü bağlantılarının dilini belirler.',
        languageHelper:
        ...
        proxyHelper1: 'Uygulama mağazasından kurulum paketi indirme ve senkronizasyon (yalnızca Ticari sürüm)',
        proxyHelper2: 'Sistem güncellemeleri ve güncelleme bilgilerini alma (yalnızca Ticari sürüm)',
        proxyHelper3: 'Sistem lisansı doğrulama ve senkronizasyon',
        proxyHelper4: 'Docker imajı çekme gibi ağ istekleri vekil sunucu üzerinden yapılır (yalnızca Ticari sürüm)',
        proxyHelper5:
            'Sistem komut dosyası kütüphaneleri için birleşik indirme ve senkronizasyon (Ticari sürüm özelliği)',
        proxyHelper6: 'Sertifika başvurusu (Ticari sürüm özelliği)',
        ...
        apiInterfaceAlert3: 'API dokümantasyonu',
        apiInterfaceAlert4: 'Kullanım kılavuzu',
        apiKey: 'API anahtarı',
        ...
        passwordEmptyTip: 'Geçerli parolayı değiştirmemek için boş bırakın',
    ...
    app: {
        ...
        appOfficeWebsite: 'Resmi web sitesi',
        github: 'GitHub',
        ...
        takeDown: 'Kullanımdan kaldırıldı',
        ...
        openclawHttpsUpgradeNoticeTitle:
            "Not: Aşağıdaki talimatlar yalnızca OpenClaw'ı 2026.3.13-2026.3.22 sürümlerinden 2026.3.23 veya sonraki bir sürüme yükselten kullanıcılar için geçerlidir:",
        openclawHttpsUpgradeNoticeItem1:
            'Yükseltmeden sonra ajan erişimi yeniden HTTP kullanır. Yapılandırma -> Ayarlar -> Güvenlik bölümüne giderek erişim adresini kontrol edin.',
        openclawHttpsUpgradeNoticeItem2:
            'Daha önce ters proxy web sitesi kullandıysanız, proxy hedefini http://IP:Port olarak değiştirin.',
        ...
        isEdirWarn: 'docker-compose.yml dosyasında değişiklikler algılandı. Lütfen farkları inceleyin.',
    },
    website: {
    ...
    xpack: {
        ...
        opsReport: {
            ...
            overview: 'Genel Bakış',
            system: 'Ana Makine Çalışması',
            login: 'Giriş ve Güvenlik',
            ...
            page: {
                enterprise: 'Kurumsal',
                reportNode: 'Rapor Düğümü',
                selectReportNode: 'Rapor düğümü seçin',
                currentNode: 'Geçerli Düğüm',
                scoreMeta: '{0} puan düşüldü · {1} risk',
                hostAddress: 'Ana Makine Adresi',
                panelVersion: 'Panel Sürümü',
                cpuCores: 'Fiziksel Çekirdek',
                coreUnit: '{0} Çekirdek',
                memoryTotal: 'Toplam Bellek',
                reportDate: 'Rapor Tarihi',
                serverSecurityOverview: 'Sunucu Güvenlik Operasyon Genel Bakışı',
                securityScore: 'Güvenlik Puanı',
                overviewSummary:
                    'Mevcut güvenlik seviyesi: {0}. {1} puan düşüldü, {2} risk öğesi bulundu, {3} nesne kontrol edildi.',
                riskDistribution: 'Risk Dağılımı',
                totalDeducted: 'Toplam Düşülen',
                noRiskDeducted: 'Düşülme yok',
                scoreTrend: 'Puan Trendi',
                scoreLevelSafe: 'Güvenli',
                scoreLevelAttention: 'Dikkat Gerekli',
                scoreLevelMediumRisk: 'Orta Risk',
                scoreLevelHighRisk: 'Yüksek Risk',
                scoreCategoryHost: 'Ana Makine Kaynakları',
                scoreCategoryLogin: 'Giriş Güvenliği',
                scoreCategoryWebsite: 'Web Siteleri ve Sertifikalar',
                scoreCategoryCronjob: 'Zamanlanmış Görevler',
                scoreCategoryResource: 'Çalışma Kaynakları',
                scoreDiskHigh: 'Disk {0} kullanımı %{1}',
                scoreDiskMedium: 'Disk {0} kullanımı %{1}',
                scoreResourceHigh: '{0} mevcut kullanımı %{1}',
                scoreResourceMedium: '{0} mevcut kullanımı %{1}',
                scoreLoadMedium: 'Mevcut yük {0}',
                scoreMonitorDisabled: 'Ana makine izleme devre dışı',
                scorePanelLoginFailedHigh: 'Panel girişi {0} kez başarısız oldu',
                scorePanelLoginFailedMedium: 'Panel girişi {0} kez başarısız oldu',
                scoreSSHLoginFailedHigh: 'SSH girişi {0} kez başarısız oldu',
                scoreSSHLoginFailedMedium: 'SSH girişi {0} kez başarısız oldu',
                scoreMFADisabled: 'MFA devre dışı',
                scoreAllowIPsOpen: "İzin verilen IP'ler ve bağlı alan adı yapılandırılmamış veya erişim kısıtlanmamış",
                scorePanelHTTPSDisabled: 'Panel HTTPS devre dışı',
                scoreSSHRootLogin: 'SSH root girişi etkin',
                scoreSSHPasswordAuth: 'SSH şifre doğrulaması etkin, anahtar doğrulaması devre dışı',
                scoreSSLHigh: '{0} sertifikasının {1} günü kaldı',
                scoreSSLMedium: '{0} sertifikasının {1} günü kaldı',
                scoreWebsiteExpire: '{0} web sitesinin {1} günü kaldı',
                scoreWebsiteHTTP: '{0} HTTPS kullanmıyor',
                ...
                scoreAppFailed: '{0} uygulama anormal',
                scoreAppStopped: '{0} uygulama durdu',
                scoreContainerHigh: '{0} konteyner durumu anormal',
                scoreContainerExited: '{0} konteyner durdu',
                scoreContainerResource: '{0} konteyner kaynak kullanımı yüksek',
                scoreContainerPublicPort: '{0} konteynerinde herkese açık portlar var',
                attentionItems: 'Dikkat Öğeleri',
                attentionAssets: 'Dikkat Varlıkları',
                riskItems: 'Risk Öğeleri',
                object: 'Nesne',
                description: 'Açıklama',
                itemUnit: 'öğe',
                recordUnit: 'kayıt',
                certUnit: 'sertifika',
                containerUnit: 'konteyner',
                loginFailed: 'Başarısız Girişler',
                sslExpire: 'Sertifika Süresi',
                abnormalContainer: 'Anormal Konteynerler',
                statAttentionDesc: 'Toplam {0} puan düşüldü',
                statLoginDesc: 'Panel {0} · SSH {1}',
                statSslDesc: '{0} sertifika kontrol edildi',
                statContainerDesc: '{0} konteyner kontrol edildi',
                assetHostDesc: 'Disk en yüksek kullanım %{0}',
                assetWebsiteDesc: '{0} sertifika süresi dolmak üzere, {1} anormal web sitesi',
                assetResourceDesc: '{0} anormal uygulama, {1} anormal konteyner',
                assetCronjobDesc: 'Son 7 günde {0} başarısızlık kaydı, {1} görev devre dışı',
                app: 'Uygulamalar',
                website: 'Web Siteleri',
                websiteSsl: 'Web Siteleri / Sertifikalar',
                cronjob: 'Zamanlanmış Görevler',
                container: 'Konteynerler',
                sslCertificate: 'SSL Sertifikaları',
                loginSecurity: 'Giriş Güvenliği',
                panelLogin: 'Panel Girişi',
                sshLogin: 'SSH Girişi',
                failedRecord: 'Başarısız Kayıtlar',
                expiredDays: '{0} gün önce süresi doldu',
                remainingDays: '{0} · {1} gün kaldı',
                enabled: 'Etkin',
                disabled: 'Devre dışı',
                exportRecordFailed: 'Dışa aktarma kaydı kaydedilemedi',
                hostInfo: 'Ana Makine Bilgisi',
                ...
                memory: 'Bellek',
                load: 'Yük',
                maxDiskUsage: 'Disk En Yüksek Kullanım',
                panelLoginSecurity: 'Panel Giriş Güvenlik Yapılandırması',
                sshSecurity: 'Linux Sunucu SSH Güvenlik Yapılandırması',
                panelFailedRecords: 'Panel Başarısız Giriş Kayıtları',
                sshFailedRecords: 'SSH Başarısız Giriş Kayıtları',
                location: 'Konum',
                configItem: 'Yapılandırma Öğesi',
                currentValue: 'Mevcut Değer',
                securityEntrance: 'Güvenlik Girişi',
                configured: 'Yapılandırılmış',
                notConfigured: 'Yapılandırılmamış',
                normal: 'Normal',
                needAttention: 'Dikkat Gerekli',
                allowIPs: "İzin Verilen IP'ler",
                restricted: 'Kısıtlanmış',
                unrestricted: 'Kısıtlanmamış',
                bindDomain: 'Bağlı Alan Adı',
                accessRestriction: 'Erişim Kısıtlaması',
                panelHTTPS: 'Panel HTTPS',
                passwordComplexity: 'Şifre Karmaşıklığı',
                sshService: 'SSH Servisi',
                running: 'Çalışıyor',
                notRunning: 'Çalışmıyor',
                listenPort: 'Dinleme Portu',
                read: 'Okundu',
                rootLogin: 'Root Girişi',
                passwordAuth: 'Şifre Doğrulaması',
                keyAuth: 'Anahtar Doğrulaması',
                panelLoginFailed: 'Panel Başarısız Girişler',
                sshLoginFailed: 'SSH Başarısız Girişler',
                panelSecurityItems: 'Panel Güvenlik Öğeleri',
                sshSecurityItems: 'SSH Güvenlik Öğeleri',
                loginSecurityHealthStatus: 'Giriş Güvenliği Sağlık Durumu',
                adjustSSHSecurity: 'SSH Güvenliğini Ayarla',
                viewLoginLogs: 'Giriş Günlüklerini Gör',
                riskLevel: 'Risk Seviyesi',
                goConfig: 'Yapılandır',
                viewMore: 'Daha Fazla Gör',
                involvedIPs: '{0} IP ilgili',
                sessionTimeout: 'Oturum Zaman Aşımı',
                countUnit: 'kez',
                recent24Hours: 'Son 24 saat',
                currentService: 'Mevcut servis',
                riskItemsExist: '{0} risk öğesi mevcut',
                loginHealthRiskDesc:
                    '{0} riskli yapılandırma algılandı. Saldırı riskini azaltmak için giriş güvenliğini güçlendirin.',
                loginHealthNormalDesc: 'Mevcut giriş ve SSH güvenlik yapılandırmaları normal durumda',
                loginHealthNormalReason: 'Giriş güvenliği normal',
                securityEntranceConfiguredDesc:
                    'Güvenlik girişi yapılandırılmış, varsayılan giriş maruziyeti azaltılmış',
                securityEntranceRiskDesc: 'Güvenlik girişi devre dışı. Varsayılan giriş girişini gizleyin',
                allowIPsRestrictedDesc: "Panel erişimi için izin verilen IP'ler kısıtlanmış",
                allowIPsRiskDesc: "Erişim IP'leri kısıtlanmamış. Genel ortamlar için izin verilen IP'leri yapılandırın",
                bindDomainRestrictedDesc: 'Erişim alan adı bağlanmış',
                bindDomainRiskDesc: 'Erişim alan adı bağlanmamış. Erişimi sabit bir alan adıyla kısıtlayın',
                accessRestrictionValue: "İzin verilen IP'ler: {0} / Bağlı alan adı: {1}",
                accessRestrictionNormalDesc:
                    "Panel erişim kaynaklarını kısıtlamak için izin verilen IP'ler veya bağlı alan adı yapılandırılmış",
                accessRestrictionRiskDesc:
                    "İzin verilen IP'ler ve bağlı alan adı yapılandırılmamış veya erişim kısıtlanmamış. En az birini yapılandırın",
                panelHTTPSNormalDesc: 'Panel HTTPS etkin',
                panelHTTPSRiskDesc: 'Panel HTTPS devre dışı. Giriş trafiği açığa çıkabilir',
                passwordComplexityNormalDesc: 'Şifre karmaşıklık doğrulaması etkin',
                passwordComplexityRiskDesc: 'Şifre karmaşıklık doğrulaması devre dışı, zayıf şifre riski yüksek',
                sessionTimeoutNormalDesc: 'Oturum zaman aşımı güvenli aralıkta',
                sessionTimeoutRiskDesc: 'Oturum zaman aşımı uzun. Boş oturum geçerlilik süresini kısıtlayın',
                sshServiceNormalDesc: 'SSH servisi normal çalışıyor',
                sshServiceRiskDesc: 'SSH servisi çalışmıyor veya durumu anormal',
                sshPortNormalDesc: 'SSH portu varsayılan porttan değiştirilmiş',
                sshPortRiskDesc: 'Hâlâ varsayılan 22 portunu kullanıyor, gerektiğinde değiştirin',
                rootLoginNormalDesc: 'Root kullanıcısı doğrudan giriş yapamaz',
                rootLoginRiskDesc: 'Root kullanıcısı doğrudan giriş yapabilir. Devre dışı bırakın',
                passwordAuthNormalDesc: 'SSH şifre girişi devre dışı',
                passwordAuthRiskDesc: 'Şifre girişi etkin, kaba kuvvet saldırısı riski yüksek',
                keyAuthNormalDesc: 'SSH anahtar doğrulaması etkin',
                keyAuthRiskDesc: 'Anahtar doğrulaması devre dışı. Anahtar tabanlı giriş kullanın',
                websiteOverview: 'Web Sitesi Genel Bakışı',
                primaryDomain: 'Birincil Alan Adı',
                expireTime: 'Son Kullanma Tarihi',
                domain: 'Alan Adı',
                issuer: 'Düzenleyen Kurum',
                autoRenew: 'Otomatik Yenileme',
                websiteCount: 'Web Sitesi Sayısı',
                httpsWebsite: 'HTTPS Web Siteleri',
                certCount: 'Sertifika Sayısı',
                websiteExpire: 'Web Sitesi Süresi',
                database: 'Veritabanları',
                remoteDatabase: 'Uzak Veritabanları',
                address: 'Adres',
                containerResourceUsage: 'Konteyner Kaynak Kullanımı',
                spaceUsage: 'Alan Kullanımı',
                reclaimable: 'Geri Kazanılabilir',
                containerReclaimable: 'Konteyner Geri Kazanılabilir',
                image: 'İmajlar',
                volume: 'Birimler',
                buildCache: 'Derleme Önbelleği',
                alert: 'Uyarı',
                alertConfigured: 'Uyarılar Yapılandırılmış',
                alertOperations: 'Uyarı Bildirimleri',
                alertTaskCount: 'Uyarı Görevleri',
                enabledAlertTask: 'Etkin Görevler',
                disabledAlertTask: 'Devre Dışı Görevler',
                alertChannels: 'Bildirim Kanalları',
                alertLogCount: 'Uyarı Günlükleri',
                alertSuccessRate: 'Uyarı Başarı Oranı',
                alertFailedLogs: 'Başarısız Uyarı Günlükleri',
                alertPendingLogs: 'Senkronize Edilecek Günlükler',
                alertPending: 'Senkronizasyon Bekliyor',
                alertTaskStats: 'Uyarı Görev İstatistikleri',
                alertTaskType: 'Uyarı Türü',
                alertLogStatusStats: 'Uyarı Yürütme Durumu',
                alertHealthNormal: 'Normal',
                alertHealthAttention: 'Dikkat Gerekli',
                alertHealthRisk: 'Yüksek Risk',
                alertHealthSummary: 'Uyarı Sağlık Durumu',
                alertHealthNormalReason: 'Uyarı görevleri, bildirim kanalları ve yürütme günlükleri sağlıklı',
                alertNoChannelReason: 'Bildirim kanalı etkin değil',
                alertFailedLogReason: '{0} başarısız uyarI günlüğü bulundu',
                alertPendingReason: '{0} uyarI günlüğü senkronizasyon bekliyor',
                alertDisabledTaskReason: '{0} uyarI görevi devre dışı',
                alertNoTaskReason: 'UyarI görevi yapılandırılmamış',
                goAlertConfig: 'UyarI Yapılandırması',
                goAlertLogs: 'UyarI Günlükleri',
                configureAlertChannel: 'Kanalları Yapılandır',
                createAlertTask: 'UyarI Görevi Oluştur',
                viewAlertTasks: 'UyarI Görevlerini Gör',
                viewFailedAlertLogs: 'Başarısız Günlükleri Gör',
                viewAlertLogs: 'UyarI Günlüklerini Gör',
                alertChannelSummary: '{0} / {1} kanal etkin',
                alertTaskEnabledDesc: '{0} görev etkin',
                alertTaskSummary: '{0} etkin, {1} devre dışı',
                alertLogSummary: '{0} başarılı, {1} başarısız',
                alertPendingDesc: '{0} günlük senkronizasyon bekliyor',
                alertLogSuccessDesc: 'Bildirim tamamlandı',
                alertLogFailedDesc: 'Kanal yapılandırmasını veya teslim yolunu kontrol edin',
                alertLogPendingDesc: 'Çevrimdışı veya senkronizasyon yolu bekliyor',
                failedAlertLogs: 'Başarısız Uyarı Günlükleri',
                disabledAlertTasks: 'Devre Dışı Uyarı Görevleri',
                alertTableDisplayDesc: '{1} öğeden {0} gösteriliyor',
                alertMsg: 'Uyarı İçeriği',
                alertMethod: 'Uyarı Yöntemi',
                alertRule: 'Uyarı Kuralı',
                noAlertTask: 'Uyarı görevi yok',
                noFailedAlertLog: 'Başarısız uyarI günlüğü yok',
                noDisabledAlertTask: 'Devre dışı uyarI görevi yok',
                alertCronjobType: 'Zamanlanmış Görev: {0}',
                alertAllTargets: 'Tüm Hedefler',
                alertAllDisks: 'Tüm Diskler',
                alertAllCertificates: 'Tüm Sertifikalar',
                alertAllWebsites: 'Tüm Web Siteleri',
                alertDiskRuleShort: '{0} {1}{2} aşıyor, günde {3} kez',
                alertAverageRuleShort: '{0} dk ortalama %{1} aşıyor, günde {2} kez',
                alertTimeRuleShort: '{0} gün içinde tetikle, {1} kez gönder',
                alertSendCountRuleShort: 'Günde {0} kez gönder',
                alertConfigInvalid: 'Geçersiz Yapılandırma',
                scoreCategoryAlert: 'Uyarı Bildirimleri',
                scoreAlertNoTask: 'Uyarı görevi yapılandırılmamış',
                scoreAlertNoEnabledTask: 'Tüm uyarı görevleri devre dışı',
                scoreAlertDisabledTask: '{0} uyarI görevi devre dışı',
                scoreAlertNoChannel: 'Uyarı bildirim kanalı etkin değil',
                scoreAlertFailedHigh: '{0} uyarI başarısızlık günlüğü bulundu',
                scoreAlertFailedMedium: '{0} uyarI başarısızlık günlüğü bulundu',
                scoreAlertPending: '{0} uyarI günlüğü senkronizasyon bekliyor',
                statAlertDesc: '{0} etkin görev · {1} kanal',
                assetAlertDesc: '{0} başarısız günlük, {1} senkronizasyon bekleyen günlük',
                failedExecutionRecords: 'Başarısız Yürütme Kayıtları',
                taskID: 'Görev ID',
                executeTime: 'Yürütme Zamanı',
                backupTasks: 'Yedekleme Görevleri',
                systemMetrics: 'Çalışma Metrikleri',
                cpu: 'CPU',
                thresholdPercent: 'Eşik %{0}',
                recent24HourPeakPercent: 'Son 24 saat zirve {0}',
                loadAverage: '1 / 5 / 15 dakika yük: {0} / {1} / {2}',
                sourceMount: 'Bağlama noktası {0}',
                storageUsage: 'Depolama Kullanımı',
                localDisk: 'Yerel Disk',
                highUsagePeriods: 'Yüksek Kullanım Dönemleri',
                ...
                scoring: 'Puanlama',
                counted: 'Dahil',
                notCounted: 'Dahil Değil',
                dataSource: 'Veri Kaynağı',
                noHighUsagePeriod: 'Yüksek kullanım dönemi yok',
                monitorDisabledOrNoData: 'Ana makine izleme devre dışı veya izleme verisi yok',
                systemHealthStatus: 'Son 24 saat ana makine çalışma risk durumu',
                mainReasons: 'Başlıca Nedenler',
                viewHostMonitor: 'Ana Makine İzlemeyi Gör',
                systemHealthAttentionDesc:
                    'Son 24 saatte {0} risk öğesi algılandı. Kaynak zirvelerine ve disk kullanımına öncelik verin.',
                systemHealthNormalDesc: 'Son 24 saatte ana makine çalışma metrikleri normaldi',
                monitorEnabled: 'İzleme Etkin',
                cpuCoreUsage: '{0} / {1} çekirdek',
                load1Minute: '1 dk yük',
                diskSpaceUsage: 'Disk Alanı Kullanımı',
                usedCapacity: 'Kullanılan / Toplam',
                fileSystem: 'Dosya Sistemi',
                resourceTrendSummary: 'Kaynak Trend Özeti',
                last24Hours: 'Son 24 Saat',
                granularityHour: 'Hassasiyet: 1 saat',
                current: 'Mevcut',
                average: 'Ortalama',
                totalItems: 'Toplam {0} öğe',
                to: '-',
                hoursShort: '{0} saat',
                minutesShort: '{0} dk',
                websiteStatus: 'Web Sitesi Durumu',
                websiteHealthStatus: 'Web Sitesi Koruma Sağlığı',
                websiteHealthNormalReason: 'Web siteleri, sertifikalar, WAF ve web sitesi izleme sağlıklı',
                websiteHealthAttentionDesc:
                    '{0} risk öğesi algılandı. Web sitesi güvenliğini ve kullanılabilirliğini korumak için yakında ele alın.',
                websiteHealthNormalDesc: 'Mevcut web sitesi koruma metrikleri normal',
                handleSslRisk: 'Sertifika Risklerini Ele Al',
                viewWaf: "WAF'ı Gör",
                priority: 'Öncelik',
                riskDescription: 'Risk Açıklaması',
                deductScore: 'Düşülen Puan',
                remaining: 'Kalan',
                wafSourceIpTop: 'WAF Kaynak IP TOP5',
                wafAffectedSiteTop: 'Etkilenen Siteler TOP5',
                sslRisk: 'Sertifika Riskleri',
                sslExpiring: 'Süresi Dolan Sertifikalar',
                includedInReport: 'Rapora dahil edildi',
                needRenewal: 'Yenileme öneriliyor',
                fromExpireInfo: 'Son kullanma bilgisinden',
                runningWebsite: 'Çalışan Web Siteleri',
                fromWebsiteStatus: 'Web sitesi listesi durumundan',
                stoppedWebsite: 'Duran Web Siteleri',
                confirmStoppedWebsite: 'Bunun beklenen bir durum olup olmadığını doğrulayın',
                expiringWebsite: 'Süresi Dolacak Web Siteleri',
                expiringSoon: 'Yakında Sona Eriyor',
                none: 'Yok',
                noSslRisk: 'Ele alınması gereken sertifika yok',
                websiteProtection: 'WAF ve Web Sitesi İzleme',
                websiteMonitor: 'Web Sitesi İzleme',
                waf: 'WAF',
                siteAvailability: 'Site Kullanılabilirliği',
                monitoredSites: 'İzlenen Siteler',
                requestCount: 'İstek Sayısı',
                abnormalSites: 'Anormal Siteler',
                count5xxSource: '5xx isteklere göre sayılır',
                wafIntercept: 'WAF Engelleme',
                highRiskHit: 'Yüksek Riskli Eşleşme',
                websiteMonitorDisabledOrNoData: 'Web sitesi izleme devre dışı veya izleme verisi yok',
                wafDisabledOrNoData: 'WAF devre dışı veya engelleme verisi yok',
                noWafData: 'WAF engelleme verisi yok',
                sourceIP: 'Kaynak IP',
                hitCount: 'Eşleşme Sayısı',
                level: 'Seviye',
                attackType: 'Saldırı Türü',
                requestRatio: 'İstek Oranı',
                installed: 'Yüklü',
                normalRunning: 'Normal Çalışıyor',
                failedStart: 'Başlatma Başarısız',
                manualStopped: 'Manuel Olarak Durduruldu',
                failed: 'Başarısız',
                success: 'Başarılı',
                canUpdate: 'Yükseltilebilir',
                listSeparator: ', ',
                containerCount: 'Konteyner Sayısı',
                stopped: 'Durdu',
                abnormal: 'Anormal',
                abnormalContainers: 'Anormal Konteynerler',
                resourceUsage: 'Kaynak Kullanımı',
                exposedContainerPorts: 'Açık Portlar',
                portMapping: 'Port Eşleme',
                risk: 'Risk',
                noAbnormalContainer: 'Anormal konteyner yok',
                noExposedContainer: 'Açık port algılanmadı',
                publicExpose: 'Genel Maruziyet',
                privateExpose: 'Özel Eşleme',
                ...
                resourceThresholdContainers: 'CPU / bellek eşiğini aşan konteynerler',
                noThresholdExceededContainer: 'Eşiği aşan konteyner yok',
                triggerMetric: 'Tetiklenen ölçüm',
                ...
                executionRecords: 'Yürütme Kayıtları',
                successRate: 'Başarı Oranı',
                failedJobs: 'Başarısız Görevler',
                recentRecoveryPoint: 'Son Kurtarma Noktası',
                remoteCoverage: 'Uzak Kapsama',
                recent7Days: 'Son 7 gün',
                taskTypeStats: 'Görev Türü İstatistikleri',
                total: 'Toplam',
                taskTypeDesc: '{0} etkin, {1} devre dışı',
                failedOrAttentionTasks: 'Başarısız veya Dikkat Gerektiren Görevler',
                execution: 'Yürütme',
                latestExecution: 'Son Yürütme',
                remoteBackup: 'Uzak Yedekleme',
                localOnly: 'Yalnızca Yerel',
                covered: 'Kapsanmış',
                noAttentionCronjob: 'Başarısız veya dikkat gerektiren zamanlanmış görev yok',
                ...
                generationRule: 'Oluşturma Kuralları',
                scheduleDaily: 'Günlük',
                scheduleDailyDesc: "Her gün 09:00'da son 24 saatin raporunu oluştur",
                scheduleWeekly: 'Haftalık',
                scheduleWeeklyDesc: "Her Pazartesi 09:00'da son 7 günün raporunu oluştur",
                scheduleMonthly: 'Aylık',
                scheduleMonthlyDesc: "Her ayın 1'inde 09:00'da bir önceki ayın raporunu oluştur",
                scheduleCurrentDaily: "Her gün 09:00'da son 24 saatin raporu oluşturulur · Sonraki {0}",
                scheduleCurrentWeekly: "Her Pazartesi 09:00'da son 7 günün raporu oluşturulur · Sonraki {0}",
                scheduleCurrentMonthly: "Her ayın 1'inde 09:00'da bir önceki ayın raporu oluşturulur · Sonraki {0}",
                notificationMethod: 'Bildirim Yöntemleri',
                channel: 'Kanal',
                receiver: 'Alıcı',
                systemThreshold: 'Sistem eşiği',
                metric: 'Metrik',
                currentRule: 'Mevcut Kural',
                hostMonitor: 'Ana Makine İzleme',
                monitorInterval: 'İzleme Aralığı',
                exportSettings: 'Dışa Aktarma Ayarları',
                lastExportReport: 'Son Oluşturulan Sonuç',
                noLastExportReport: 'Dışa aktarılmış rapor kaydı yok',
                lastExportStatus: 'Son Dışa Aktarma Durumu',
                exportFile: 'Dışa Aktarma Dosyası',
                generateTime: 'Oluşturma Zamanı',
                fileSize: 'Dosya Boyutu',
                viewExportHistory: 'Dışa Aktarma Geçmişini Gör',
                defaultFormat: 'Varsayılan Biçim',
                savePath: 'Kayıt Dizini',
                savePathRequired: 'Rapor kayıt dizinini ayarlayın',
                autoExport: 'Otomatik Dışa Aktarmayı Etkinleştir',
                autoExportDesc: "Etkinleştirildiğinde her gün 09:00'da otomatik olarak operasyon raporu oluşturulur",
                autoExportEnabled: 'Otomatik dışa aktarma etkin',
                autoExportDisabled: 'Otomatik dışa aktarma devre dışı',
                readOnlyPermissionTip:
                    'Mevcut hesap yalnızca operasyon raporu ayarlarını görüntüleyebilir. Değişiklik yapmak için yönetici ile iletişime geçin.',
                ...
                generateNow: 'Şimdi Oluştur',
                generateSuccess: 'Rapor dosyası oluşturuldu: {0}',
                generateFailed: 'Rapor oluşturulamadı',
                enabledStatus: 'Etkin',
                disabledStatus: 'Devre Dışı',
                thresholdRule: 'Eşik {0}, art arda {1} kez tetikleme',
                hours: '{0} saat',
                minutes: '{0} dakika',
                seconds: '{0} saniye',
                totalExports: 'Toplam Dışa Aktarma',
                successExports: 'Başarılı Dışa Aktarma',
                failedExports: 'Başarısız Dışa Aktarma',
                reportName: 'Rapor Adı',
                exportFormat: 'Dışa Aktarma Biçimi',
                operator: 'Operatör',
                triggerType: 'Tetikleme',
                filePath: 'Dosya Yolu',
                manualExport: 'Manuel',
                scheduledExport: 'Zamanlanmış',
                exportResult: 'Dışa Aktarma Sonucu',
                exportDetail: 'Dışa Aktarma Detayı',
                mfa: 'MFA',
                mfaNormalDesc: 'MFA etkinleştirildi',
                mfaRiskDesc: 'MFA etkinleştirilmemiş. Hesap güvenliğini artırmak için etkinleştirmeniz önerilir',
            },
        },
        user: {
            user: 'Kullanıcı',
        ...
        logExport: {
            title: 'Günlükleri Dışa Aktar',
            records: 'Dışa Aktarma Kayıtları',
            retentionDays: 'Dışa Aktarma Kaydı Saklama Süresi',
            timeRange: 'Zaman Aralığı',
            timeRequired: 'Dışa aktarma zaman aralığını seçin',
            websiteRequired: 'Bir web sitesi seçin',
            blackStatus: 'Kara Liste Durumu',
            black: 'Kara listede',
            notBlack: 'Kara listede değil',
            fuzzy: 'Bulanık Eşleşme',
            regex: 'Düzenli İfade',
            invalidRegex: 'En fazla 256 karakterlik geçerli bir RE2 ifadesi girin',
            created: 'Dışa aktarma görevi oluşturuldu',
            fileName: 'Dosya Adı',
            fileSize: 'Dosya Boyutu',
            expiresAt: 'Son Kullanma',
            cancelConfirm: 'Bu dışa aktarma görevi iptal edilsin mi?',
            deleteConfirm: 'Bu dışa aktarma kaydı ve dosyası silinsin mi?',
        },
        waf: {
            name: 'WAF',
            ...
            geoHelper:
                'Bölge ve il politikalarını tek anahtarda birleştirir. Önce bölge kuralları, ardından il kuralları uygulanır',
            ...
            deny: 'Yasakla',
            allow: 'İzin Ver',
            allowOnly: 'Yalnızca seçilenlere izin ver',
            field: 'Nesne',
            pattern: 'Koşul',
            ruleContent: 'İçerik',
            contain: 'içerir',
            ...
            executionStrategy: 'Yürütme stratejisi',
            detectionStrength: 'Algılama düzeyi',
            protectionMode: 'Koruma modu',
            observationMode: 'Gözlem modu',
            standardMode: 'Standart mod',
            observationModeHelper: 'İstekleri engellemeden algılar ve günlüğe kaydeder',
        ...
        helper: {
            ...
            vllmTitle3: 'Operasyonel Verimlilik',
            vllmContent3:
                'Örnek oluşturma, düzenleme, başlatma, durdurma, yeniden başlatma, silme ve görev takibini tek bir arayüzden gerçekleştirerek yerel model hizmetlerinin yönetim verimliliğini artırın.',
            vllmTitle4: 'Esnek Yapılandırma',
            vllmContent4:
                'Gelişmiş ayarlar aracılığıyla portları, konteynerleri, başlatma komutlarını ve Compose yapılandırmalarını merkezi olarak yönetin; standartlaştırılmış dağıtım ve sonraki ayarlamaları kolaylaştırın.',
        },
        node: {
            master: 'Ana Düğüm',
            ...
            syncWithMaster:
                'Ticari sürüme yükseltildikten sonra, tüm veriler varsayılan olarak senkronize edilir. Senkronizasyon politikaları düğüm yönetiminde manuel olarak ayarlanabilir.',
        ...
        alert: {
            ...
            recipientPlaceholder: 'E-posta adresini girin',
            addRecipient: 'Alıcı ekle',
            webhookItem: 'Webhook bağlantısı',
            addWebhook: 'Webhook ekle',
            selectAlertType: 'Uyarı türünü seçin',
            configDetail: 'Detayları yapılandır',
            webhookCount: 'Webhook sayısı',
            sms: 'SMS',
            wechat: 'WeChat',
            dingTalk: 'DingTalk',
            feiShu: 'FeiShu',
        ...
        vm: {
            ...
            healthCheckResult: {
                ...
                fail: 'Başarısız',
                normal: 'Normal',
                fixCommand: 'Düzeltme komutu',
                technicalDetail: 'Teknik ayrıntılar',
                check: {
                    vmName: 'Sanal makine adı',
                    libvirtConnection: 'Libvirt bağlantısı',
                    vmDefinition: 'Sanal makine tanımı',
                    domainXML: 'Sanal makine XML’i',
                    architecture: 'Mimari',
                    virtualizationType: 'Sanallaştırma türü',
                    machineType: 'Makine türü',
                    efiCapability: 'EFI desteği',
                    qemuEmulator: 'QEMU öykünücüsü',
                    bootOrder: 'Önyükleme sırası',
                    arm64Firmware: 'ARM64 ürün yazılımı',
                    arm64Features: 'ARM64 özellikleri',
                    arm64Video: 'ARM64 görüntü aygıtı',
                    arm64FirmwareFile: 'ARM64 ürün yazılımı dosyası',
                    arm64CDROM: 'ARM64 CD-ROM',
                    blockDevice: 'Blok aygıtı',
                    isoArchitecture: 'ISO mimarisi',
                    network: 'Ağ',
                    qemuLog: 'QEMU günlüğü',
                    arm64RuntimeFirmware: 'Çalışma zamanı ARM64 ürün yazılımı',
                },
                reason: {
                    invalidName: 'Sanal makine adı geçersiz.',
                    connectionFailed: '{uri} adresine bağlanılamadı.',
                    vmNotFound: '{name} sanal makinesi bulunamadı.',
                    xmlReadFailed: 'Sanal makine XML’i okunamadı.',
                    liveXMLFallback: 'Kalıcı yapılandırma okunamadı; çalışan yapılandırma kullanılıyor.',
                    xmlParseFailed: 'Sanal makine XML’i ayrıştırılamadı.',
                    stateReadFailed:
                        'Sanal makine durumu belirlenemedi. Çalışma zamanı ürün yazılımı denetimi atlandı.',
                    guestArchMissing: 'XML’de konuk mimarisi eksik.',
                    archMismatch:
                        'Ana makine mimarisi {hostArch}, konuk mimarisi ise {guestArch}. Mimariler arası çalıştırma desteklenmiyor.',
                    nonKVMType: 'Sanallaştırma türü {type}; varsayılan KVM türü değil.',
                    archOrMachineMissing: 'XML’de mimari veya makine türü eksik.',
                    machineUnsupported: 'Ana makine {arch}/{machine} yapılandırmasını desteklemiyor.',
                    emulatorNotSpecified: 'XML’de öykünücü belirtilmemiş; Libvirt bir öykünücü seçecek.',
                    fileNotFound: 'Dosya bulunamadı: {path}',
                    fileNotExecutable: 'Dosya çalıştırılabilir değil: {path}',
                    bootDeviceMissing: 'XML’de önyükleme aygıtı tanımlanmamış.',
                    diskNotFirst: 'Disk ilk önyükleme aygıtı değil. Geçerli sıra: {order}',
                    cdromNotInBootOrder: 'CD-ROM bağlı, ancak önyükleme sırasına dahil edilmemiş.',
                    firmwareNotConfigured:
                        'EFI veya Loader yapılandırılmamış; konuk ekranı başlatamayabilir veya önyükleme yapamayabilir.',
                    acpiCustom: 'ACPI yapılandırılmış. Konuğun bu özel ayara gerçekten ihtiyaç duyduğunu doğrulayın.',
                    acpiRequiresUEFI: 'ACPI, UEFI olmadan yapılandırılmış ve ACPI requires UEFI hatasına neden oluyor.',
                    apicUnsupported: 'x86 APIC yapılandırılmış, ancak ARM64 için geçerli değil.',
                    gicNotDeclared: 'Kalıcı XML’de GIC yok; Libvirt çalışma sırasında ekleyebilir.',
                    videoNotConfigured: 'XML’de görüntü aygıtı yapılandırılmamış.',
                    videoNotVirtio: 'Görüntü aygıtı türü {type}; Virtio önerilir.',
                    firmwareFileMissing: 'Ürün yazılımı dosyası yok veya normal bir dosya değil: {path}',
                    firmwareNotAvailable: 'Libvirt EFI desteği bildirmiyor ve ARM64 UEFI ürün yazılımı bulunamadı.',
                    cdromBusNotSCSI: 'CD-ROM {bus} veri yolunu kullanıyor; ARM64 için SCSI gereklidir.',
                    cdromNotOnVirtioSCSI: 'CD-ROM bir Virtio SCSI denetleyicisine bağlı değil.',
                    diskSourceMissing: '{device} {target} için kaynak dosya yapılandırılmamış.',
                    sourceNotFound: '{device} {target} kaynak dosyası yok: {path}',
                    sourceIsDirectory: '{device} {target} kaynak yolu bir dizin: {path}',
                    systemDiskNotFound: 'Sistem diski algılanmadı.',
                    isoArchMismatch: '{guestArch} konuğuna {imageArch} için olduğu düşünülen bir imaj bağlı: {path}',
                    networkReadFailed: '{name} ağı okunamadı.',
                    networkStateReadFailed: '{name} ağının durumu okunamadı.',
                    networkInactive: '{name} ağı mevcut ancak etkin değil.',
                    logUnavailable: 'Analiz edilebilecek bir başlangıç günlüğü yok.',
                    logErrorsFound: 'En son başlangıç kaydında yaygın hatalar bulundu.',
                    vmNotRunning: 'Sanal makine çalışmıyor; QEMU çalışma zamanı bağımsız değişkeni denetimi atlandı.',
                    runtimeFirmwareMissing: 'QEMU günlüğünde pflash, AAVMF veya QEMU_EFI girdisi bulunamadı.',
                },
            },
            ...
            disk: 'Disk',
            overview: 'Overview',
            kvmUnavailable: 'No available KVM hardware virtualization capability was detected.',
            kvmCheckCpu: 'Confirm that the host CPU supports Intel VT-x or AMD-V virtualization.',
            kvmCheckBios: 'Enable virtualization options in BIOS/UEFI.',
            kvmCheckModule: 'Confirm that the kvm, kvm_intel, or kvm_amd kernel module is loaded correctly.',
            kvmCheckDevice:
                'Confirm that /dev/kvm exists and the current environment is not a container or cloud host without KVM support.',
            abnormal: 'Abnormal',
            ...
            runtimeAbnormal: 'VM runtime is abnormal',
            noDependency: 'No dependency check data',
            storageOverview: 'Storage Overview',
            totalAllocated: 'Calculated by total VM configuration',
            runningAllocated: 'Running allocation: {0}',
            storageAvailable: 'Available: {0}',
            inProgress: 'In progress',
            needAttention: 'Needs attention',
            normal: 'Normal',
            environmentRisk: 'The VM runtime is not ready. Fix dependencies or virtualization services.',
            storageRisk: 'Storage pool {0} usage has reached {1}%.',
            abnormalRisk: '{0} VMs are in an abnormal state.',
            pausedRisk: '{0} VMs are paused.',
            memoryRisk: 'VM memory allocation has reached {0}%.',
            cpuLimitHelper: 'Şu anda kullanılabilir CPU: {0} çekirdek',
            cpuLimitExceeded: 'CPU sınırı aşıyor. Şu anki maksimum kullanılabilir: {0} çekirdek.',
            memoryLimitHelper: 'Şu anda ayrılabilir bellek: {0} (ana makine {1} bellek ayırmalıdır)',
            memoryLimitExceeded: 'Bellek sınırı aşıyor. Şu anki maksimum ayrılabilir: {0}.',
            storageLimitHelper: 'Hedef depolama havuzundaki mevcut boş alan: {0}',
            storageLimitExceeded: 'Disk kapasitesi sınırı aşıyor. Şu anki maksimum kullanılabilir: {0}.',
            iso: 'ISO',
            ...
            deleteTemplateConfirm: '{0} şablonu silinsin. Bu işlem geri alınamaz. Devam edilsin mi?',
            orphanClean: 'Sahipsiz veri temizliği',
            orphanScan: 'Yeniden tara',
            orphanCleanHelper:
                'Yalnızca sanal makineler, anlık görüntüler veya kayıtlı şablonlar tarafından başvurulmayan aday dosyalar gösterilir. Temizlemeden önce dosyanın artık kullanılmadığını doğrulayın; işlem geri alınamaz.',
            orphanSelected: '{0} dosya seçildi, toplam {1}',
            orphanSize: 'Boyut',
            orphanCleanConfirm: 'Seçilen {0} dosya ({1}) temizlensin mi? Bu işlem geri alınamaz.',
            orphanCleanSuccess: '{0} dosya temizlendi ve {1} alan boşaltıldı.',
            orphanType: {
                orphan_domain_disk: 'Sahipsiz disk',
            ...
            dhcpEnd: 'DHCP Bitişi',
            bootOrder: 'Önyükleme Sırası',
            bootDiskFirst: 'Önce disk (HD → CD-ROM)',
            bootIsoFirst: 'Önce ISO (CD-ROM → HD)',
            bootOrderConfirm:
                'Önyükleme sırası {0} olarak değiştirilsin mi? Sanal makine bir sonraki başlangıçta bağlı ve önyüklenebilir aygıtları bu sırayla dener.',
            ...
            forceDelete: 'Zorla sil',
            forceDeleteHelper:
                'Zorla silme VM silme hatalarını yok sayar, panel meta verilerini siler ve kaynak kullanımını serbest bırakır.',
            deleteNameHelper: '" yazarak bu sanal makineyi sil',
            isoSource: 'ISO Kaynağı',
            downloadFromServer: 'Uzaktan İndir',
            ...
            deleteSourceFileHelper:
                'İşaretlenirse, bu ISO kaydının başvurduğu kaynak dosya da silinir ve kurtarılamaz.',
            dir: 'Yerel Dizin',
        },
        cluster: {
