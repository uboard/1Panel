...
const message = {
    ...
    aiTools: {
        agents: {
            ...
            batchAction: '{0} por lotes',
            installSkillAction: 'Distribuir Skill',
            batchAgentTask: '{0} agentes por lotes',
            dispatchAgentTask: 'Enviar tareas para {0} agentes',
            dispatchTask: 'Enviar tareas de {0}',
            taskSubmitted: 'Tarea de {0} enviada',
            ...
            verifyModel: 'Modelo de verificación',
            verifyModelHelper:
                'Seleccione un modelo al que esta cuenta tenga acceso. Se usará para enviar una solicitud mínima al guardar y verificar la conexión.',
            verifyModelRequired: 'Seleccione un modelo de verificación',
            discoverModels: 'Obtener modelos',
            automaticModelDiscovery: 'Obtención automática',
            manualModelConfiguration: 'Configuración manual',
            ...
            skillsMarketSourceLocalHub: 'Tienda local de Skills',
            ...
            roleMarkdownDescriptions: {
                'AGENTS.md': [
                    ...
                    'Buen lugar para reglas, prioridades y detalles sobre cómo debe comportarse.',
                ],
                'SOUL.md': ['Personalidad, tono y límites.', 'Se carga en cada sesión.'],
                'USER.md': ['Quién es el usuario y cómo dirigirse a él.', 'Se carga en cada sesión.'],
                'IDENTITY.md': [
                    'El nombre, estilo y emoji del agente.',
                    'Se crea o actualiza durante el ritual de inicio.',
                ],
                'TOOLS.md': [
                    'Notas sobre las herramientas locales y las convenciones.',
                    'No controla la disponibilidad de herramientas; solo sirve de guía.',
                ],
                'HEARTBEAT.md': [
                    'Lista de comprobación opcional para ejecuciones heartbeat.',
                    'Manténgala corta para evitar gastar tokens.',
                ],
                'BOOT.md': [
                    'Lista de inicio opcional que se ejecuta al reiniciar el gateway cuando los hooks internos están habilitados.',
                    'Manténgala corta; use la herramienta de mensajes para envíos externos.',
                ],
                'BOOTSTRAP.md': [
                    'Ritual único de la primera ejecución.',
                    'Solo se crea para un espacio de trabajo completamente nuevo.',
                    'Elimínelo cuando el ritual se complete.',
                ],
            },
            duplicateBinding: 'La combinacion de canal e ID de cuenta debe ser unica',
            ...
            threadSession: 'Sesión por hilo',
            replyMode: 'Modo de respuesta',
            requireMention: 'Requerir mención',
            requireMentionTrue: "Requiere {'@'}",
            requireMentionFalse: "No requiere {'@'}",
            requireMentionOpen: 'Según la configuración del grupo',
            ...
            allowlistPolicyHelper: '{0}. Solo se usa cuando {1} es Lista permitida.',
            systemPrompt: 'Prompt del sistema',
            groupAllowFrom: 'Lista permitida de grupos',
            groupAllowFromPlaceholder: 'Un ID de grupo por línea',
            separateSessionByConversation: 'Sesión separada por conversación',
            groupSessionScope: 'Ámbito de sesión de grupo',
            groupSessionScopeGroup: 'Compartido por grupo',
            groupSessionScopeGroupSender: 'Por remitente',
            sharedMemoryAcrossConversations: 'Compartir memoria entre conversaciones',
            asyncMode: 'Modo asíncrono',
            ackText: 'Texto de confirmación',
            ackTextDefault: 'Tarea recibida, procesando...',
            streaming: 'Streaming',
            streamingOff: 'Desactivado',
            streamingPartial: 'Parcial',
            streamingBlock: 'Bloqueante',
            streamingProgress: 'Progreso',
            ...
            successAndRestart: '{0}. El contenedor se está reiniciando automáticamente.',
        ...
        model: {
            ...
            endpointLabel: 'Endpoint de {0}',
            acceleratedEndpointLabel: 'Endpoint de aceleración de {0}',
            tokenOptionalLabel: 'Token de {0} (opcional)',
            searchSource: 'Buscar en {0}',
            hfEndpointHelper:
        ...
        proxy: {
            proxy: 'Mejoras de gateway de IA',
        ...
        aiProxy: {
            ...
            importModelAccount: 'Importar cuenta de modelo',
            editModelAccount: 'Editar cuenta de modelo',
            selectModelAccount: 'Seleccionar una cuenta de modelo existente',
            upstreamApiAddress: 'Dirección de API ascendente',
            priority: 'Prioridad',
            healthStatus: 'Estado de salud',
            failureCount: 'Fallos',
            lastError: 'Último error',
            modelMap: 'Mapeo de modelos',
            apiKeyKeepEmpty: 'API Key (dejar vacío para no cambiar)',
            apiKeyOnceHint: 'La API Key solo se muestra una vez al crearla. Cópiela y guárdela ahora.',
            apiKeyOnceSave: 'La API Key solo se muestra una vez. Guárdela ahora:',
            ...
            logRetentionDays: 'Retención de logs del gateway de IA (días)',
            clearLogs: 'Limpiar logs',
            clearLogsConfirm:
                'Se limpiarán las estadísticas de uso, auditorías de cumplimiento, decisiones de enrutamiento, logs del cuerpo de solicitud y logs del servicio del gateway de IA. ¿Continuar?',
            ...
            requestBodyLog: 'Log del cuerpo de solicitud',
            requestBodyLogDesc:
                'Escribe cuerpos de solicitud y respuesta de AI Gateway en Elasticsearch para búsqueda, auditoría y diagnóstico.',
            requestBodyLogIndexPrefix: 'Prefijo del índice',
            requestBodyLogRetentionDays: 'Retención del log del cuerpo de solicitud (días)',
            requestBodyLogMaxBodyKb: 'Tamaño máximo del cuerpo de solicitud (KB)',
            ...
            deleteTargetConfirm: '¿Eliminar {0} {1}?',
            deleteBackendTitle: 'Eliminar cuenta de modelo',
            userFallback: 'Usuario eliminado (ID: {0})',
            ...
            distributionBy: 'Distribución por {0}',
            ...
            ranking: 'Ranking',
            rank: 'Rango',
            promptToken: 'Tokens de entrada',
            completionToken: 'Tokens de salida',
            ...
            actionDropHistory: 'Eliminar historial',
            severity: 'Severity',
            severityHigh: 'High',
            ...
            sampleText: 'Texto',
            sampleLabel: 'Etiqueta',
            vectorModel: 'Modelo vectorial',
            vectorDim: 'Dimensión',
            threshold: 'Umbral',
            preview: 'Vista previa',
            previewGuide:
        ...
        skillsHub: {
            ...
            repositoryGithubOnly: 'Solo se admiten direcciones de repositorios de GitHub',
            repositoryRef: 'Rama o Tag',
            repositoryRefPlaceholder: 'Predeterminado main; si falla, se intentará master',
            repositoryDownloadPreview: 'URL de descarga de destino:',
            packageURL: 'URL del paquete',
            packageURLPlaceholder: 'Introduzca la dirección del paquete .zip',
            ...
            riskCheckResult: 'Resultado de seguridad',
            noRiskFound: 'No se encontraron riesgos evidentes.',
            riskFilePath: 'Ruta del archivo',
            riskKeyword: 'Palabra clave o regla coincidente',
            riskDescription: 'Descripción del riesgo',
            publishHighRiskConfirm:
                'Este Skill tiene elementos de alto riesgo y puede contener ejecución de scripts, descargas externas o acceso a información sensible. ¿Publicarlo de todos modos?',
            approve: 'Aprobar',
            reject: 'Rechazar',
            publish: 'Publicar',
            disable: 'Retirar',
            ...
            copy: 'Copiar',
            extract: 'Extraer',
            postInstallCommand: 'Comando posterior a la instalación',
            localSource: 'Carga local',
            uploadDragTitle: 'Arrastre el paquete Skill aquí o haga clic para subirlo',
            uploadFormatLabel: 'Formatos:',
            uploadFormatValue: '.zip, .7z, .tar, .tar.gz',
            uploadSizeLabel: 'Tamaño:',
            uploadSizeValue: 'No más de 5 MB por archivo',
            uploadRequirementLabel: 'Requisito:',
            uploadRequirementPrefix: 'El paquete Skill debe contener',
            ...
            deleteConfirm:
                '¿Eliminar este Skill? Esta acción no se puede deshacer. Los Skills ya instalados en agentes no se verán afectados.',
            ...
            riskType: {
                script_file: 'Archivo de script',
                dependency_manifest: 'Declaración de dependencias',
                external_url: 'URL externa',
                environment_variable: 'Variable de entorno',
                dockerfile: 'Dockerfile',
                command_execution: 'Ejecución de comandos',
                remote_script_execution: 'Ejecución de script remoto',
                eval_execution: 'Ejecución dinámica',
                base64_execution: 'Ejecución tras decodificar Base64',
                privileged_command: 'Comando privilegiado',
                dangerous_delete: 'Eliminación peligrosa',
                world_writable_permission: 'Permiso de alto riesgo',
                credential: 'Credencial sospechosa',
                sensitive_path: 'Ruta sensible',
                suspicious_download_execute: 'Descarga y ejecución sospechosa',
                binary_content: 'Contenido binario',
                scan_truncated: 'Escaneo truncado',
            },
            riskDescriptionText: {
                script_file: 'Contiene archivos de script que pueden ejecutar comandos locales.',
                dependency_manifest:
                    'Contiene declaraciones de dependencias que pueden descargar dependencias externas.',
                external_url: 'Contiene URL externas. Verifique que las direcciones de salida sean confiables.',
                environment_variable: 'Declara variables de entorno. Verifique su uso y valores predeterminados.',
                dockerfile: 'Contiene un Dockerfile que puede definir compilación de imagen o lógica de ejecución.',
                command_execution:
                    'Contiene llamadas relacionadas con ejecución de comandos. Verifique que sean confiables.',
                remote_script_execution: 'Contiene lógica que descarga y ejecuta directamente un script remoto.',
                eval_execution: 'Contiene ejecución dinámica mediante eval.',
                base64_execution: 'Contiene lógica que ejecuta contenido después de decodificar Base64.',
                privileged_command: 'Contiene comandos sudo de elevación de privilegios.',
                dangerous_delete: 'Contiene comandos de eliminación peligrosos.',
                world_writable_permission: 'Contiene cambios de permisos chmod 777.',
                credential: 'Contiene posibles API Key, Token, Secret o Password.',
                sensitive_path: 'Contiene acceso a directorios o archivos sensibles.',
                suspicious_download_execute: 'Contiene lógica sospechosa de descarga externa o descarga y ejecución.',
                binary_content: 'El archivo contiene bytes NUL y puede ocultar contenido ejecutable o binario.',
                scan_truncated:
                    'El archivo supera el límite de escaneo. El contenido no escaneado requiere revisión manual.',
            },
        },
        benchmark: {
            title: 'Benchmark',
            ...
            contextTokensHelper: 'Suma del límite de tokens de entrada y salida de este benchmark.',
            outputThroughput: 'Rendimiento de salida',
            outputThroughputHelper: 'Tokens de salida generados por segundo. Un valor mayor indica más velocidad.',
            ...
            firstTokenLatencyHelper:
                'Tiempo desde el envío de la solicitud hasta recibir el primer token. Un valor menor indica respuesta más rápida.',
            ...
            requestRateUnlimited: 'Ilimitado (máximo rendimiento)',
        ...
        mcp: {
            ...
            gatewayArgsHelper:
                'Los argumentos se añaden al comando supergateway. No se pueden cambiar los argumentos de transporte, puerto, ruta y protocolo gestionados por 1Panel',
    ...
    cronjob: {
        ...
        syncIpGroupHelper: 'Sincroniza grupos de IP remotos usados en las listas negras/blancas de WAF',
    ...
    terminal: {
        ...
        nodeAdminLocalOnly: 'Los administradores de nodo solo pueden usar terminal local.',
    ...
    file: {
        ...
        aiSearchHitLines: 'Líneas coincidentes',
        aiSearch: 'Búsqueda con IA',
        aiSearchTitle: 'Búsqueda con IA',
        aiSearchHint:
            'Busca el contenido del archivo línea por línea. Usa los botones a la derecha de la fila de búsqueda y las "Condiciones avanzadas" debajo. Cuando la cuenta de IA esté activada y guardada, también se podrá generar un resumen en Markdown.',
        aiSearchAccountTitle: 'Cuenta de IA',
        aiSearchAccountIntro: 'Elige una cuenta de modelo grande para generar resúmenes y guarda los cambios.',
        aiSearchAccountEnable: 'Activar búsqueda de IA en archivos',
        aiSearchSaveAccount: 'Guardar configuración de la cuenta',
        aiSearchSectionQuery: 'Búsqueda',
        aiSearchSectionConditions: 'Condiciones de búsqueda',
        aiSearchResultsSection: 'Resultados del análisis',
        aiSearchContentLabel: 'Contenido de búsqueda',
        aiSearchDirLabel: 'Directorio',
        aiSearchExtLabel: 'Extensión del archivo',
        aiSearchModifiedPreset: 'Hora de modificación',
        aiSearchSizePresetLabel: 'Tamaño del archivo',
        aiSearchTimeAny: 'Cualquier momento',
        aiSearchTime3h: 'Últimas 3 horas',
        aiSearchTime1d: 'Último 1 día',
        aiSearchTime7d: 'Últimos 7 días',
        aiSearchTime30d: 'Últimos 30 días',
        aiSearchTimeCustom: 'Personalizado',
        aiSearchSizeAny: 'Sin límite de tamaño',
        ...
        aiSearchPlaceholder: 'Introduce el contenido de la búsqueda',
        aiSearchContainSub: 'Recursivo',
        aiSearchMaxItems: 'Límite de rutas/archivos incluidos en la búsqueda (enumeración de directorio, 1–2000)',
        aiSearchRun: 'Iniciar análisis',
        aiSearchTruncated: 'Hay demasiados elementos del directorio; solo se incluyó parte de la lista.',
        aiSearchPreFiltered: 'Las rutas relativas se filtraron previamente por palabra clave.',
        aiSearchMeta: 'Elementos analizados: {0} | Duración {1} | Tokens {2}',
        aiSearchQueryRequired: 'Introduce una descripción de búsqueda o palabras clave',
        aiSearchContentHits: 'Coincidencias de contenido',
        aiSearchContentScanMeta: 'Análisis de contenido: se leyeron {0} archivos de texto.',
        aiSearchNoLineHits: 'No se encontraron líneas que coincidan en los archivos de texto analizados.',
        aiSearchHitsTruncated: 'Algunos archivos no se analizaron o la lista de coincidencias se truncó por límites.',
        aiSearchHitFiles: 'Archivos con coincidencias',
        aiSearchOpenFile: 'Abrir en el editor',
        aiSearchOpenAtLine: 'Abrir e ir a esta línea',
        aiSearchGrepOnlyHint:
            'La IA de archivos está desactivada: solo se ejecuta la búsqueda determinista de contenido, sin llamar al modelo. Activa y guarda la cuenta de IA arriba para obtener resúmenes. La fila de búsqueda y las opciones de abajo siguen aplicando.',
        aiSearchMatchCase: 'Distinguir mayúsculas y minúsculas',
        aiSearchWholeWord: 'Palabra completa (límites de palabra en inglés \\b)',
        aiSearchUseRegex: 'Expresión regular (sintaxis Go RE2)',
        aiSearchExtensions: 'Extensiones de archivo (separadas por comas, p. ej. go,ts,md)',
        aiSearchMinSize: 'Tamaño mínimo del archivo (bytes, 0 = sin límite)',
        aiSearchMaxSize: 'Tamaño máximo del archivo (bytes, 0 = sin límite)',
        aiSearchSectionAdvanced: 'Condiciones avanzadas',
        aiSearchLimitMaxItems: 'Total de archivos a buscar',
        aiSearchLimitMaxScan: 'Archivos para escanear contenido',
        aiSearchLimitMaxBytes: 'Límite de lectura por archivo',
        aiSearchLimitHitsPerFile: 'Líneas coincidentes por archivo',
        aiSearchLimitTotalHits: 'Total de líneas coincidentes',
        aiSearchLimitUnitEntries: 'elementos',
        aiSearchLimitUnitFiles: 'archivos',
        aiSearchLimitUnitBytes: 'B',
        aiSearchLimitUnitLines: 'líneas',
        aiSearchMaxScanFiles: 'Máximo de archivos para escanear contenido',
        aiSearchMaxFileBytes:
            'Máximo de bytes leídos de cada archivo durante el escaneo de contenido. A diferencia del filtro de tamaño anterior (el tamaño en disco decide si entra en la lista), este limita cuánto se lee realmente para la coincidencia.',
        aiSearchMaxHitsPerFile: 'Máximo de líneas coincidentes por archivo',
        aiSearchMaxTotalHits: 'Límite total de líneas coincidentes',
        aiSearchGrepMetaContent:
            'Escaneo de contenido: {0} elementos totales, {1} archivos de texto leídos (según las condiciones actuales; se aplican límites de tamaño/cantidad). Duración {2}',
        aiSearchAdvancedResetDefaults: 'Restablecer límites predeterminados',
        zip: 'Comprimido',
        group: 'Grupo',
        path: 'Ruta',
        public: 'Otros',
        ...
        historyHint:
            'Registra la versión anterior a cada cambio de archivo, lo que permite revisar el historial de cambios de contenido y revertir versiones de contenido.',
        historySettingTitle: 'Política de versiones',
        historyEnable: 'Habilitar historial de versiones',
        historyMaxPerPath: 'Conservar por archivo',
        historyDiskQuota: 'Cuota global de disco (MB)',
        historyCurrentScope: 'Archivo actual',
        historyAllScope: 'Todos los archivos',
        historyDeleteConfirm: '¿Está seguro de que desea eliminar los registros de historial seleccionados?',
        historyNeedFile: 'Abra un archivo primero',
        historyRestore: 'Restaurar esta versión',
        historyOperationOnlyHint:
            'El elemento seleccionado es una operación de archivo y no admite restauración de versiones.',
        historyCurrentFile: 'Archivo actual',
        historyLatestVersion:
            'El lado izquierdo muestra el contenido de la versión histórica y el lado derecho muestra la última versión ' +
            'del archivo seleccionado',
        historyCompareTarget: 'Destino de comparación',
        historyCompareTargetPath: 'Ruta de comparación',
        historyRestoreConfirm: '¿Restaurar esta versión al archivo actual?',
        historyRestoreDirtyConfirm:
            'El archivo actual tiene cambios sin guardar. Al restaurar se sobrescribirán. ¿Continuar?',
        historyRestoreSuccess: 'Versión restaurada correctamente',
        historyDirtyHint: 'El editor actual tiene cambios sin guardar. Al restaurar una versión se sobrescribirán.',
        historyDiffHintCurrent:
            'El lado izquierdo muestra el contenido de la versión histórica y el lado derecho muestra el contenido ' +
            'del archivo actual',
        historyDiffHintAll:
            'El lado izquierdo muestra el contenido de la versión histórica y el lado derecho muestra la última ' +
        ...
        shareClose: 'Close',
        shareCancel: 'Cancelar uso compartido',
        shareCancelConfirm: '¿Seguro que quieres cancelar este uso compartido de archivo?',
        shareDetail: 'Details',
    ...
    ssh: {
        ...
        confFileOrderHelper:
            'Use el desplegable para cambiar de archivo de configuración y editar/guardar; se aplica por orden de carga y prevalece el valor cargado antes.',
        confFileOrderLabel: '{0} (Orden de carga #{1})',
    ...
    setting: {
        ...
        passwordEmptyTip: 'Déjalo vacío para no modificar la contraseña actual',
    ...
    nginx: {
        ...
        build: 'Compilar',
        buildWarn:
            'La compilación local de módulos consume CPU y memoria. Los módulos estáticos también reconstruyen y reinician OpenResty. ¿Continuar?',
        buildPurposeHint:
    ...
    xpack: {
        ...
        opsReport: {
            ...
            setting: 'Configuración',
            page: {
                enterprise: 'Edición Empresarial',
                reportNode: 'Nodo de informe',
                selectReportNode: 'Seleccionar nodo de informe',
                currentNode: 'Actual',
                scoreMeta: '{0} puntos deducidos · {1} riesgos',
                ...
                serverSecurityOverview: 'Resumen de operaciones de seguridad del servidor',
                securityScore: 'Puntuación de seguridad',
                overviewSummary:
                    'Nivel de seguridad actual: {0}. {1} puntos deducidos, {2} elementos de riesgo detectados, {3} objetos verificados.',
                riskDistribution: 'Distribución de riesgos',
                totalDeducted: 'Total deducido',
                noRiskDeducted: 'Sin deducciones',
                scoreTrend: 'Tendencia de puntuación',
                scoreLevelSafe: 'Seguro',
                scoreLevelAttention: 'Requiere atención',
                scoreLevelMediumRisk: 'Riesgo medio',
                scoreLevelHighRisk: 'Riesgo alto',
                scoreCategoryHost: 'Recursos del host',
                scoreCategoryLogin: 'Seguridad de acceso',
                scoreCategoryWebsite: 'Sitios web y certificados',
                scoreCategoryCronjob: 'Tareas programadas',
                scoreCategoryResource: 'Recursos de ejecución',
                scoreDiskHigh: 'Uso del disco {0}: {1}%',
                scoreDiskMedium: 'Uso del disco {0}: {1}%',
                scoreResourceHigh: 'Uso actual de {0}: {1}%',
                scoreResourceMedium: 'Uso actual de {0}: {1}%',
                scoreLoadMedium: 'Carga actual: {0}',
                scoreMonitorDisabled: 'El monitoreo del host está deshabilitado',
                scorePanelLoginFailedHigh: 'Acceso al panel fallido {0} veces',
                scorePanelLoginFailedMedium: 'Acceso al panel fallido {0} veces',
                scoreSSHLoginFailedHigh: 'Acceso SSH fallido {0} veces',
                scoreSSHLoginFailedMedium: 'Acceso SSH fallido {0} veces',
                scoreMFADisabled: 'MFA deshabilitado',
                scoreAllowIPsOpen: 'IPs autorizadas y dominio vinculado no configurados o acceso sin restricciones',
                scorePanelHTTPSDisabled: 'HTTPS del panel deshabilitado',
                scoreSSHRootLogin: 'El acceso SSH como root está permitido',
                scoreSSHPasswordAuth: 'Autenticación por contraseña SSH habilitada sin autenticación por clave',
                scoreSSLHigh: 'El certificado {0} expira en {1} días',
                scoreSSLMedium: 'El certificado {0} expira en {1} días',
                scoreWebsiteExpire: 'El sitio web {0} expira en {1} días',
                ...
                scoreAppFailed: 'La aplicación {0} está en estado anormal',
                scoreAppStopped: 'La aplicación {0} se ha detenido',
                scoreContainerHigh: 'Estado anormal del contenedor {0}',
                scoreContainerExited: 'El contenedor {0} se ha detenido',
                scoreContainerResource: 'Alto uso de recursos del contenedor {0}',
                scoreContainerPublicPort: 'El contenedor {0} tiene puertos expuestos públicamente',
                attentionItems: 'Elementos de atención',
                attentionAssets: 'Activos de atención',
                riskItems: 'Elementos de riesgo',
                object: 'Objeto',
                description: 'Descripción',
                itemUnit: 'elementos',
                recordUnit: 'registros',
                certUnit: 'certificados',
                containerUnit: 'contenedores',
                loginFailed: 'Inicios de sesión fallidos',
                sslExpire: 'Vencimiento de certificado',
                abnormalContainer: 'Contenedores anómalos',
                statAttentionDesc: '{0} puntos deducidos',
                statLoginDesc: 'Panel {0} · SSH {1}',
                statSslDesc: '{0} certificados verificados',
                statContainerDesc: '{0} contenedores verificados',
                assetHostDesc: 'Uso máximo de disco {0}%',
                assetWebsiteDesc: '{0} certificados por vencer, {1} sitios web anómalos',
                assetResourceDesc: '{0} aplicaciones anómalas, {1} contenedores anómalos',
                assetCronjobDesc: '{0} registros de fallos en los últimos 7 días, {1} tareas deshabilitadas',
                app: 'Aplicaciones',
                website: 'Sitios web',
                websiteSsl: 'Sitios web / Certificados',
                cronjob: 'Tareas programadas',
                container: 'Contenedores',
                sslCertificate: 'Certificados SSL',
                loginSecurity: 'Seguridad de acceso',
                panelLogin: 'Acceso al panel',
                sshLogin: 'Acceso SSH',
                failedRecord: 'Registros fallidos',
                expiredDays: 'Expiró hace {0} días',
                remainingDays: '{0} · {1} días restantes',
                enabled: 'Habilitado',
                disabled: 'Deshabilitado',
                exportRecordFailed: 'Error al guardar el registro de exportación',
                ...
                panelLoginSecurity: 'Seguridad de acceso al panel',
                sshSecurity: 'Seguridad SSH del servidor Linux',
                panelFailedRecords: 'Registros de accesos fallidos al panel',
                sshFailedRecords: 'Registros de accesos SSH fallidos',
                location: 'Ubicación',
                configItem: 'Elemento de configuración',
                currentValue: 'Valor actual',
                securityEntrance: 'Entrada de seguridad',
                configured: 'Configurado',
                notConfigured: 'No configurado',
                normal: 'Normal',
                needAttention: 'Requiere atención',
                allowIPs: 'IPs autorizadas',
                restricted: 'Restringido',
                unrestricted: 'Sin restricciones',
                bindDomain: 'Dominio vinculado',
                accessRestriction: 'Restricción de acceso',
                panelHTTPS: 'HTTPS del panel',
                passwordComplexity: 'Complejidad de contraseña',
                sshService: 'Servicio SSH',
                running: 'En ejecución',
                notRunning: 'No en ejecución',
                listenPort: 'Puerto de escucha',
                read: 'Leído',
                rootLogin: 'Acceso Root',
                passwordAuth: 'Autenticación por contraseña',
                keyAuth: 'Autenticación por clave',
                panelLoginFailed: 'Accesos fallidos al panel',
                sshLoginFailed: 'Accesos SSH fallidos',
                panelSecurityItems: 'Elementos de seguridad del panel',
                sshSecurityItems: 'Elementos de seguridad SSH',
                loginSecurityHealthStatus: 'Estado de salud de seguridad de acceso',
                adjustSSHSecurity: 'Ajustar seguridad SSH',
                viewLoginLogs: 'Ver registros de acceso',
                riskLevel: 'Nivel de riesgo',
                goConfig: 'Configurar',
                viewMore: 'Ver más',
                involvedIPs: '{0} IPs involucradas',
                sessionTimeout: 'Tiempo de espera de sesión',
                countUnit: 'veces',
                recent24Hours: 'Últimas 24 horas',
                currentService: 'Servicio actual',
                riskItemsExist: '{0} elementos de riesgo',
                loginHealthRiskDesc:
                ...
                bindDomainRiskDesc: 'Dominio de acceso no vinculado. Se recomienda restringir a un dominio fijo',
                accessRestrictionValue: 'IPs autorizadas: {0} / Dominio vinculado: {1}',
                accessRestrictionNormalDesc:
                    'IPs autorizadas o dominio vinculado configurados para restringir el acceso al panel',
                accessRestrictionRiskDesc:
                    'IPs autorizadas y dominio vinculado no configurados o acceso sin restricciones. Configure al menos uno',
                panelHTTPSNormalDesc: 'HTTPS del panel habilitado',
                panelHTTPSRiskDesc: 'HTTPS del panel deshabilitado. El tráfico de acceso puede estar expuesto',
                passwordComplexityNormalDesc: 'Verificación de complejidad de contraseña habilitada',
                passwordComplexityRiskDesc:
                    'Verificación de complejidad de contraseña deshabilitada, aumentando el riesgo de contraseñas débiles',
                mfa: 'Autenticación MFA',
                mfaNormalDesc: 'Autenticación MFA habilitada, mayor seguridad de acceso',
                ...
                sshPortRiskDesc: 'SSH aún usa el puerto predeterminado 22. Se recomienda cambiarlo según sea necesario',
                ...
                httpsWebsite: 'Sitios web HTTPS',
                certCount: 'Certificados',
                websiteExpire: 'Vencimiento de sitio web',
                database: 'Bases de datos',
                remoteDatabase: 'Bases de datos remotas',
                address: 'Dirección',
                containerResourceUsage: 'Uso de recursos de contenedores',
                spaceUsage: 'Uso de espacio',
                reclaimable: 'Recuperable',
                containerReclaimable: 'Contenedores recuperables',
                image: 'Imágenes',
                volume: 'Volúmenes',
                buildCache: 'Caché de compilación',
                alert: 'Alerta',
                alertConfigured: 'Alertas configuradas',
                alertOperations: 'Notificaciones de alerta',
                alertTaskCount: 'Tareas de alerta',
                enabledAlertTask: 'Tareas habilitadas',
                disabledAlertTask: 'Tareas deshabilitadas',
                alertChannels: 'Canales de notificación',
                alertLogCount: 'Registros de alerta',
                alertSuccessRate: 'Tasa de éxito de alertas',
                alertFailedLogs: 'Registros de alerta fallidos',
                alertPendingLogs: 'Registros pendientes de sincronización',
                alertPending: 'Pendiente de sincronización',
                alertTaskStats: 'Estadísticas de tareas de alerta',
                alertTaskType: 'Tipo de alerta',
                alertLogStatusStats: 'Estado de ejecución de alertas',
                ...
                alertDisabledTaskReason: '{0} tareas de alerta deshabilitadas',
                alertNoTaskReason: 'No hay tareas de alerta configuradas',
                goAlertConfig: 'Configuración de alertas',
                goAlertLogs: 'Registros de alerta',
                configureAlertChannel: 'Configurar canales de notificación',
                createAlertTask: 'Crear tarea de alerta',
                viewAlertTasks: 'Ver tareas de alerta',
                viewFailedAlertLogs: 'Ver registros fallidos',
                viewAlertLogs: 'Ver registros de alerta',
                alertChannelSummary: '{0} / {1} canales habilitados',
                alertTaskEnabledDesc: '{0} tareas habilitadas',
                alertTaskSummary: '{0} habilitadas, {1} deshabilitadas',
                alertLogSummary: '{0} exitosos, {1} fallidos',
                alertPendingDesc: '{0} registros pendientes de sincronización',
                alertLogSuccessDesc: 'Notificación completada',
                alertLogFailedDesc: 'Verifique la configuración del canal o la ruta de envío',
                alertLogPendingDesc: 'Sin conexión o ruta de sincronización pendiente',
                failedAlertLogs: 'Registros de alerta fallidos',
                disabledAlertTasks: 'Tareas de alerta deshabilitadas',
                alertTableDisplayDesc: 'Mostrando {0} de {1}',
                noAlertTask: 'Sin tareas de alerta',
                noFailedAlertLog: 'Sin registros de alerta fallidos',
                noDisabledAlertTask: 'Sin tareas de alerta deshabilitadas',
                alertMsg: 'Mensaje de alerta',
                alertMethod: 'Método de alerta',
                alertRule: 'Regla de alerta',
                alertCronjobType: 'Tarea programada: {0}',
                alertAllTargets: 'Todos los objetivos',
                alertAllDisks: 'Todos los discos',
                alertAllCertificates: 'Todos los certificados',
                alertAllWebsites: 'Todos los sitios web',
                alertDiskRuleShort: '{0} supera {1}{2}, {3} veces al día',
                alertAverageRuleShort: 'Promedio de {0} min supera {1}%, {2} veces al día',
                alertTimeRuleShort: 'Disparar en {0} días, enviar {1} veces',
                alertSendCountRuleShort: 'Enviar {0} veces al día',
                scoreCategoryAlert: 'Notificaciones de alerta',
                scoreAlertNoTask: 'No hay tareas de alerta configuradas',
                scoreAlertNoEnabledTask: 'Todas las tareas de alerta están deshabilitadas',
                scoreAlertDisabledTask: '{0} tareas de alerta deshabilitadas',
                scoreAlertNoChannel: 'No hay canal de notificación de alerta habilitado',
                scoreAlertFailedHigh: '{0} registros de fallos de alerta encontrados',
                scoreAlertFailedMedium: '{0} registros de fallos de alerta encontrados',
                scoreAlertPending: '{0} registros de alerta pendientes de sincronización',
                statAlertDesc: '{0} tareas habilitadas · {1} canales',
                assetAlertDesc: '{0} registros fallidos, {1} registros pendientes de sincronización',
                failedExecutionRecords: 'Registros de ejecución fallidos',
                taskID: 'ID de tarea',
                executeTime: 'Tiempo de ejecución',
                backupTasks: 'Tareas de copia de seguridad',
                systemMetrics: 'Métricas de ejecución',
                cpu: 'CPU',
                thresholdPercent: 'Umbral {0}%',
                recent24HourPeakPercent: 'Pico en las últimas 24 h: {0}',
                loadAverage: 'Carga 1 / 5 / 15 minutos: {0} / {1} / {2}',
                sourceMount: 'Punto de montaje {0}',
                ...
                notCounted: 'No contabilizado',
                dataSource: 'Fuente de datos',
                noHighUsagePeriod: 'Sin períodos de alto uso',
                monitorDisabledOrNoData: 'El monitoreo del host está deshabilitado o no hay datos disponibles',
                systemHealthStatus: 'Estado de riesgo de ejecución del host en las últimas 24 h',
                mainReasons: 'Causas principales',
                ...
                diskSpaceUsage: 'Uso de espacio en disco',
                usedCapacity: 'Usado / Total',
                fileSystem: 'Sistema de archivos',
                resourceTrendSummary: 'Resumen de tendencia de recursos',
                last24Hours: 'Últimas 24 horas',
                granularityHour: 'Granularidad: 1 hora',
                current: 'Actual',
                average: 'Promedio',
                ...
                hoursShort: '{0} h',
                minutesShort: '{0} min',
                websiteStatus: 'Estado de sitios web',
                websiteHealthStatus: 'Estado de salud de protección web',
                websiteHealthNormalReason: 'Sitios web, certificados, WAF y monitoreo web están saludables',
                websiteHealthAttentionDesc:
                    '{0} elementos de riesgo detectados. Gestiónelos pronto para proteger la seguridad y disponibilidad del sitio web.',
                websiteHealthNormalDesc: 'Las métricas de protección web actuales están normales',
                handleSslRisk: 'Gestionar riesgos de certificados',
                viewWaf: 'Ver WAF',
                priority: 'Prioridad',
                riskDescription: 'Descripción del riesgo',
                deductScore: 'Puntuación deducida',
                remaining: 'Restante',
                wafSourceIpTop: 'IPs fuente WAF TOP5',
                wafAffectedSiteTop: 'Sitios afectados TOP5',
                sslRisk: 'Riesgos de certificados',
                sslExpiring: 'Certificados por vencer',
                includedInReport: 'Incluido en el informe',
                needRenewal: 'Renovación recomendada',
                fromExpireInfo: 'Desde información de vencimiento',
                runningWebsite: 'Sitios web en ejecución',
                fromWebsiteStatus: 'Desde la lista de sitios web',
                stoppedWebsite: 'Sitios web detenidos',
                confirmStoppedWebsite: 'Confirme si esto es lo esperado',
                expiringWebsite: 'Sitios web por vencer',
                expiringSoon: 'Vencimiento próximo',
                none: 'Ninguno',
                noSslRisk: 'No hay certificados que gestionar',
                websiteProtection: 'WAF y monitoreo web',
                websiteMonitor: 'Monitoreo web',
                waf: 'WAF',
                siteAvailability: 'Disponibilidad del sitio',
                monitoredSites: 'Sitios monitoreados',
                requestCount: 'Solicitudes',
                abnormalSites: 'Sitios anómalos',
                count5xxSource: 'Contabilizado por solicitudes 5xx',
                wafIntercept: 'Bloqueos WAF',
                highRiskHit: 'Detecciones de alto riesgo',
                websiteMonitorDisabledOrNoData: 'El monitoreo web está deshabilitado o no hay datos disponibles',
                wafDisabledOrNoData: 'WAF deshabilitado o sin datos de bloqueos',
                noWafData: 'Sin datos de bloqueos WAF',
                sourceIP: 'IP de origen',
                hitCount: 'Detecciones',
                level: 'Nivel',
                attackType: 'Tipo de ataque',
                requestRatio: 'Proporción de solicitudes',
                installed: 'Instalado',
                normalRunning: 'Ejecución normal',
                failedStart: 'Fallo al iniciar',
                manualStopped: 'Detenido manualmente',
                failed: 'Fallido',
                success: 'Exitoso',
                canUpdate: 'Actualizable',
                listSeparator: ', ',
                containerCount: 'Contenedores',
                stopped: 'Detenido',
                abnormal: 'Anómalo',
                abnormalContainers: 'Contenedores anómalos',
                resourceUsage: 'Uso de recursos',
                exposedContainerPorts: 'Puertos expuestos',
                portMapping: 'Mapeo de puertos',
                risk: 'Riesgo',
                noAbnormalContainer: 'Sin contenedores anómalos',
                noExposedContainer: 'No se detectaron puertos expuestos',
                publicExpose: 'Exposición pública',
                privateExpose: 'Mapeo privado',
                ...
                resourceThresholdContainers: 'Contenedores que superan el umbral de CPU / memoria',
                noThresholdExceededContainer: 'No hay contenedores que superen el umbral',
                triggerMetric: 'Métrica activada',
                ...
                failedJobs: 'Tareas fallidas',
                recentRecoveryPoint: 'Último punto de recuperación',
                remoteCoverage: 'Cobertura remota',
                recent7Days: 'Últimos 7 días',
                taskTypeStats: 'Estadísticas por tipo de tarea',
                total: 'Total',
                taskTypeDesc: '{0} habilitadas, {1} deshabilitadas',
                failedOrAttentionTasks: 'Tareas fallidas o de atención',
                execution: 'Ejecución',
                latestExecution: 'Última ejecución',
                remoteBackup: 'Copia de seguridad remota',
                localOnly: 'Solo local',
                covered: 'Cubierto',
                noAttentionCronjob: 'Sin tareas programadas fallidas o de atención',
                cronjobHealth: 'Estado de salud de tareas programadas',
                ...
                generationRule: 'Regla de generación',
                scheduleDaily: 'Diario',
                scheduleDailyDesc: 'Generar un informe de las últimas 24 horas a las 09:00 cada día',
                scheduleWeekly: 'Semanal',
                scheduleWeeklyDesc: 'Generar un informe de los últimos 7 días a las 09:00 cada lunes',
                scheduleMonthly: 'Mensual',
                scheduleMonthlyDesc: 'Generar un informe del mes anterior a las 09:00 el día 1',
                scheduleCurrentDaily: 'Cada día a las 09:00, generar informe de las últimas 24 horas · Próximo {0}',
                scheduleCurrentWeekly: 'Cada lunes a las 09:00, generar informe de los últimos 7 días · Próximo {0}',
                scheduleCurrentMonthly: 'El día 1 a las 09:00, generar informe del mes anterior · Próximo {0}',
                notificationMethod: 'Métodos de notificación',
                channel: 'Canal',
                receiver: 'Destinatario',
                systemThreshold: 'Umbral del sistema',
                metric: 'Métrica',
                currentRule: 'Regla actual',
                hostMonitor: 'Monitoreo del host',
                monitorInterval: 'Intervalo de monitoreo',
                exportSettings: 'Configuración de exportación',
                lastExportReport: 'Último resultado generado',
                noLastExportReport: 'Sin registros de informes exportados',
                lastExportStatus: 'Estado de última exportación',
                exportFile: 'Archivo exportado',
                generateTime: 'Fecha de generación',
                fileSize: 'Tamaño del archivo',
                viewExportHistory: 'Ver historial de exportación',
                ...
                readOnlyPermissionTip:
                    'La cuenta actual solo puede ver la configuración del informe de operaciones. Contacte al administrador para realizar cambios.',
                refreshing: 'Actualizando',
                exporting: 'Exportando',
                exportFailed: 'Error al exportar el informe',
                generating: 'Generando',
                saved: 'Guardado',
                saveFailed: 'Error al guardar la configuración',
                generateNow: 'Generar ahora',
                generateSuccess: 'Archivo de informe generado: {0}',
                generateFailed: 'Error al generar el informe',
                enabledStatus: 'Habilitado',
                disabledStatus: 'Deshabilitado',
                alertConfigInvalid: 'Configuración inválida',
                thresholdRule: 'Umbral {0}, disparar después de {1} veces consecutivas',
                hours: '{0} horas',
                minutes: '{0} minutos',
                seconds: '{0} segundos',
                totalExports: 'Total de exportaciones',
                successExports: 'Exportaciones exitosas',
                ...
                manualExport: 'Manual',
                scheduledExport: 'Programado',
                exportResult: 'Resultado de exportación',
                exportDetail: 'Detalle de exportación',
            },
        },
        user: {
            user: 'Usuario',
            ...
            masterOnlyPermission: 'Permiso del nodo principal',
            masterOnlyPermissionHelper: 'Este permiso solo tiene efecto en el nodo principal.',
            view: 'Ver',
            manage: 'Gestionar',
        },
        app: {
        ...
        logExport: {
            ...
            records: 'Historial de exportación',
            retentionDays: 'Retención del historial de exportación',
            timeRange: 'Intervalo de tiempo',
            timeRequired: 'Selecciona el intervalo de exportación',
            websiteRequired: 'Selecciona un sitio web',
            blackStatus: 'Estado de lista negra',
            black: 'Bloqueado',
            notBlack: 'No bloqueado',
            fuzzy: 'Coincidencia parcial',
            regex: 'Expresión regular',
            invalidRegex: 'Introduce una expresión RE2 válida de hasta 256 caracteres',
            created: 'Tarea de exportación creada',
            fileName: 'Nombre del archivo',
            fileSize: 'Tamaño del archivo',
            expiresAt: 'Caduca el',
            cancelConfirm: '¿Cancelar esta tarea de exportación?',
            deleteConfirm: '¿Eliminar este registro y archivo de exportación?',
        },
        waf: {
            name: 'WAF',
            ...
            geoHelper:
                'Combina políticas de región y provincia con un solo interruptor. Primero se aplican las reglas regionales y después las provinciales',
            regionPolicy: 'Política regional',
            provincePolicy: 'Política provincial',
            ...
            deny: 'Prohibir',
            allow: 'Permitir',
            allowOnly: 'Permitir solo lo seleccionado',
            field: 'Objeto',
            pattern: 'Condición',
            ...
            hostSearchHelper: 'Introduce el Host para búsqueda difusa',
            toCreate: 'Crear',
            closeWaf: 'Cerrar WAF',
            ...
            originProtect: 'Protección del origen CDN',
            attacklog: 'Registro de intercepciones',
            unknownWebsite: 'Acceso a dominio no autorizado',
            geoRuleEmpty: 'Selecciona al menos una región o provincia',
            ...
            spiderIpHelper:
                'Al activarlo, solo se permiten los crawlers seleccionados; al desactivarlo, se bloquean todos.',
            spiderIp: 'Pool de IPs de crawlers',
            spider: 'Crawler',
            spiderAllowlist: 'Crawlers permitidos',
            spiderAllowlistEmpty: 'No hay crawlers seleccionados. Al guardar, se bloquearán todos.',
            ...
            executionStrategy: 'Estrategia de ejecución',
            detectionStrength: 'Nivel de detección',
            protectionMode: 'Modo de protección',
            observationMode: 'Modo de observación',
            standardMode: 'Modo estándar',
            observationModeHelper: 'Detecta y registra solicitudes sin bloquearlas',
        ...
        monitor: {
            ...
            realIPRecognition: 'Identificación de IP real',
            ...
            originProtection: 'Protección del servidor de origen',
            originProtectionHelper:
                'Solo los nodos CDN de los grupos IP seleccionados pueden conectarse al origen. La detección de la IP real usa otro interruptor.',
            originProtectionIPGroups: 'Grupos IP de retorno CDN',
            originProtectionIPGroupsPlaceholder: 'Seleccione grupos IP de retorno CDN de confianza',
            originProtectionWarning:
                'Una configuración incorrecta puede impedir el acceso al sitio. Confirme que incluye todas las direcciones de retorno CDN.',
            originProtectionEnableConfirm:
                'Las conexiones fuera de los grupos IP seleccionados se tratarán como acceso directo al origen y se bloquearán. ¿Continuar?',
        ...
        alert: {
            ...
            sendCount: 'Envíos',
            recipientPlaceholder: 'Ingrese la dirección de correo',
            addRecipient: 'Agregar destinatario',
            webhookItem: 'Enlace Webhook',
            addWebhook: 'Agregar Webhook',
            selectAlertType: 'Seleccionar tipo de alerta',
            configDetail: 'Configurar detalles',
            webhookCount: 'Cantidad de Webhooks',
            sms: 'SMS',
            wechat: 'WeChat',
            dingTalk: 'DingTalk',
            feiShu: 'FeiShu',
        ...
        vm: {
            ...
            healthCheckResult: {
                ...
                fail: 'Error',
                normal: 'Normal',
                fixCommand: 'Comando de corrección',
                technicalDetail: 'Detalles técnicos',
                check: {
                    vmName: 'Nombre de la máquina virtual',
                    libvirtConnection: 'Conexión con Libvirt',
                    vmDefinition: 'Definición de la máquina virtual',
                    domainXML: 'XML de la máquina virtual',
                    architecture: 'Arquitectura',
                    virtualizationType: 'Tipo de virtualización',
                    machineType: 'Tipo de máquina',
                    efiCapability: 'Compatibilidad con EFI',
                    qemuEmulator: 'Emulador QEMU',
                    bootOrder: 'Orden de arranque',
                    arm64Firmware: 'Firmware ARM64',
                    arm64Features: 'Funciones de ARM64',
                    arm64Video: 'Pantalla ARM64',
                    arm64FirmwareFile: 'Archivo de firmware ARM64',
                    arm64CDROM: 'CD-ROM ARM64',
                    blockDevice: 'Dispositivo de bloques',
                    isoArchitecture: 'Arquitectura de la ISO',
                    network: 'Red',
                    qemuLog: 'Registro de QEMU',
                    arm64RuntimeFirmware: 'Firmware ARM64 en ejecución',
                },
                reason: {
                    invalidName: 'El nombre de la máquina virtual no es válido.',
                    connectionFailed: 'No se puede conectar con {uri}.',
                    vmNotFound: 'No se encontró la máquina virtual {name}.',
                    xmlReadFailed: 'No se pudo leer el XML de la máquina virtual.',
                    liveXMLFallback:
                        'No se pudo leer la configuración persistente; se está usando la configuración en ejecución.',
                    xmlParseFailed: 'No se pudo analizar el XML de la máquina virtual.',
                    stateReadFailed:
                        'No se pudo determinar el estado de la máquina virtual. Se omitió la comprobación del firmware en ejecución.',
                    guestArchMissing: 'Falta la arquitectura del sistema invitado en el XML.',
                    archMismatch:
                        'La arquitectura del host es {hostArch} y la del invitado es {guestArch}. No se admite la ejecución entre arquitecturas diferentes.',
                    nonKVMType: 'El tipo de virtualización es {type}, no el tipo KVM predeterminado.',
                    archOrMachineMissing: 'Falta la arquitectura o el tipo de máquina en el XML.',
                    machineUnsupported: 'El host no admite {arch}/{machine}.',
                    emulatorNotSpecified: 'No se especificó un emulador en el XML; Libvirt seleccionará uno.',
                    fileNotFound: 'No se encontró el archivo: {path}',
                    fileNotExecutable: 'El archivo no es ejecutable: {path}',
                    bootDeviceMissing: 'No hay ningún dispositivo de arranque definido en el XML.',
                    diskNotFirst: 'El disco no es el primer dispositivo de arranque. Orden actual: {order}',
                    cdromNotInBootOrder: 'Hay un CD-ROM conectado, pero no está incluido en el orden de arranque.',
                    firmwareNotConfigured:
                        'EFI o Loader no están configurados, por lo que el invitado podría no iniciar la pantalla o arrancar.',
                    acpiCustom: 'ACPI está configurado. Confirme que el invitado necesita esta personalización.',
                    acpiRequiresUEFI: 'ACPI está configurado sin UEFI, lo que provoca el error ACPI requires UEFI.',
                    apicUnsupported: 'x86 APIC está configurado, pero no es válido para ARM64.',
                    gicNotDeclared:
                        'GIC no aparece en el XML persistente; Libvirt puede añadirlo durante la ejecución.',
                    videoNotConfigured: 'No hay ningún dispositivo de pantalla configurado en el XML.',
                    videoNotVirtio: 'El tipo de dispositivo de pantalla es {type}; se recomienda Virtio.',
                    firmwareFileMissing: 'El archivo de firmware no existe o no es un archivo normal: {path}',
                    firmwareNotAvailable:
                        'Libvirt no informa de compatibilidad con EFI y no se encontró firmware UEFI para ARM64.',
                    cdromBusNotSCSI: 'El CD-ROM utiliza el bus {bus}; ARM64 requiere SCSI.',
                    cdromNotOnVirtioSCSI: 'El CD-ROM no está conectado a un controlador Virtio SCSI.',
                    diskSourceMissing: 'No hay un archivo de origen configurado para {device} {target}.',
                    sourceNotFound: 'El archivo de origen de {device} {target} no existe: {path}',
                    sourceIsDirectory: 'La ruta de origen de {device} {target} es un directorio: {path}',
                    systemDiskNotFound: 'No se detectó ningún disco del sistema.',
                    isoArchMismatch:
                        'El invitado {guestArch} tiene conectada una imagen que parece corresponder a {imageArch}: {path}',
                    networkReadFailed: 'No se puede leer la red {name}.',
                    networkStateReadFailed: 'No se puede leer el estado de la red {name}.',
                    networkInactive: 'La red {name} existe, pero está inactiva.',
                    logUnavailable: 'No hay ningún registro de inicio disponible para analizar.',
                    logErrorsFound: 'Se encontraron errores comunes en el registro de inicio más reciente.',
                    vmNotRunning:
                        'La máquina virtual no está en ejecución, por lo que se omitió la comprobación de los argumentos de QEMU.',
                    runtimeFirmwareMissing: 'No se encontró pflash, AAVMF ni QEMU_EFI en el registro de QEMU.',
                },
            },
            ...
            orphanClean: 'Limpieza de datos huérfanos',
            orphanScan: 'Volver a escanear',
            orphanCleanHelper:
                'Solo se muestran archivos candidatos no referenciados por máquinas virtuales, instantáneas o plantillas registradas. Confirme que ya no se usan antes de limpiarlos; la operación no se puede deshacer.',
            orphanSelected: '{0} archivos seleccionados, {1} en total',
            orphanSize: 'Tamaño',
            orphanCleanConfirm: '¿Limpiar los {0} archivos seleccionados ({1})? Esta operación no se puede deshacer.',
            orphanCleanSuccess: 'Se limpiaron {0} archivos y se liberaron {1}.',
            orphanType: {
                orphan_domain_disk: 'Disco huérfano',
            ...
            downloadFromServer: 'Descarga remota',
            ...
            deleteSourceFileHelper:
                'Si se marca, también se eliminará el archivo de origen referenciado por este registro ISO y no se podrá recuperar.',
