...
const message = {
    commons: {
        ...
        rule: {
            ...
            complexityPassword: '支援長度為 8-30 位，並包含字母、數字、特殊字元中至少兩項的密碼組合',
    ...
    aiTools: {
        agents: {
            ...
            operationType: '操作類型',
            batchAction: '批量{0}',
            installSkillAction: '下發 Skill',
            batchAgentTask: '批量{0}智能體',
            dispatchAgentTask: '下發智能體{0}任務',
            dispatchTask: '下發{0}任務',
            taskSubmitted: '{0}任務已下發',
            allNodes: '所有節點',
            targetVersion: '目標版本',
            ...
            verifyModel: '驗證模型',
            verifyModelHelper: '請選擇該帳號有權存取的模型，儲存時將使用它發送最小請求以驗證連線。',
            verifyModelRequired: '請選擇驗證模型',
            discoverModels: '取得模型',
            automaticModelDiscovery: '自動取得',
            manualModelConfiguration: '手動配置',
            discoverModelsHelper: '從供應商的 /v1/models 介面取得模型，取得後將全部加入模型池',
            discoverModelsFailedFallback: '取得模型失敗，請手動配置模型',
            accountModelsDuplicate: '模型池中存在重複模型，請檢查後重試',
            modelPool: '模型池',
            fallbackModels: '備用模型',
            addFallbackModel: '新增備用模型',
            fallbackModelsEmpty: '尚未配置備用模型',
            ...
            npmRegistry: 'NPM 源',
            npmRegistryHelper: '用於 OpenClaw 外掛安裝時的 npm registry，可選擇預設來源或手動輸入自訂來源',
            npmRegistryInvalid: '請輸入正確的 NPM 源地址，需以 http:// 或 https:// 開頭',
            ...
            skillsMarketSourceLocalHub: '本地 Skill 商店',
            skillsScore: '評分',
            ...
            roleMarkdownDescriptions: {
                'AGENTS.md': [
                    'Agent 的操作說明，以及如何使用記憶。',
                    '每次會話開始時都會載入。',
                    '適合放規則、優先級和行為方式等內容。',
                ],
                'SOUL.md': ['人格、語氣和邊界。', '每次會話都會載入。'],
                'USER.md': ['使用者是誰，以及應該如何稱呼和回應使用者。', '每次會話都會載入。'],
                'IDENTITY.md': ['Agent 的名字、氣質和 emoji。', '會在 bootstrap 儀式中建立或更新。'],
                'TOOLS.md': ['關於本地工具和約定的說明。', '不會控制工具可用性，僅作為使用指引。'],
                'HEARTBEAT.md': ['可選的心跳執行檢查清單。', '盡量保持簡短，避免消耗過多 token。'],
                'BOOT.md': [
                    '可選的啟動檢查清單，會在 gateway 重啟且啟用內部 hooks 時執行。',
                    '盡量保持簡短；如需對外發送訊息，請使用 message 工具。',
                ],
            ...
            threadSession: '執行緒會話',
            replyMode: '回覆模式',
            requireMention: "群聊需 {'@'} 機器人",
            requireMentionTrue: "需要 {'@'}",
            requireMentionFalse: "無需 {'@'}",
            requireMentionOpen: '依群組設定',
            groupPolicy: '群組策略',
            policyAllowlist: '白名單',
            policyOpen: '開放',
            policyDisabled: '禁用',
            ...
            addBot: '新增 Bot',
            accountId: '帳戶 ID',
            accountIdPlaceholder: '用於區分不同 Bot 的唯一標識，儲存後用於配置和路由識別',
            setDefaultBot: '設為預設 Bot',
            botDuplicateField: '{field} 不能重複',
            botRequired: '請至少新增一個 Bot',
            botId: 'Bot ID',
            allowFrom: '私聊白名單',
            allowFromPlaceholder: '一行一個發送方識別碼',
            allowlistPolicyHelper: '{0}，僅在{1}為白名單時生效',
            systemPrompt: '系統提示詞',
            groupAllowFrom: '群組白名單',
            groupAllowFromPlaceholder: '一行一個群組識別碼',
            separateSessionByConversation: '按會話隔離',
            groupSessionScope: '群會話範圍',
            groupSessionScopeGroup: '整群共享',
            groupSessionScopeGroupSender: '群內按人隔離',
            sharedMemoryAcrossConversations: '跨會話共享記憶',
            asyncMode: '非同步模式',
            ackText: '確認訊息',
            ackTextDefault: '任務已接收，處理中...',
            streaming: '即時串流',
            streamingOff: '關閉',
            streamingPartial: '部分輸出',
            streamingBlock: '阻塞輸出',
            streamingProgress: '進度輸出',
            allowFromRequired: '請至少填寫一個白名單項',
            pairingCode: '配對碼',
            pairingCodePlaceholder: '請輸入配對碼',
            approvePairing: '批准配對',
            saveSuccess: '保存成功',
            successAndRestart: '{0}，容器正在自動重新啟動。',
        ...
        model: {
            ...
            repoID: '倉庫 ID',
            endpointLabel: '{0} 地址',
            acceleratedEndpointLabel: '{0} 加速地址',
            tokenOptionalLabel: '{0} Token（可選）',
            searchSource: '搜尋 {0}',
            hfEndpointHelper: '國內存取 HuggingFace 不穩定時可設定加速地址，搜尋、詳情和下載都會使用該地址。',
            sortTrending: '熱門趨勢',
            sortLikes: '按讚最多',
            sortDownloads: '下載最多',
            sortUpdated: '最近更新',
            ...
            cancelTaskConfirm: '確認取消該下載任務？',
            deleteLocalModelConfirm: '確認刪除本地模型 {0}？',
        },
        proxy: {
            proxy: 'AI 閘道增強',
        ...
        aiProxy: {
            ...
            lastError: '最近錯誤',
            modelMap: '模型映射',
            apiKeyKeepEmpty: 'API Key（留空不改）',
            apiKeyOnceHint: 'API Key 僅建立時顯示一次，請及時複製保存。',
            apiKeyOnceSave: 'API Key 只顯示一次，請立即保存：',
            qpsLimit: 'QPS 限制',
            tokenLimit: 'Token 限制',
            tokenUsed: '已用 Token',
            tokenRemaining: '剩餘 Token',
            resetToken: '重設 Token',
            resetTokenConfirm: '確認重設 {0} 的 Token 用量？',
            unlimited: '不限',
            unlimitedWithAuto: '不限，包含 auto',
            lastUsedAt: '最近使用時間',
            settingTitle: 'AI 閘道設定',
            basicSetting: '基礎設定',
            ...
            lbPolicyWeightedRoundRobinDesc:
                '根據模型帳號權重分配請求，權重越高承擔的請求越多，適合後端性能不同的場景。',
            lbPolicyFailover: '故障轉移',
            lbPolicyFailoverDesc: '優先使用優先級最高的模型帳號，失敗或冷卻後再切換到下一個可用帳號。',
            maxConcurrency: '最大併發',
            queueSize: '等待佇列大小',
            queueTimeoutSeconds: '佇列等待逾時（秒）',
            requestTimeoutSeconds: '非串流請求逾時（秒）',
            ...
            deleteTargetConfirm: '確認刪除{0} {1}？',
            deleteBackendTitle: '刪除模型帳號',
            userFallback: '已刪除使用者 (ID: {0})',
            requestModel: '請求模型',
            upstreamModel: '上游模型',
            ...
            ranking: '排行榜',
            rank: '排名',
            promptToken: '輸入 Token',
            completionToken: '輸出 Token',
            totalToken: '總 Token',
            ...
            modelGroupModelsPlaceholder: '請選擇或輸入請求模型名稱',
            modelGroupModelsHelper: '只填寫真實上游模型；智慧路由會按順序優先選擇靠前模型，不做模型間負載均衡。',
            modelGroupGuide:
                '模型組只配置真實上游模型；auto 是用戶端請求 AI 網關時使用的虛擬模型名稱，不需要放進模型組。',
            modelGroupModelCount: '{0} 個模型',
            contentCompliance: '內容合規',
            contentAction: '處理動作',
            actionBlock: '阻斷',
            actionAuditOnly: '僅記錄',
            actionDropHistory: '刪除歷史',
            severity: '風險等級',
            severityHigh: '高',
            severityMedium: '中',
            severityLow: '低',
            sensitiveWord: '敏感詞',
            sensitiveGroup: '敏感詞分組',
            sensitiveWordCount: '詞數',
            normalizedWord: '歸一化詞',
            matchedWords: '命中詞',
            matchedGroups: '命中分組',
            ...
            embeddingConfigDesc:
                '用於智慧路由和內容合規語義樣本匹配。建議使用 llama.cpp + Qwen3-Embedding-0.6B，配置後可重建樣本向量。',
            decisionConfig: '判定參數',
            ...
            routeThreshold: '路由閾值',
            routeThresholdHelper: '用於智慧路由：請求與簡單/複雜樣本相似度達到該值後，才採用樣本匹配結果。',
            auditThreshold: '審核閾值',
            auditThresholdHelper: '用於內容合規：請求與審核樣本相似度達到該值後，才認為命中審核樣本。',
            topK: 'TopK',
        ...
        skillsHub: {
            ...
            repositoryGithubOnly: '僅支援 GitHub 倉庫地址',
            repositoryRef: '分支或 Tag',
            repositoryRefPlaceholder: '預設為 main，失敗後將嘗試 master',
            repositoryDownloadPreview: '目標下載地址：',
            packageURL: '壓縮包 URL',
            packageURLPlaceholder: '請輸入 .zip 壓縮包地址',
            importSuccess: 'Skill 匯入成功，已進入待審核狀態。',
            source: '來源',
            applicableAgent: '適用智能體',
            overview: '概覽',
            versionHistory: '版本歷史',
            publishedAt: '上架時間',
            versionMarker: '標記',
            ...
            riskCheckResult: '安全檢查結果',
            noRiskFound: '暫未發現明顯風險。',
            riskFilePath: '檔案路徑',
            riskKeyword: '命中的關鍵字或規則',
            riskDescription: '風險說明',
            publishHighRiskConfirm: '該 Skill 存在高風險項，可能包含腳本執行、外部下載或敏感資訊存取。確認仍要上架嗎？',
            approve: '審核通過',
            reject: '審核駁回',
            publish: '上架',
            disable: '下架',
            customTarget: '自訂智能體',
            addCustomTarget: '添加智能體',
            installToTarget: '安裝到自訂智能體',
            hostSkillDir: 'Skill 目錄',
            hostSkillDirHelper: '請填寫節點 Skill 目錄路徑。',
            installMethod: '安裝方式',
            copy: '複製',
            extract: '解壓',
            postInstallCommand: '安裝後命令',
            localSource: '本地上傳',
            uploadDragTitle: '拖拽 Skill 包到此處，或點擊上傳',
            uploadFormatLabel: '支援格式：',
            uploadFormatValue: '.zip、.7z、.tar、.tar.gz',
            uploadSizeLabel: '檔案大小：',
            uploadSizeValue: '單個檔案不超過 5 MB',
            uploadRequirementLabel: '包內要求：',
            uploadRequirementPrefix: 'Skill 包內必須包含',
            onlySupportedArchive: '僅支援上傳 .zip、.7z、.tar、.tar.gz 格式的 Skill 包',
            uploadSizeExceeded: '單個 Skill 包不能超過 5 MB',
            ...
            deleteConfirm: '確認刪除該 Skill？刪除後不可恢復，已安裝到智能體中的 Skill 不受影響。',
            rejectConfirm: '確認駁回該 Skill 的審核？駁回後 Skill 將進入「審核未通過」狀態。',
            downloadPublishedOnly: '僅支援下載已上架的 Skill 包。',
            ...
            riskType: {
                script_file: '腳本檔案',
                dependency_manifest: '依賴聲明',
                external_url: '外部 URL',
                environment_variable: '環境變數',
                dockerfile: 'Dockerfile',
                command_execution: '命令執行',
                remote_script_execution: '遠端腳本執行',
                eval_execution: '動態執行',
                base64_execution: 'Base64 解碼執行',
                privileged_command: '提權命令',
                dangerous_delete: '危險刪除',
                world_writable_permission: '高危權限',
                credential: '疑似密鑰',
                sensitive_path: '敏感路徑',
                suspicious_download_execute: '可疑下載執行',
                binary_content: '二進位內容',
                scan_truncated: '掃描內容截斷',
            },
            riskDescriptionText: {
                script_file: '包含腳本檔案，可能執行本地命令。',
                dependency_manifest: '包含依賴聲明檔案，安裝時可能拉取外部依賴。',
                external_url: '包含外部 URL，請確認外聯地址可信。',
                environment_variable: '聲明了環境變數，請確認用途和預設值。',
                dockerfile: '包含 Dockerfile，可能定義映像構建或執行邏輯。',
                command_execution: '包含命令執行相關呼叫，請確認執行邏輯可信。',
                remote_script_execution: '包含遠端腳本下載後直接執行邏輯。',
                eval_execution: '包含 eval 動態執行邏輯。',
                base64_execution: '包含 Base64 解碼後執行邏輯。',
                privileged_command: '包含 sudo 提權命令。',
                dangerous_delete: '包含危險刪除命令。',
                world_writable_permission: '包含 chmod 777 權限放開命令。',
                credential: '包含疑似 API Key、Token、Secret 或 Password。',
                sensitive_path: '包含存取敏感目錄或敏感檔案的行為。',
                suspicious_download_execute: '包含可疑外聯下載或下載後執行邏輯。',
                binary_content: '檔案中包含 NUL 位元組，可能隱藏可執行內容或二進位內容。',
                scan_truncated: '檔案內容超過掃描上限，未掃描部分仍需人工確認。',
            },
        },
        benchmark: {
            title: '基準測試',
            ...
            endpoint: '介面路徑',
            tokenizer: '分詞器',
            tokenizerPlaceholder: '請選擇或輸入本機分詞器目錄，例如 /opt/1panel/tokenizers/DeepSeek-V3',
            runConfig: '執行設定',
            rawResult: '原始結果',
            resultMetrics: '結果指標',
            contextTokens: '上下文長度',
            contextTokensHelper: '本次測試的輸入 Token 與輸出 Token 上限之和。',
            outputThroughput: '輸出吞吐',
            outputThroughputHelper: '模型每秒產生的輸出 Token 數，越高表示生成速度越快。',
            totalThroughput: '總吞吐',
            totalThroughputHelper: '每秒處理的輸入與輸出 Token 總數，用於衡量整體處理能力。',
            firstTokenLatency: '首 Token 延遲',
            firstTokenLatencyHelper: '從請求送出到收到第一個 Token 的時間，越低表示回應越快。',
            tokenValueHelper: '請輸入正整數或 k 單位，例如 512、1k、32k',
            numPrompts: '請求數量',
            concurrency: '併發數',
            mean: '平均值',
            median: '中位數',
            requestRate: '請求速率',
            requestRateUnlimited: '不限速（最大吞吐）',
            requestRateCustom: '自訂 QPS',
            requestRateCustomPlaceholder: '請輸入每秒請求數，如 2.5',
            successfulRequests: '成功請求',
            requestThroughput: '請求吞吐',
            timeout: '逾時時間（秒）',
            image: 'vLLM 映像',
            ignoreEos: '忽略 EOS',
            extraHeaders: '額外請求標頭',
        ...
        mcp: {
            ...
            protocolVersionHelper: '僅用於無狀態 Streamable HTTP 自動初始化下游 stdio MCP Server',
            gatewayArgsHelper:
                '參數將附加到 supergateway 啟動命令，不支援修改由 1Panel 管理的傳輸、連接埠、路徑和協議參數',
            testConnection: '測試連線',
    ...
    cronjob: {
        ...
        syncIpGroupHelper: '同步 WAF 黑白名單中的遠端 IP 組',
    ...
    monitor: {
        ...
        goroutineSummary: '共 {0} 個 Goroutine，彙總為 {1} 組呼叫堆疊',
        goroutineTruncated: '快照內容過大，目前僅顯示部分呼叫堆疊。',
        ...
        startCapture: '開始擷取',
        capturing: '正在擷取',
        captureSuccess: '診斷檔案已產生，已開始下載',
        profileCPU: 'CPU',
        profileHeap: '堆積記憶體',
        profileGoroutine: 'Goroutine',
        profileMutex: '互斥鎖',
        profileBlock: '阻塞',
        runtimeRSSDesc: '程序目前佔用的實體記憶體，包括 Go 堆積、執行緒堆疊及原生記憶體。',
        runtimeHeapAllocDesc: 'Go 堆積中已配置且尚未釋放的記憶體，持續增長可能表示物件未釋放。',
        runtimeHeapObjectsDesc: 'Go 堆積中目前存活的物件數量，持續增長可能表示物件未釋放。',
        runtimeGoroutineDesc: '目前輕量級並行工作數量，持續增長通常需要檢查 Goroutine 洩漏。',
        profileCPUDesc: '在指定時間內取樣 CPU 呼叫堆疊，用於定位實際消耗 CPU 的熱點函式。',
        profileHeapDesc: '記錄目前仍在使用的 Go 堆積物件及其配置呼叫堆疊，用於排查記憶體持續增長。',
    ...
    terminal: {
        ...
        nodeAdminLocalOnly: '節點管理員僅支援本地終端',
    ...
    file: {
        ...
        shareList: '分享列表',
        fileTools: '檔案工具',
        aiSearchHitLines: '命中行',
        aiSearch: 'AI 搜尋',
        aiSearchTitle: 'AI 搜尋',
        aiSearchHint:
            '按檔案內容逐行比對；比對方式見搜尋列右側按鈕與下方「進階條件」。啟用並儲存 AI 帳號後，還可產生 Markdown 摘要。',
        aiSearchAccountTitle: 'AI 帳號',
        aiSearchAccountIntro: '選擇用於產生摘要的大模型帳號，修改後請點選儲存。',
        aiSearchAccountEnable: '啟用檔案 AI 搜尋',
        aiSearchSaveAccount: '儲存帳號設定',
        aiSearchSectionQuery: '搜尋',
        aiSearchSectionConditions: '檢索條件',
        aiSearchResultsSection: '分析結果',
        aiSearchContentLabel: '搜尋內容',
        aiSearchDirLabel: '目錄',
        aiSearchExtLabel: '檔案副檔名',
        aiSearchModifiedPreset: '修改時間',
        aiSearchSizePresetLabel: '檔案大小',
        aiSearchTimeAny: '不限時間',
        aiSearchTime3h: '最近 3 小時',
        aiSearchTime1d: '最近 1 天',
        aiSearchTime7d: '最近 7 天',
        aiSearchTime30d: '最近 30 天',
        aiSearchTimeCustom: '自訂',
        aiSearchSizeAny: '不限大小',
        aiSearchSize0_10mb: '0 ~ 10 MB',
        aiSearchSize10_100mb: '10 MB ~ 100 MB',
        aiSearchSize100_1gb: '100 MB ~ 1 GB',
        aiSearchSizeGte1gb: '≥ 1 GB',
        aiSearchSizeCustom: '自訂（位元組）',
        aiSearchPlaceholder: '請輸入搜尋內容',
        aiSearchContainSub: '含子目錄',
        aiSearchMaxItems: '參與檢索的路徑／檔案條數上限（目錄列舉，1–2000）',
        aiSearchRun: '開始分析',
        aiSearchTruncated: '目錄項過多，僅納入部分清單，結果可能不完整。',
        aiSearchPreFiltered: '已依關鍵字對相對路徑做預篩選，以縮小送給模型的條目範圍。',
        aiSearchMeta: '供分析條目：{0} | 耗時 {1} | Token {2}',
        aiSearchQueryRequired: '請輸入搜尋描述或關鍵字',
        aiSearchContentHits: '內容命中',
        aiSearchContentScanMeta: '內容掃描：已讀取 {0} 個文字檔案（依目前檢索條件；受大小與數量限制）。',
        aiSearchNoLineHits: '在已掃描的文字檔案中，沒有任何一行符合目前檢索條件；上方摘要仍可能基於檔名與中繼資料。',
        aiSearchHitsTruncated: '部分檔案未掃描或命中清單因上限被截斷。',
        aiSearchHitFiles: '有命中的檔案',
        aiSearchOpenFile: '在編輯器中開啟',
        aiSearchOpenAtLine: '開啟並定位到此行',
        aiSearchGrepOnlyHint:
            '目前未啟用檔案 AI：只做確定性的內容檢索，不會呼叫大模型。啟用並儲存 AI 帳號後可獲得摘要。搜尋列與下方選項均生效。',
        aiSearchMatchCase: '區分大小寫',
        aiSearchWholeWord: '全詞比對（英文詞邊界 \\b）',
        aiSearchUseRegex: '正則表達式（Go RE2 語法）',
        aiSearchExtensions: '檔案副檔名（逗號分隔，如 go,ts,md）',
        aiSearchMinSize: '最小檔案大小（位元組，0 表示不限制）',
        aiSearchMaxSize: '最大檔案大小（位元組，0 表示不限制）',
        aiSearchSectionAdvanced: '進階條件',
        aiSearchLimitMaxItems: '檢索總檔案數',
        aiSearchLimitMaxScan: '內容掃描檔案數',
        aiSearchLimitMaxBytes: '單檔內容讀取上限',
        aiSearchLimitHitsPerFile: '單檔命中行',
        aiSearchLimitTotalHits: '命中行總數',
        aiSearchLimitUnitEntries: '條',
        aiSearchLimitUnitFiles: '個檔案',
        aiSearchLimitUnitBytes: 'B',
        aiSearchLimitUnitLines: '行',
        aiSearchMaxScanFiles: '內容掃描最多檔案數',
        aiSearchMaxFileBytes:
            '內容掃描時每個檔案最多讀取的位元組數。與上方「檔案大小」不同：那是依磁碟上的檔案大小決定是否進入清單；此項限制開啟檔案後用於比對的實際讀取量。',
        aiSearchMaxHitsPerFile: '單檔最多命中行',
        aiSearchMaxTotalHits: '命中行總數上限',
        aiSearchGrepMetaContent:
            '內容掃描：搜尋總條目 {0}，已讀取 {1} 個文字檔案（依目前檢索條件；受大小與數量限制）。耗時 {2}',
        aiSearchAdvancedResetDefaults: '恢復預設上限',
        zip: '壓縮',
        group: '使用者群組',
        path: '路徑',
        public: '公共',
        ...
        history: '歷史版本',
        historyTitle: '歷史版本',
        historyHint: '記錄檔案變更前的版本，可查看檔案內容的修改歷史，回退內容修改版本。',
        historySettingTitle: '版本策略',
        historyEnable: '啟用版本記錄',
        historyMaxPerPath: '單檔保留條數',
        historyDiskQuota: '全域磁碟配額 (MB)',
        historyCurrentScope: '目前檔案',
        historyAllScope: '所有檔案',
        historyDeleteConfirm: '確定刪除所選的修改記錄？',
        historyNeedFile: '請先開啟一個檔案',
        historyRestore: '還原此版本',
        historyOperationOnlyHint: '目前選中的是檔案操作，不支援版本還原。',
        historyCurrentFile: '目前檔案',
        historyLatestVersion: '左側顯示歷史版本內容，右側顯示所選檔案的最新版本內容',
        historyCompareTarget: '對比目標',
        historyCompareTargetPath: '對比路徑',
        historyRestoreConfirm: '確定將此版本還原到目前檔案嗎？',
        historyRestoreDirtyConfirm: '目前檔案還有未儲存的修改，還原後會覆蓋這些內容。是否繼續？',
        historyRestoreSuccess: '版本還原成功',
        historyDirtyHint: '目前編輯器存在未儲存修改，還原版本會覆蓋這些內容。',
        historyDiffHintCurrent: '左側顯示歷史版本內容，右側顯示目前檔案內容',
        historyDiffHintAll: '左側顯示歷史版本內容，右側顯示所選檔案的最新版本內容',
        copyDir: '複製路徑',
        shareFile: '分享檔案',
        shareExpire: '有效期限',
        shareExpire1h: '1 小時',
        ...
        shareQrDialogHelper: '手機打開微信、QQ 掃一掃',
        shareSaveImage: '保存圖片',
        shareOpenImage: '打開圖片',
        shareExtractFile: '提取檔案',
        shareDownloadingHint: '檔案準備中，正在開始下載…',
        shareInvalid: '分享連結無效或已失效',
        shareDownloadFailed: '下載失敗，請稍後重試',
        sharePasswordRequired: '存取密碼',
        sharePasswordRequiredInput: '請輸入存取密碼',
        sharePasswordLengthHint: '存取密碼長度需為 4-256 個字元',
        shareDownloadPasswordTip: '連結設定了存取密碼，請輸入後再下載',
        shareRiskAlert: '外鏈分享連結存在一定安全風險，建議僅分享給可信任人員，注意保護敏感資訊不被洩露。',
        sharePasswordSeparate:
            '已設定存取密碼，請以安全方式告知對方；開啟連結時需在網址後加上參數 &password=密碼，或使用可填寫密碼的下載工具。',
        shareExpiresAt: '過期時間',
        paste: '貼上',
        ...
        vscodeHelper: '請確認認證方式、主機、埠和使用者名稱。私鑰認證需先在執行 VS Code 的本地電腦完成 SSH 設定。',
        vscodeCopyConfig: '複製腳本',
        vscodeKeyHelper: '私鑰下載檔名將根據填寫的路徑產生。請將檔案儲存至該路徑，設定腳本會校驗檔案並設定存取權限。',
        vscodeKeyPath: 'SSH 私鑰路徑',
        vscodeKeyPathPlaceholder: '例如：~/.ssh/id_ed25519',
        vscodeSelectKey: 'SSH 私鑰',
        vscodeScriptPreview: 'SSH 設定腳本',
        vscodePasswordHelper: '密碼認證不會寫入本地 SSH 設定，連線遠端主機時需在 VS Code 中輸入密碼。',
        vscodePasswordHint: '密碼認證將使用填寫的主機、埠和使用者名稱發起連線，無需設定腳本或私鑰檔案。',
        vscodeScriptPreviewHint:
            '在執行 VS Code 的本地電腦執行設定腳本後，將寫入用於遠端連線的 SSH 別名。主機、埠、使用者名稱、私鑰或私鑰路徑變更後，請重新執行腳本。',
        vscodePasswordModeTitle: '密碼認證',
        vscodePasswordModeHint: '密碼認證將使用填寫的主機、埠和使用者名稱發起連線，無需設定腳本或私鑰檔案。',
        vscodePasswordStep1: '確認主機、埠和使用者名稱。',
        vscodePasswordStep2: '開啟 VS Code，連線時輸入密碼。',
        vscodePasswordStep3: '不需要下載私鑰。',
    ...
    setting: {
        ...
        proxyHelper1: '應用商店的安裝包下載和同步（商業版功能）',
        proxyHelper2: '系統版本升級及取得更新說明（商業版功能）',
        proxyHelper3: '系統許可證的驗證和同步',
        proxyHelper4: 'Docker 拉取映像等網路請求將透過代理伺服器存取（商業版功能）',
        proxyHelper5: '系統類型腳本庫的統一下載與同步（商業版功能）',
        proxyHelper6: '申請憑證（商業版功能）',
        proxyType: '代理類型',
        proxyUrl: '代理地址',
        proxyPort: '代理埠',
        ...
        apiInterfaceAlert3: 'API 文件',
        apiInterfaceAlert4: '使用說明',
        apiKey: '介面金鑰',
        ...
        timeoutHelper: '{0} 天後面板密碼即將過期，過期後需要重新設定密碼',
        complexity: '密碼複雜度驗證',
        complexityHelper: '開啟後密碼必須滿足長度為 8-30 位，並包含字母、數字、特殊字元中至少兩項',
        bindDomain: '網域綁定',
        unBindDomain: '域名解綁',
        panelSSL: '面板 SSL',
    ...
    license: {
        ...
        authorizedUser: '被授權方',
        lostHelper: '許可證已達到最大重試次數，請手動點選同步按鈕，以確保商業版功能正常使用，詳情：',
        exceptionalHelper: '許可證同步驗證異常，請手動點選同步按鈕，以確保商業版功能正常使用，詳情：',
        quickUpdate: '快速更新',
        power: '授權',
        ...
        serialNo: '序號',
        remark: '備註',
        waf: '升級商業版可以獲得攔截地圖、日誌、封鎖記錄、地理位置封禁、自訂規則、自訂攔截頁面等功能。',
        tamper: '升級商業版可以保護網站免受未經授權的修改或篡改。',
        tamperHelper: '操作失敗，該檔案或資料夾已經開啟防篡改，請檢查後重試',
        setting: '升級商業版可以自訂面板 Logo、歡迎簡介等資訊。',
        monitor: '升級商業版可以檢視網站的即時狀態、訪客趨勢、訪客來源、請求日誌等資訊。',
        alert: '升級商業版可透過簡訊接收告警資訊，並檢視告警日誌，全面掌控各類關鍵事件，確保系統執行無憂。',
        node: '升級商業版可以使用 1Panel 管理多台 Linux 伺服器。',
        nodeApp: '升級商業版可以統一升級多節點應用版本，無需手動切換節點。',
        nodeDashboard: '升級商業版可以集中管理多節點應用、網站、資料庫和計劃任務。',
        fileExchange: '升級商業版可以在多台伺服器之間快速傳輸檔案。',
        app: '升級商業版可透過手機APP，檢視服務資訊、異常監控等。',
        cluster: '升級商業版可以管理 MySQL/Postgres/Redis 主從叢集。',
        vllm: '升級商業版可將 vLLM 服務統一納入 1Panel 管理，集中完成部署、設定調整、狀態維運與任務追蹤，降低本地模型服務維護成本。',
        'model-downloader':
            '升級商業版可從 HuggingFace、ModelScope 或相容鏡像站搜尋、下載並管理本機模型檔案，統一維護本機模型目錄與下載任務。',
    },
    clean: {
        scan: '開始掃描',
    ...
    firewall: {
        ...
        portWhiteListHelper: '支援指定協定（如 80/tcp、443/udp），未指定時預設使用 tcp。',
    ...
    xpack: {
        ...
        opsReport: {
            ...
            page: {
                ...
                memoryTotal: '記憶體總量',
                reportDate: '報表日期',
                serverSecurityOverview: '伺服器安全運營概覽',
                securityScore: '安全評分',
                overviewSummary: '當前安全等級為 {0}，合計扣分 {1} 分，識別到 {2} 個風險項，覆蓋 {3} 個檢查對象。',
                riskDistribution: '風險分佈',
                totalDeducted: '合計扣分',
                noRiskDeducted: '未觸發扣分',
                scoreTrend: '評分趨勢',
                scoreLevelSafe: '安全',
                scoreLevelAttention: '需關注',
                scoreLevelMediumRisk: '中風險',
                scoreLevelHighRisk: '高風險',
                scoreCategoryHost: '主機資源',
                scoreCategoryLogin: '登入安全',
                scoreCategoryWebsite: '網站與憑證',
                scoreCategoryCronjob: '計劃任務',
                scoreCategoryResource: '執行資源',
                scoreDiskHigh: '磁碟 {0} 使用率 {1}%',
                scoreDiskMedium: '磁碟 {0} 使用率 {1}%',
                scoreResourceHigh: '{0} 當前使用率 {1}%',
                scoreResourceMedium: '{0} 當前使用率 {1}%',
                scoreLoadMedium: '負載當前值 {0}',
                scoreMonitorDisabled: '主機監控未開啟',
                scorePanelLoginFailedHigh: '面板登入失敗 {0} 次',
                scorePanelLoginFailedMedium: '面板登入失敗 {0} 次',
                scoreSSHLoginFailedHigh: 'SSH 登入失敗 {0} 次',
                scoreSSHLoginFailedMedium: 'SSH 登入失敗 {0} 次',
                scoreMFADisabled: 'MFA 未開啟',
                scoreAllowIPsOpen: '授權 IP 與綁定域名均未配置或未限制訪問',
                scorePanelHTTPSDisabled: '面板 HTTPS 未啟用',
                scoreSSHRootLogin: 'SSH 允許 Root 登入',
                scoreSSHPasswordAuth: 'SSH 開啟密碼認證且未啟用金鑰認證',
                scoreSSLExpired: '{0} 憑證已到期',
                scoreSSLHigh: '{0} 憑證剩餘 {1} 天',
                scoreSSLMedium: '{0} 憑證剩餘 {1} 天',
                scoreWebsiteExpired: '{0} 網站已到期',
                scoreWebsiteExpire: '{0} 網站剩餘 {1} 天到期',
                scoreWebsiteHTTP: '{0} 未啟用 HTTPS',
                scoreWebsiteStopped: '{0} 狀態異常',
                scoreWebsiteMonitorUnavailable: '網站監控偵測到不可用站點',
                scoreWebsiteMonitorAvailability: '網站監控可用率 {0}% 低於閾值',
                scoreWebsiteMonitorStatusAbnormal: '網站監控已啟用，但狀態異常',
                scoreWafDisabled: 'WAF 未開啟，網站未納入防護',
                scoreWafHighRiskHit: 'WAF 統計週期內命中 {0} 條風險規則',
                scoreCronjobFailed: '近 7 天存在 {0} 條計劃任務失敗記錄',
                scoreAppFailed: '{0} 應用執行異常',
                scoreAppStopped: '{0} 應用已停止',
                scoreContainerHigh: '{0} 容器狀態異常',
                scoreContainerExited: '{0} 容器已停止',
                scoreContainerResource: '{0} 容器資源使用率過高',
                scoreContainerPublicPort: '{0} 容器存在公網暴露端口',
                attentionItems: '待關注項',
                attentionAssets: '待關注資產',
                riskItems: '風險項',
                object: '對象',
                description: '說明',
                itemUnit: '項',
                ...
                loginFailed: '登入失敗',
                sslExpire: '憑證到期',
                abnormalContainer: '異常容器',
                statAttentionDesc: '當前合計扣分 {0} 分',
                statLoginDesc: '面板 {0} 條 · SSH {1} 條',
                statSslDesc: '共檢查 {0} 張憑證',
                statContainerDesc: '共檢查 {0} 個容器',
                assetHostDesc: '磁碟最高使用率 {0}%',
                assetWebsiteDesc: '{0} 張憑證即將到期，{1} 個網站狀態異常',
                assetResourceDesc: '{0} 個應用異常，{1} 個容器異常',
                assetCronjobDesc: '近 7 天 {0} 條失敗記錄，{1} 個任務未啟用',
                app: '應用',
                website: '網站',
                websiteSsl: '網站 / 憑證',
                cronjob: '計劃任務',
                ...
                expired: '已到期',
                expiredDays: '已過期 {0} 天',
                remainingDays: '{0} · 剩餘 {1} 天',
                enabled: '已開啟',
                disabled: '未開啟',
                exportRecordFailed: '儲存匯出記錄失敗',
                hostInfo: '主機資訊',
                hostname: '主機名',
                osVersion: '系統版本',
                kernelVersion: '核心版本',
                ...
                memory: '記憶體',
                load: '負載',
                maxDiskUsage: '磁碟最高使用率',
                panelLoginSecurity: '面板登入安全配置',
                sshSecurity: 'Linux 伺服器 SSH 安全配置',
                panelFailedRecords: '面板登入失敗記錄',
                sshFailedRecords: 'SSH 登入失敗記錄',
                location: '歸屬地',
                configItem: '配置項',
                currentValue: '當前值',
                ...
                unrestricted: '未限制',
                bindDomain: '綁定網域',
                accessRestriction: '訪問限制',
                panelHTTPS: '面板 HTTPS',
                passwordComplexity: '密碼複雜度',
                sshService: 'SSH 服務',
                running: '執行中',
                notRunning: '未執行',
                listenPort: '監聽埠',
                ...
                allowIPsRestrictedDesc: '已限制允許訪問面板的 IP',
                allowIPsRiskDesc: '未限制訪問 IP，公網環境建議配置授權 IP',
                bindDomainRestrictedDesc: '已綁定訪問域名',
                bindDomainRiskDesc: '未綁定訪問域名，建議限制固定域名訪問',
                accessRestrictionValue: '授權 IP：{0} / 綁定域名：{1}',
                accessRestrictionNormalDesc: '已配置授權 IP 或綁定域名，面板訪問來源受限',
                accessRestrictionRiskDesc: '授權 IP 與綁定域名均未配置或未限制訪問，建議至少配置一項',
                ...
                mfa: 'MFA 認證',
                mfaNormalDesc: '已開啟 MFA 認證，登入安全性更高',
                mfaRiskDesc: '未開啟 MFA 認證，建議啟用多因素認證',
                ...
                autoRenew: '自動續簽',
                websiteCount: '網站數量',
                httpsWebsite: 'HTTPS 網站',
                certCount: '憑證數量',
                websiteExpire: '網站到期',
                database: '資料庫',
                remoteDatabase: '遠端資料庫',
                address: '地址',
                containerResourceUsage: '容器資源佔用',
                spaceUsage: '佔用空間',
                reclaimable: '可回收空間',
                containerReclaimable: '容器可回收',
                image: '映像',
                volume: '資料卷',
                buildCache: '建構快取',
                alert: '告警',
                ...
                needRenewal: '建議續簽',
                fromExpireInfo: '來自到期資訊',
                runningWebsite: '執行中網站',
                fromWebsiteStatus: '來自網站列表狀態',
                stoppedWebsite: '已停止網站',
                confirmStoppedWebsite: '確認是否符合預期',
                expiringWebsite: '快要過期網站',
                expiringSoon: '即將到期',
                none: '暫無',
                noSslRisk: '暫無需處理憑證',
                websiteProtection: 'WAF 與網站監控',
                websiteMonitor: '網站監控',
                waf: 'WAF',
                siteAvailability: '站點可用率',
                monitoredSites: '監控站點',
                requestCount: '請求數',
                abnormalSites: '異常站點',
                count5xxSource: '按 5xx 請求統計',
                wafIntercept: 'WAF 攔截',
                websiteMonitorDisabledOrNoData: '網站監控未啟用或暫無監控資料',
                wafDisabledOrNoData: 'WAF 未啟用或暫無攔截資料',
                serviceEnabledButAbnormal: '已啟用，但狀態異常',
                noWafData: '暫無 WAF 攔截資料',
                sourceIP: '來源 IP',
                hitCount: '命中次數',
                level: '等級',
                attackType: '攻擊類型',
                ...
                stopped: '停止',
                abnormal: '異常',
                abnormalContainers: '異常容器',
                resourceUsage: '資源使用',
                exposedContainerPorts: '暴露埠',
                portMapping: '埠映射',
                risk: '風險',
                noAbnormalContainer: '暫無異常容器',
                ...
                resourceThresholdContainers: 'CPU / 記憶體超閾值容器',
                noThresholdExceededContainer: '暫無超閾值容器',
                triggerMetric: '觸發項',
                ...
                successRate: '成功率',
                failedJobs: '失敗任務',
                recentRecoveryPoint: '最近恢復點',
                disabledCronjobTasks: '未啟用計劃任務',
                remoteCoverage: '遠端覆蓋',
                recent7Days: '近 7 天',
                taskTypeStats: '任務類型統計',
                total: '總計',
                taskTypeDesc: '已啟用 {0} 個，未啟用 {1} 個',
                failedOrAttentionTasks: '失敗或需關注任務',
                execution: '執行情況',
                ...
                cronjobHealthAttentionDesc: '存在 {0} 個需關注項，建議優先處理未啟用任務和失敗記錄',
                ...
                scheduleWeekly: '每週',
                scheduleWeeklyDesc: '每週一 09:00 生成近 7 天報表',
                scheduleMonthly: '每月',
                scheduleMonthlyDesc: '每月 1 日 09:00 生成上月報表',
                scheduleCurrentDaily: '每天 09:00 生成近 24 小時報表 · 下次 {0}',
                scheduleCurrentWeekly: '每週一 09:00 生成近 7 天報表 · 下次 {0}',
                scheduleCurrentMonthly: '每月 1 日 09:00 生成上月報表 · 下次 {0}',
                notificationMethod: '通知方式',
                channel: '通道',
                receiver: '接收對象',
                systemThreshold: '系統閾值',
                metric: '指標',
                currentRule: '當前規則',
                hostMonitor: '主機監控',
                ...
                autoExport: '啟用自動匯出',
                autoExportDesc: '開啟後將每天 09:00 自動生成運維報表',
                autoExportEnabled: '已啟用自動匯出',
                autoExportDisabled: '未啟用自動匯出',
                readOnlyPermissionTip: '目前帳號僅可查看運維報表設定，如需修改請聯絡管理員授權。',
                refreshing: '重新整理中',
                exporting: '匯出中',
                exportFailed: '匯出報表失敗',
                generating: '生成中',
                ...
                saveFailed: '儲存設定失敗',
                generateNow: '立即生成',
                generateSuccess: '已生成報表檔案：{0}',
                generateFailed: '生成報表失敗',
                enabledStatus: '已啟用',
                disabledStatus: '已停用',
                thresholdRule: '閾值 {0}，連續 {1} 次觸發',
                hours: '{0} 小時',
                minutes: '{0} 分鐘',
                seconds: '{0} 秒',
                totalExports: '匯出總數',
        ...
        logExport: {
            title: '匯出日誌',
            records: '匯出記錄',
            retentionDays: '匯出記錄保留天數',
            timeRange: '時間範圍',
            timeRequired: '請選擇匯出時間範圍',
            websiteRequired: '請選擇網站',
            blackStatus: '黑名單狀態',
            black: '已封鎖',
            notBlack: '未封鎖',
            fuzzy: '模糊比對',
            regex: '正則表示式',
            invalidRegex: '請輸入有效的 RE2 正則表示式，最長 256 個字元',
            created: '匯出任務已建立',
            fileName: '檔案名稱',
            fileSize: '檔案大小',
            expiresAt: '過期時間',
            cancelConfirm: '確認取消此匯出任務？',
            deleteConfirm: '確認刪除此匯出記錄及檔案？',
        },
        waf: {
            name: 'WAF',
            blackWhite: '黑白名單',
            ...
            geoRule: '地區存取限制',
            geoHelper: '使用一個開關組合地區與省份策略，先執行地區規則，再由省份規則進一步限制中國省級區域',
            regionPolicy: '地區策略',
            provincePolicy: '省份策略',
            ...
            hostSearchHelper: '請輸入 Host，支援模糊搜尋',
            toCreate: '去建立',
            closeWaf: '關閉 WAF',
            ...
            fileExtCheck: '檔案上傳限制',
            geoRestrict: '地區存取限制',
            originProtect: 'CDN 來源站保護',
            attacklog: '攔截紀錄',
            unknownWebsite: '未授權網域存取',
            geoRuleEmpty: '地區或省份至少選擇一項',
            unknown: '網站不存在',
            geo: '地區限制',
            ...
            spiderIpHelper: '啟用後僅放行已選取的蜘蛛，停用後會攔截所有蜘蛛存取',
            spiderIp: '蜘蛛 IP 池',
            spider: '蜘蛛',
            spiderAllowlist: '蜘蛛放行範圍',
            spiderAllowlistEmpty: '未選取任何蜘蛛，儲存後將攔截所有蜘蛛存取',
            geoIp: 'IP 位址庫',
            ...
            detectionStrength: '檢測強度',
            protectionMode: '防護模式',
            observationMode: '觀察模式',
            standardMode: '標準模式',
        ...
        monitor: {
            ...
            originProtection: '來源站保護',
            originProtectionHelper: '只允許所選 IP 群組中的 CDN 節點連線來源站，訪客真實 IP 識別使用獨立開關',
            originProtectionIPGroups: 'CDN 回源 IP 群組',
            originProtectionIPGroupsPlaceholder: '請選擇可信任的 CDN 回源 IP 群組',
            originProtectionWarning: '設定錯誤可能導致網站無法存取，請先確認 IP 群組包含所有 CDN 回源位址',
            originProtectionEnableConfirm: '開啟後，非所選 IP 群組的連線將視為直接連線來源站並遭到阻擋，是否繼續？',
            statusErr: '狀態碼格式錯誤',
            shenma: '神馬搜尋',
        ...
        helper: {
            ...
            modelDownloaderTitle1: '模型發現',
            modelDownloaderContent1: '直接搜尋 HuggingFace 模型倉庫，檢視下載量、點讚數、模型詳情與檔案列表。',
            modelDownloaderTitle2: '加速下載',
            modelDownloaderContent2: '支援設定 HuggingFace 加速地址與 HF Token，適配官方站、鏡像站和私有模型存取。',
            modelDownloaderTitle3: '任務追蹤',
            modelDownloaderContent3: '統一檢視下載佇列、任務狀態、進度、錯誤資訊，並支援取消、重試和記錄清理。',
            modelDownloaderTitle4: '本地管理',
            modelDownloaderContent4: '集中維護本地模型目錄，檢視模型路徑、大小和時間，支援刪除不再需要的模型檔案。',
        },
        node: {
            master: '主節點',
            masterBackup: '主節點備份',
            ...
            nodeUpgradePackageManage: '安裝包管理',
            nodeUpgradePackageClean: '清理',
            nodeUpgradePackageFormatHelper: '僅支援 `1panel-agent_v*_*` 或 `1panel-v*-linux-*` 安裝包',
            nodeUpgradePackageHostConfirm: '即將選擇伺服器檔案：{0}，是否繼續？',
            nodeUpgradePackageCleanHelper: '即將清理所有低版本升級包，是否繼續？',
            nodeUpgradeOfflinePackageHelper: '離線環境中，異構節點需先上傳對應更新包後再更新。',
            ...
            syncWithMaster: '升級為商業版後，將預設同步所有資料，可在節點管理中手動調整同步策略。',
            syncProxy: '系統代理設定',
        ...
        alert: {
            ...
            remainingDays: '剩餘天數',
            sendCount: '告警次數',
            recipientPlaceholder: '請輸入電子郵件地址',
            addRecipient: '新增收件人',
            webhookItem: 'Webhook 連結',
            addWebhook: '新增 Webhook',
            selectAlertType: '選擇告警類型',
            configDetail: '設定詳情',
            webhookCount: 'Webhook 數量',
            sms: '簡訊通知',
            wechat: '微信公眾號',
            dingTalk: '釘釘通知',
            feiShu: '飛書通知',
            ...
            alertConfigProHelper: '商業版額外支援企業微信、釘釘、飛書及簡訊告警。',
        },
        theme: {
        ...
        vm: {
            ...
            healthCheckResult: {
                ...
                normal: '正常',
                fixCommand: '修復命令',
                technicalDetail: '技術詳情',
                check: {
                    vmName: '虛擬機名稱',
                    libvirtConnection: 'Libvirt 連線',
                    vmDefinition: '虛擬機定義',
                    domainXML: '虛擬機 XML',
                    architecture: '架構',
                    virtualizationType: '虛擬化類型',
                    machineType: '機器類型',
                    efiCapability: 'EFI 能力',
                    qemuEmulator: 'QEMU 模擬器',
                    bootOrder: '啟動順序',
                    arm64Firmware: 'ARM64 韌體',
                    arm64Features: 'ARM64 特性',
                    arm64Video: 'ARM64 顯示裝置',
                    arm64FirmwareFile: 'ARM64 韌體檔案',
                    arm64CDROM: 'ARM64 光碟機',
                    blockDevice: '區塊裝置',
                    isoArchitecture: 'ISO 架構',
                    network: '網路',
                    qemuLog: 'QEMU 日誌',
                    arm64RuntimeFirmware: 'ARM64 韌體執行參數',
                },
                reason: {
                    invalidName: '虛擬機名稱無效。',
                    connectionFailed: '無法連線 {uri}。',
                    vmNotFound: '找不到虛擬機 {name}。',
                    xmlReadFailed: '讀取虛擬機 XML 失敗。',
                    liveXMLFallback: '無法讀取持久化設定，已改用目前執行設定。',
                    xmlParseFailed: '解析虛擬機 XML 失敗。',
                    stateReadFailed: '無法確認虛擬機執行狀態，將略過執行態韌體檢查。',
                    guestArchMissing: 'XML 中缺少客體架構。',
                    archMismatch: '主機架構為 {hostArch}，客體架構為 {guestArch}，不支援跨架構執行。',
                    nonKVMType: '虛擬化類型為 {type}，不是預設的 KVM。',
                    archOrMachineMissing: 'XML 中缺少架構或機器類型。',
                    machineUnsupported: '主機不支援 {arch}/{machine}。',
                    emulatorNotSpecified: 'XML 未明確指定模擬器，將由 Libvirt 選擇。',
                    fileNotFound: '檔案不存在：{path}',
                    fileNotExecutable: '檔案不可執行：{path}',
                    bootDeviceMissing: 'XML 中沒有啟動裝置。',
                    diskNotFirst: '硬碟不是第一啟動項目，目前順序：{order}',
                    cdromNotInBootOrder: '已掛載 CD-ROM，但啟動順序中沒有光碟機。',
                    firmwareNotConfigured: '未設定 EFI 或 Loader，客體可能無法初始化顯示或開機。',
                    acpiCustom: '偵測到 ACPI，請確認這是客體明確需要的自訂設定。',
                    acpiRequiresUEFI: '偵測到 ACPI 但沒有 UEFI，會觸發 ACPI requires UEFI。',
                    apicUnsupported: '偵測到 x86 APIC，ARM64 設定不應包含此項。',
                    gicNotDeclared: '持久化 XML 未顯示 GIC，Libvirt 可能在執行態自動補充。',
                    videoNotConfigured: 'XML 中沒有設定顯示裝置。',
                    videoNotVirtio: '顯示裝置類型為 {type}，建議使用 Virtio。',
                    firmwareFileMissing: '韌體檔案不存在或不是一般檔案：{path}',
                    firmwareNotAvailable: 'Libvirt 未回報 EFI 能力，且未找到 ARM64 UEFI 韌體。',
                    cdromBusNotSCSI: 'CD-ROM 使用 {bus} 匯流排，ARM64 應使用 SCSI。',
                    cdromNotOnVirtioSCSI: 'CD-ROM 未連接至 Virtio SCSI 控制器。',
                    diskSourceMissing: '{device} {target} 沒有來源檔案。',
                    sourceNotFound: '{device} {target} 的來源檔案不存在：{path}',
                    sourceIsDirectory: '{device} {target} 的來源路徑是目錄：{path}',
                    systemDiskNotFound: '未偵測到系統磁碟。',
                    isoArchMismatch: '{guestArch} 客體掛載了疑似 {imageArch} 的映像檔：{path}',
                    networkReadFailed: '無法讀取網路 {name}。',
                    networkStateReadFailed: '無法讀取網路 {name} 的狀態。',
                    networkInactive: '網路 {name} 存在但未啟動。',
                    logUnavailable: '目前沒有可分析的啟動日誌。',
                    logErrorsFound: '最近一次啟動記錄中發現常見錯誤。',
                    vmNotRunning: '虛擬機目前未執行，已略過 QEMU 執行參數檢查。',
                    runtimeFirmwareMissing: 'QEMU 日誌中未發現 pflash、AAVMF 或 QEMU_EFI。',
                },
            },
            dependencies: '依賴',
            ...
            dependencyPurposeMap: {
                ...
                storage: '提供預設儲存目錄或儲存池，用於保存虛擬機磁碟檔案。',
            },
            dependencyNotReady: '虛擬機依賴檢測未通過，請處理依賴後再使用虛擬機功能。',
            helperUnavailable: '虛擬機能力初始化失敗，請檢查 Core 日誌或重新升級後再使用虛擬機功能。',
            cpu: 'CPU',
            memory: '記憶體',
            disk: '磁碟',
            overview: '概覽',
            kvmUnavailable: '未偵測到可用的 KVM 硬體虛擬化能力。',
            kvmCheckCpu: '確認主機 CPU 支援 Intel VT-x 或 AMD-V 虛擬化能力。',
            kvmCheckBios: '進入 BIOS/UEFI 開啟虛擬化相關選項。',
            kvmCheckModule: '確認核心模組 kvm、kvm_intel 或 kvm_amd 已正確載入。',
            kvmCheckDevice: '確認 /dev/kvm 存在，且目前執行環境不是不支援 KVM 的容器或雲端主機。',
            abnormal: '異常',
            resourceOverview: '資源概況',
            cpuAllocated: 'CPU 配置',
            memoryAllocated: '記憶體配置',
            storageUsed: '儲存使用',
            riskReminder: '風險提醒',
            noRisk: '暫無風險',
            runtimeHealth: '執行環境',
            runtimeAbnormal: '虛擬機執行環境異常',
            noDependency: '暫無依賴檢測資料',
            storageOverview: '儲存池概況',
            totalAllocated: '依虛擬機設定總量統計',
            runningAllocated: '執行中佔用：{0}',
            storageAvailable: '剩餘可用：{0}',
            inProgress: '任務進行中',
            needAttention: '需要關注',
            normal: '正常',
            environmentRisk: '虛擬機執行環境未就緒，請處理依賴或虛擬化服務。',
            storageRisk: '儲存池 {0} 使用率已達 {1}%。',
            abnormalRisk: '目前有 {0} 台虛擬機處於異常狀態。',
            pausedRisk: '目前有 {0} 台虛擬機處於暫停狀態。',
            memoryRisk: '虛擬機記憶體配置率已達 {0}%。',
            cpuLimitHelper: '目前可用 CPU：{0} 核',
            cpuLimitExceeded: 'CPU 超出限制，目前最大可用：{0} 核',
            memoryLimitHelper: '目前可分配記憶體：{0}（主機需要預留 {1} 記憶體）',
            memoryLimitExceeded: '記憶體超出限制，目前最大可分配：{0}',
            storageLimitHelper: '目標儲存池目前可用空間：{0}',
            storageLimitExceeded: '磁碟容量超出限制，目前最大可用：{0}',
            iso: '鏡像',
            createFromTemplate: '從範本啟動',
            template: '範本',
            templateName: '範本名稱',
            convertToTemplate: '轉為範本',
            sourceVM: '來源虛擬機',
            templateSize: '範本大小',
            deleteTemplateConfirm: '刪除範本 {0}，該操作不可回滾，是否繼續？',
            orphanClean: '孤立資料清理',
            orphanScan: '重新掃描',
            orphanCleanHelper:
                '僅顯示未被虛擬機、快照或已登記範本引用的候選檔案。請確認檔案不再使用後再清理，清理操作不可復原。',
            orphanSelected: '已選擇 {0} 個檔案，共 {1}',
            orphanSize: '檔案大小',
            orphanCleanConfirm: '確認清理已選擇的 {0} 個檔案（{1}）嗎？該操作不可復原。',
            orphanCleanSuccess: '已清理 {0} 個檔案，釋放 {1}。',
            orphanType: {
                orphan_domain_disk: '孤立磁碟',
                orphan_snapshot: '孤立快照',
                partial_file: '未完成檔案',
            },
            diskSize: '磁碟容量',
            diskPath: '磁碟路徑',
            ...
            dhcpEnd: 'DHCP 結束位址',
            bootOrder: '啟動項',
            bootDiskFirst: '磁碟優先（HD → CD-ROM）',
            bootIsoFirst: '鏡像優先（CD-ROM → HD）',
            bootOrderConfirm: '確定將啟動順序修改為 {0} 嗎？虛擬機下次啟動時，將按此順序嘗試目前已掛載且可啟動的裝置。',
            ...
            rename: '重新命名',
            newName: '新名稱',
            renameHelper: '請輸入新的虛擬機名稱，重新命名需要虛擬機處於關機狀態。',
            ...
            tx: '傳送',
            console: '控制台',
            consoleNotReady: 'VNC 控制台不可用，請啟動虛擬機並檢查 VNC 圖形設定。',
            consoleDisconnected: 'VNC 控制台已中斷連線。',
            consoleConnectFailed: 'VNC 控制台連線失敗，請檢查控制台代理服務。',
            consoleCredentialsRequired: 'VNC 控制台需要認證資訊，請檢查後端代理設定。',
            snapshot: '快照',
            createSnapshot: '建立快照',
            ...
            forceDelete: '強制刪除',
            forceDeleteHelper: '強制刪除將會忽略虛擬機刪除錯誤，刪除面板中繼資料並釋放資源佔用。',
            deleteNameHelper: '" 刪除此虛擬機',
            isoSource: '鏡像來源',
            downloadFromServer: '遠端下載',
            isoTargetDir: '鏡像目標路徑',
            ...
            deleteSourceFileHelper: '勾選後會同時刪除該鏡像記錄引用的源檔案，檔案刪除後無法恢復。',
            dir: '本機目錄',
        },
        cluster: {
            cluster: '應用高可用',
