...
const message = {
    ...
    aiTools: {
        agents: {
            ...
            botDuplicateAccountId: '帳戶 ID 不能重複',
        ...
        model: {
            ...
            modelSource: '模型來源',
            repoID: '倉庫 ID',
            modelScopeEndpoint: 'ModelScope 地址',
            modelScopeToken: 'ModelScope Token（可選）',
            hfToken: 'HF Token（可選）',
            hfEndpoint: 'HuggingFace 加速地址',
            hfEndpointHelper: '國內存取 HuggingFace 不穩定時可設定加速地址，搜尋、詳情和下載都會使用該地址。',
            searchModelScope: '搜尋 ModelScope',
        ...
        aiProxy: {
            ...
            requestBodyLogEsEndpoint: 'Elasticsearch 地址',
            requestBodyLogEsAuthMethod: 'Elasticsearch 認證方式',
            requestBodyLogEsUsername: 'Elasticsearch 使用者名稱',
            requestBodyLogEsPassword: 'Elasticsearch 密碼',
            ...
            deleteModelGroupConfirm: '確認刪除模型組 {0}？',
            ...
            apiKeyReset: '重設',
            apiKeyCount: '數量',
            deleteGroupConfirm: '確定刪除群組「{name}」？此操作無法復原。',
        },
        skillsHub: {
            title: 'Skills Hub',
            upload: '上傳 Skill',
